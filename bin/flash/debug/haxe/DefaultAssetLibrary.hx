...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("data/graphics/persona_tarot_card_hd___back_by_ipswich67-d4on9zw.png", __ASSET__data_graphics_persona_tarot_card_hd___back_by_ipswich67_d4on9zw_png);
		type.set ("data/graphics/persona_tarot_card_hd___back_by_ipswich67-d4on9zw.png", AssetType.IMAGE);
		className.set ("data/graphics/Tarocco_Bolognese.png", __ASSET__data_graphics_tarocco_bolognese_png);
		type.set ("data/graphics/Tarocco_Bolognese.png", AssetType.IMAGE);
		className.set ("data/graphics/test.png", __ASSET__data_graphics_test_png);
		type.set ("data/graphics/test.png", AssetType.IMAGE);
		...
		type.set (id, AssetType.IMAGE);
		id = "data/graphics/Tarocco_Bolognese.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "data/graphics/test.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__data_graphics_tarocco_bolognese_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__data_graphics_test_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("data/graphics/Tarocco_Bolognese.png") #if display private #end class __ASSET__data_graphics_tarocco_bolognese_png extends lime.graphics.Image {}
@:image("data/graphics/test.png") #if display private #end class __ASSET__data_graphics_test_png extends lime.graphics.Image {}
