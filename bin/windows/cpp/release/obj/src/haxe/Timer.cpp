...
HXLINE( 304)		HX_VARI( Float,now) = ::haxe::Timer_obj::getMS();
HXLINE( 305)		HX_VARI( Bool,foundNull) = false;
HXLINE( 306)		HX_VAR(  ::haxe::Timer,timer);
HXLINE( 308)		{
HXLINE( 308)			HX_VARI( Int,_g1) = (int)0;
HXDLIN( 308)			HX_VARI( Int,_g) = ::haxe::Timer_obj::sRunningTimers->length;
HXDLIN( 308)			while((_g1 < _g)){
HXLINE( 308)				HX_VARI( Int,i) = _g1++;
HXLINE( 310)				timer = ::haxe::Timer_obj::sRunningTimers->__get(i).StaticCast<  ::haxe::Timer >();
HXLINE( 312)				Bool _hx_tmp = hx::IsNotNull( timer );
HXDLIN( 312)				if (_hx_tmp) {
HXLINE( 314)					timer->_hx___check(now);
            				}
HXLINE( 318)				Bool _hx_tmp1 = !(foundNull);
HXDLIN( 318)				if (_hx_tmp1) {
HXLINE( 318)					foundNull = hx::IsNull( ::haxe::Timer_obj::sRunningTimers->__get(i).StaticCast<  ::haxe::Timer >() );
            				}
            				else {
HXLINE( 318)					foundNull = true;
            				}
            			}
            		}
HXLINE( 322)		if (foundNull) {
            			HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            			Bool _hx_run( ::haxe::Timer val){
            				HX_STACK_FRAME("haxe.Timer","__checkTimers",0xb7078205,"haxe.Timer.__checkTimers","haxe/Timer.hx",324,0x1a690682)
            				HX_STACK_ARG(val,"val")
HXLINE( 324)				return hx::IsNotNull( val );
            			}
            			HX_END_LOCAL_FUNC1(return)

HXLINE( 324)			::haxe::Timer_obj::sRunningTimers = ::haxe::Timer_obj::sRunningTimers->filter( ::Dynamic(new _hx_Closure_0()));
            		}
            	}
