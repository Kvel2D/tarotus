...
void BitmapGlyphFrame_obj::__construct( ::haxegon::bitmapFont::BitmapFont parent){
            	HX_STACK_FRAME("haxegon.bitmapFont.BitmapGlyphFrame","new",0x68d3ea44,"haxegon.bitmapFont.BitmapGlyphFrame.new","haxegon/bitmapFont/BitmapFont.hx",596,0x0e43809e)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(parent,"parent")
HXLINE( 596)		this->parent = parent;
            	}
...
{
	hx::ObjectPtr< BitmapGlyphFrame_obj > _hx_result = new BitmapGlyphFrame_obj();
...
void BitmapGlyphFrame_obj::dispose(){
            	HX_STACK_FRAME("haxegon.bitmapFont.BitmapGlyphFrame","dispose",0xafa95c83,"haxegon.bitmapFont.BitmapGlyphFrame.dispose","haxegon/bitmapFont/BitmapFont.hx",600,0x0e43809e)
            	HX_STACK_THIS(this)
HXLINE( 601)		this->rect = null();
HXLINE( 603)		Bool _hx_tmp = hx::IsNotNull( this->_bitmap );
HXDLIN( 603)		if (_hx_tmp) {
HXLINE( 605)			this->_bitmap->dispose();
            		}
HXLINE( 608)		this->_bitmap = null();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(BitmapGlyphFrame_obj,dispose,(void))
 ...
 ::openfl::display::BitmapData BitmapGlyphFrame_obj::get_bitmap(){
            	HX_STACK_FRAME("haxegon.bitmapFont.BitmapGlyphFrame","get_bitmap",0x67262a54,"haxegon.bitmapFont.BitmapGlyphFrame.get_bitmap","haxegon/bitmapFont/BitmapFont.hx",612,0x0e43809e)
            	HX_STACK_THIS(this)
HXLINE( 613)		Bool _hx_tmp = hx::IsNotNull( this->_bitmap );
HXDLIN( 613)		if (_hx_tmp) {
HXLINE( 615)			return this->_bitmap;
            		}
HXLINE( 618)		Int _hx_tmp1 = ::Math_obj::ceil(this->rect->width);
HXDLIN( 618)		Int _hx_tmp2 = ::Math_obj::ceil(this->rect->height);
HXDLIN( 618)		this->_bitmap =  ::openfl::display::BitmapData_obj::__new(_hx_tmp1,_hx_tmp2,true,(int)0);
HXLINE( 619)		this->_bitmap->copyPixels(this->parent->bitmap,this->rect, ::openfl::geom::Point_obj::__new(null(),null()),null(),null(),null());
HXLINE( 620)		return this->_bitmap;
            	}
...
hx::Val BitmapGlyphFrame_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		if (HX_FIELD_EQ(inName,"bitmap") ) { return hx::Val( inCallProp == hx::paccAlways ? get_bitmap() : bitmap); }
...
hx::Val BitmapGlyphFrame_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
...
#if HXCPP_SCRIPTABLE
static hx::StorageInfo BitmapGlyphFrame_obj_sMemberStorageInfo[] = {
...
static hx::StaticInfo *BitmapGlyphFrame_obj_sStaticStorageInfo = 0;
#endif

static ::String BitmapGlyphFrame_obj_sMemberFields[] = {
...
static void BitmapGlyphFrame_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(BitmapGlyphFrame_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void BitmapGlyphFrame_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
void BitmapGlyphFrame_obj::__register()
{
	...
	__mClass->mMarkFunc = BitmapGlyphFrame_obj_sMarkStatics;
	__mClass->mStatics = hx::Class_obj::dupFunctions(0 /* sStaticFields */);
	__mClass->mMembers = hx::Class_obj::dupFunctions(BitmapGlyphFrame_obj_sMemberFields);
	__mClass->mCanCast = hx::TCanCast< BitmapGlyphFrame_obj >;
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = BitmapGlyphFrame_obj_sVisitStatics;
#endif
#ifdef HXCPP_SCRIPTABLE
	__mClass->mMemberStorageInfo = BitmapGlyphFrame_obj_sMemberStorageInfo;
#endif
#ifdef HXCPP_SCRIPTABLE
	__mClass->mStaticStorageInfo = BitmapGlyphFrame_obj_sStaticStorageInfo;
#endif
