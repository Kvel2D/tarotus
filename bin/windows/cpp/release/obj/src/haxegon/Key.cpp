...
int Key_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_("ALT",09,95,31,00)) return 65;
	if (inName==HX_("B",42,00,00,00)) return 1;
	if (inName==HX_("BACKSLASH",96,28,9e,c3)) return 55;
	if (inName==HX_("BACKSPACE",1f,f5,42,c6)) return 52;
	if (inName==HX_("C",43,00,00,00)) return 2;
	if (inName==HX_("CAPSLOCK",8c,6c,6e,80)) return 56;
	if (inName==HX_("COMMA",b5,69,4b,c8)) return 61;
	if (inName==HX_("CONTROL",3d,3f,55,99)) return 64;
	if (inName==HX_("D",44,00,00,00)) return 3;
	if (inName==HX_("DELETE",2b,6c,5b,1d)) return 51;
	if (inName==HX_("DOWN",62,c0,2e,2d)) return 68;
	if (inName==HX_("E",45,00,00,00)) return 4;
	if (inName==HX_("EIGHT",2f,b9,1c,eb)) return 34;
	if (inName==HX_("END",bb,9f,34,00)) return 73;
	if (inName==HX_("ENTER",f8,a4,74,ee)) return 59;
	if (inName==HX_("ESCAPE",81,ef,5c,8d)) return 48;
	if (inName==HX_("F",46,00,00,00)) return 5;
	if (inName==HX_("F1",2b,3d,00,00)) return 36;
	if (inName==HX_("F10",a5,48,35,00)) return 45;
	if (inName==HX_("F11",a6,48,35,00)) return 46;
	if (inName==HX_("F12",a7,48,35,00)) return 47;
	if (inName==HX_("F2",2c,3d,00,00)) return 37;
	if (inName==HX_("F3",2d,3d,00,00)) return 38;
	if (inName==HX_("F4",2e,3d,00,00)) return 39;
	if (inName==HX_("F5",2f,3d,00,00)) return 40;
	if (inName==HX_("F6",30,3d,00,00)) return 41;
	if (inName==HX_("F7",31,3d,00,00)) return 42;
	if (inName==HX_("F8",32,3d,00,00)) return 43;
	if (inName==HX_("F9",33,3d,00,00)) return 44;
	if (inName==HX_("FIVE",32,9f,7c,2e)) return 31;
	if (inName==HX_("FOUR",e6,2b,81,2e)) return 30;
	if (inName==HX_("G",47,00,00,00)) return 6;
	if (inName==HX_("H",48,00,00,00)) return 7;
	if (inName==HX_("HOME",1f,92,d3,2f)) return 72;
	if (inName==HX_("I",49,00,00,00)) return 8;
	if (inName==HX_("J",4a,00,00,00)) return 9;
	if (inName==HX_("K",4b,00,00,00)) return 10;
	if (inName==HX_("L",4c,00,00,00)) return 11;
	if (inName==HX_("LBRACKET",3c,3b,54,16)) return 53;
	if (inName==HX_("LEFT",07,d0,70,32)) return 69;
	if (inName==HX_("M",4d,00,00,00)) return 12;
	if (inName==HX_("MINUS",50,b8,56,86)) return 49;
	if (inName==HX_("N",4e,00,00,00)) return 13;
	if (inName==HX_("NINE",32,4d,c6,33)) return 35;
	if (inName==HX_("O",4f,00,00,00)) return 14;
	if (inName==HX_("ONE",46,36,3c,00)) return 27;
	if (inName==HX_("P",50,00,00,00)) return 15;
	if (inName==HX_("PAGEDOWN",31,36,e2,b9)) return 75;
	if (inName==HX_("PAGEUP",6a,5e,bb,98)) return 74;
	if (inName==HX_("PERIOD",01,0d,9e,ed)) return 62;
	if (inName==HX_("PLUS",5a,07,1b,35)) return 50;
	if (inName==HX_("Q",51,00,00,00)) return 16;
	if (inName==HX_("QUOTE",1c,5b,e0,db)) return 58;
	if (inName==HX_("R",52,00,00,00)) return 17;
	if (inName==HX_("RBRACKET",f6,e7,82,6d)) return 54;
	if (inName==HX_("RIGHT",bc,43,52,67)) return 70;
	if (inName==HX_("S",53,00,00,00)) return 18;
	if (inName==HX_("SEMICOLON",11,86,2a,49)) return 57;
	if (inName==HX_("SEVEN",ed,5c,1f,f8)) return 33;
	if (inName==HX_("SHIFT",62,24,11,fa)) return 60;
	if (inName==HX_("SIX",02,3b,3f,00)) return 32;
	if (inName==HX_("SLASH",1d,f8,af,fc)) return 63;
	if (inName==HX_("SPACE",a6,c4,54,ff)) return 66;
	if (inName==HX_("T",54,00,00,00)) return 19;
	if (inName==HX_("TAB",35,f6,3f,00)) return 71;
	if (inName==HX_("THREE",3e,8c,7e,8d)) return 29;
	if (inName==HX_("TWO",6c,09,40,00)) return 28;
	if (inName==HX_("U",55,00,00,00)) return 20;
	if (inName==HX_("UP",5b,4a,00,00)) return 67;
	if (inName==HX_("V",56,00,00,00)) return 21;
	if (inName==HX_("W",57,00,00,00)) return 22;
	if (inName==HX_("X",58,00,00,00)) return 23;
	if (inName==HX_("Y",59,00,00,00)) return 24;
	if (inName==HX_("Z",5a,00,00,00)) return 25;
	if (inName==HX_("ZERO",28,d7,b1,3b)) return 26;
...
void Key_obj::__boot()
{
A = hx::CreateEnum< Key_obj >(HX_HCSTRING("A","\x41","\x00","\x00","\x00"),0,0);
ALT = hx::CreateEnum< Key_obj >(HX_HCSTRING("ALT","\x09","\x95","\x31","\x00"),65,0);
B = hx::CreateEnum< Key_obj >(HX_HCSTRING("B","\x42","\x00","\x00","\x00"),1,0);
BACKSLASH = hx::CreateEnum< Key_obj >(HX_HCSTRING("BACKSLASH","\x96","\x28","\x9e","\xc3"),55,0);
BACKSPACE = hx::CreateEnum< Key_obj >(HX_HCSTRING("BACKSPACE","\x1f","\xf5","\x42","\xc6"),52,0);
C = hx::CreateEnum< Key_obj >(HX_HCSTRING("C","\x43","\x00","\x00","\x00"),2,0);
CAPSLOCK = hx::CreateEnum< Key_obj >(HX_HCSTRING("CAPSLOCK","\x8c","\x6c","\x6e","\x80"),56,0);
COMMA = hx::CreateEnum< Key_obj >(HX_HCSTRING("COMMA","\xb5","\x69","\x4b","\xc8"),61,0);
CONTROL = hx::CreateEnum< Key_obj >(HX_HCSTRING("CONTROL","\x3d","\x3f","\x55","\x99"),64,0);
D = hx::CreateEnum< Key_obj >(HX_HCSTRING("D","\x44","\x00","\x00","\x00"),3,0);
DELETE = hx::CreateEnum< Key_obj >(HX_HCSTRING("DELETE","\x2b","\x6c","\x5b","\x1d"),51,0);
DOWN = hx::CreateEnum< Key_obj >(HX_HCSTRING("DOWN","\x62","\xc0","\x2e","\x2d"),68,0);
E = hx::CreateEnum< Key_obj >(HX_HCSTRING("E","\x45","\x00","\x00","\x00"),4,0);
EIGHT = hx::CreateEnum< Key_obj >(HX_HCSTRING("EIGHT","\x2f","\xb9","\x1c","\xeb"),34,0);
END = hx::CreateEnum< Key_obj >(HX_HCSTRING("END","\xbb","\x9f","\x34","\x00"),73,0);
ENTER = hx::CreateEnum< Key_obj >(HX_HCSTRING("ENTER","\xf8","\xa4","\x74","\xee"),59,0);
ESCAPE = hx::CreateEnum< Key_obj >(HX_HCSTRING("ESCAPE","\x81","\xef","\x5c","\x8d"),48,0);
F = hx::CreateEnum< Key_obj >(HX_HCSTRING("F","\x46","\x00","\x00","\x00"),5,0);
F1 = hx::CreateEnum< Key_obj >(HX_HCSTRING("F1","\x2b","\x3d","\x00","\x00"),36,0);
F10 = hx::CreateEnum< Key_obj >(HX_HCSTRING("F10","\xa5","\x48","\x35","\x00"),45,0);
F11 = hx::CreateEnum< Key_obj >(HX_HCSTRING("F11","\xa6","\x48","\x35","\x00"),46,0);
F12 = hx::CreateEnum< Key_obj >(HX_HCSTRING("F12","\xa7","\x48","\x35","\x00"),47,0);
F2 = hx::CreateEnum< Key_obj >(HX_HCSTRING("F2","\x2c","\x3d","\x00","\x00"),37,0);
F3 = hx::CreateEnum< Key_obj >(HX_HCSTRING("F3","\x2d","\x3d","\x00","\x00"),38,0);
F4 = hx::CreateEnum< Key_obj >(HX_HCSTRING("F4","\x2e","\x3d","\x00","\x00"),39,0);
F5 = hx::CreateEnum< Key_obj >(HX_HCSTRING("F5","\x2f","\x3d","\x00","\x00"),40,0);
F6 = hx::CreateEnum< Key_obj >(HX_HCSTRING("F6","\x30","\x3d","\x00","\x00"),41,0);
F7 = hx::CreateEnum< Key_obj >(HX_HCSTRING("F7","\x31","\x3d","\x00","\x00"),42,0);
F8 = hx::CreateEnum< Key_obj >(HX_HCSTRING("F8","\x32","\x3d","\x00","\x00"),43,0);
F9 = hx::CreateEnum< Key_obj >(HX_HCSTRING("F9","\x33","\x3d","\x00","\x00"),44,0);
FIVE = hx::CreateEnum< Key_obj >(HX_HCSTRING("FIVE","\x32","\x9f","\x7c","\x2e"),31,0);
FOUR = hx::CreateEnum< Key_obj >(HX_HCSTRING("FOUR","\xe6","\x2b","\x81","\x2e"),30,0);
G = hx::CreateEnum< Key_obj >(HX_HCSTRING("G","\x47","\x00","\x00","\x00"),6,0);
H = hx::CreateEnum< Key_obj >(HX_HCSTRING("H","\x48","\x00","\x00","\x00"),7,0);
HOME = hx::CreateEnum< Key_obj >(HX_HCSTRING("HOME","\x1f","\x92","\xd3","\x2f"),72,0);
I = hx::CreateEnum< Key_obj >(HX_HCSTRING("I","\x49","\x00","\x00","\x00"),8,0);
J = hx::CreateEnum< Key_obj >(HX_HCSTRING("J","\x4a","\x00","\x00","\x00"),9,0);
K = hx::CreateEnum< Key_obj >(HX_HCSTRING("K","\x4b","\x00","\x00","\x00"),10,0);
L = hx::CreateEnum< Key_obj >(HX_HCSTRING("L","\x4c","\x00","\x00","\x00"),11,0);
LBRACKET = hx::CreateEnum< Key_obj >(HX_HCSTRING("LBRACKET","\x3c","\x3b","\x54","\x16"),53,0);
LEFT = hx::CreateEnum< Key_obj >(HX_HCSTRING("LEFT","\x07","\xd0","\x70","\x32"),69,0);
M = hx::CreateEnum< Key_obj >(HX_HCSTRING("M","\x4d","\x00","\x00","\x00"),12,0);
MINUS = hx::CreateEnum< Key_obj >(HX_HCSTRING("MINUS","\x50","\xb8","\x56","\x86"),49,0);
N = hx::CreateEnum< Key_obj >(HX_HCSTRING("N","\x4e","\x00","\x00","\x00"),13,0);
NINE = hx::CreateEnum< Key_obj >(HX_HCSTRING("NINE","\x32","\x4d","\xc6","\x33"),35,0);
O = hx::CreateEnum< Key_obj >(HX_HCSTRING("O","\x4f","\x00","\x00","\x00"),14,0);
ONE = hx::CreateEnum< Key_obj >(HX_HCSTRING("ONE","\x46","\x36","\x3c","\x00"),27,0);
P = hx::CreateEnum< Key_obj >(HX_HCSTRING("P","\x50","\x00","\x00","\x00"),15,0);
PAGEDOWN = hx::CreateEnum< Key_obj >(HX_HCSTRING("PAGEDOWN","\x31","\x36","\xe2","\xb9"),75,0);
PAGEUP = hx::CreateEnum< Key_obj >(HX_HCSTRING("PAGEUP","\x6a","\x5e","\xbb","\x98"),74,0);
PERIOD = hx::CreateEnum< Key_obj >(HX_HCSTRING("PERIOD","\x01","\x0d","\x9e","\xed"),62,0);
PLUS = hx::CreateEnum< Key_obj >(HX_HCSTRING("PLUS","\x5a","\x07","\x1b","\x35"),50,0);
Q = hx::CreateEnum< Key_obj >(HX_HCSTRING("Q","\x51","\x00","\x00","\x00"),16,0);
QUOTE = hx::CreateEnum< Key_obj >(HX_HCSTRING("QUOTE","\x1c","\x5b","\xe0","\xdb"),58,0);
R = hx::CreateEnum< Key_obj >(HX_HCSTRING("R","\x52","\x00","\x00","\x00"),17,0);
RBRACKET = hx::CreateEnum< Key_obj >(HX_HCSTRING("RBRACKET","\xf6","\xe7","\x82","\x6d"),54,0);
RIGHT = hx::CreateEnum< Key_obj >(HX_HCSTRING("RIGHT","\xbc","\x43","\x52","\x67"),70,0);
S = hx::CreateEnum< Key_obj >(HX_HCSTRING("S","\x53","\x00","\x00","\x00"),18,0);
SEMICOLON = hx::CreateEnum< Key_obj >(HX_HCSTRING("SEMICOLON","\x11","\x86","\x2a","\x49"),57,0);
SEVEN = hx::CreateEnum< Key_obj >(HX_HCSTRING("SEVEN","\xed","\x5c","\x1f","\xf8"),33,0);
SHIFT = hx::CreateEnum< Key_obj >(HX_HCSTRING("SHIFT","\x62","\x24","\x11","\xfa"),60,0);
SIX = hx::CreateEnum< Key_obj >(HX_HCSTRING("SIX","\x02","\x3b","\x3f","\x00"),32,0);
SLASH = hx::CreateEnum< Key_obj >(HX_HCSTRING("SLASH","\x1d","\xf8","\xaf","\xfc"),63,0);
SPACE = hx::CreateEnum< Key_obj >(HX_HCSTRING("SPACE","\xa6","\xc4","\x54","\xff"),66,0);
T = hx::CreateEnum< Key_obj >(HX_HCSTRING("T","\x54","\x00","\x00","\x00"),19,0);
TAB = hx::CreateEnum< Key_obj >(HX_HCSTRING("TAB","\x35","\xf6","\x3f","\x00"),71,0);
THREE = hx::CreateEnum< Key_obj >(HX_HCSTRING("THREE","\x3e","\x8c","\x7e","\x8d"),29,0);
TWO = hx::CreateEnum< Key_obj >(HX_HCSTRING("TWO","\x6c","\x09","\x40","\x00"),28,0);
U = hx::CreateEnum< Key_obj >(HX_HCSTRING("U","\x55","\x00","\x00","\x00"),20,0);
UP = hx::CreateEnum< Key_obj >(HX_HCSTRING("UP","\x5b","\x4a","\x00","\x00"),67,0);
V = hx::CreateEnum< Key_obj >(HX_HCSTRING("V","\x56","\x00","\x00","\x00"),21,0);
W = hx::CreateEnum< Key_obj >(HX_HCSTRING("W","\x57","\x00","\x00","\x00"),22,0);
X = hx::CreateEnum< Key_obj >(HX_HCSTRING("X","\x58","\x00","\x00","\x00"),23,0);
Y = hx::CreateEnum< Key_obj >(HX_HCSTRING("Y","\x59","\x00","\x00","\x00"),24,0);
Z = hx::CreateEnum< Key_obj >(HX_HCSTRING("Z","\x5a","\x00","\x00","\x00"),25,0);
ZERO = hx::CreateEnum< Key_obj >(HX_HCSTRING("ZERO","\x28","\xd7","\xb1","\x3b"),26,0);
}
