...
void DocumentClass_obj::__construct(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 237)		::openfl::Lib_obj::current->addChild(hx::ObjectPtr<OBJ_>(this));
HXLINE( 238)		super::__construct();
HXLINE( 239)		this->dispatchEvent( ::openfl::events::Event_obj::__new(HX_("addedToStage",63,22,55,0c),false,false));
            	}
