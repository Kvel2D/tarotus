...
::haxegon::bitmapFont::TextBorderStyle_obj::__register();
::haxegon::Key_obj::__register();
::haxegon::Keystate_obj::__register();
::haxe::io::Error_obj::__register();
::haxe::StackItem_obj::__register();
::MainState_obj::__register();
::CardType_obj::__register();
::GameState_obj::__register();
::WeaponType_obj::__register();
::ArmorType_obj::__register();
::ConsumableType_obj::__register();
::ItemType_obj::__register();
::DoorColor_obj::__register();
...
::openfl::external::ExternalInterface_obj::__register();
...
::Xml_obj::__register();
::Walls_obj::__register();
::Tiles_obj::__register();
...
::openfl::_internal::stage3D::_AGALConverter::SamplerReg_obj::__register();
::openfl::_internal::stage3D::_AGALConverter::SourceReg_obj::__register();
::openfl::_internal::stage3D::_AGALConverter::DestReg_obj::__register();
...
::haxegon::util::Tileset_obj::__register();
::haxegon::util::Fontfile_obj::__register();
::haxegon::util::Fontclass_obj::__register();
::haxegon::util::AnimationContainer_obj::__register();
::haxegon::bitmapFont::BitmapTextField_obj::__register();
::haxegon::bitmapFont::BitmapGlyph_obj::__register();
::haxegon::bitmapFont::BitmapGlyphCollection_obj::__register();
::haxegon::bitmapFont::BitmapGlyphFrame_obj::__register();
...
::EReg_obj::__register();
::__ASSET__OPENFL__data_fonts_seraphimb1_seraphimb1_ttf_obj::__register();
::__ASSET__OPENFL__data_fonts_pixelfj8_pixelfj8_ttf_obj::__register();
::__ASSET__OPENFL__data_fonts_opensans_opensans_ttf_obj::__register();
::__ASSET__data_fonts_seraphimb1_seraphimb1_ttf_obj::__register();
::__ASSET__data_fonts_pixelfj8_pixelfj8_ttf_obj::__register();
::__ASSET__data_fonts_opensans_opensans_ttf_obj::__register();
...
::haxegon::bitmapFont::TextBorderStyle_obj::__boot();
...
::ArmorType_obj::__boot();
::ConsumableType_obj::__boot();
::ItemType_obj::__boot();
::DoorColor_obj::__boot();
...
::openfl::external::ExternalInterface_obj::__boot();
