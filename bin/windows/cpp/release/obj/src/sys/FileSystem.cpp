...
Bool FileSystem_obj::isDirectory(::String path){
            	HX_STACK_FRAME("sys.FileSystem","isDirectory",0x6c577a21,"sys.FileSystem.isDirectory","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",62,0xb7079c8b)
            	HX_STACK_ARG(path,"path")
...
void FileSystem_obj::deleteDirectory(::String path){
            	HX_STACK_FRAME("sys.FileSystem","deleteDirectory",0x052a5cc0,"sys.FileSystem.deleteDirectory","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",84,0xb7079c8b)
            	HX_STACK_ARG(path,"path")
...
::Array< ::String > FileSystem_obj::readDirectory(::String path){
            	HX_STACK_FRAME("sys.FileSystem","readDirectory",0x0619f8b5,"sys.FileSystem.readDirectory","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",88,0xb7079c8b)
            	HX_STACK_ARG(path,"path")
