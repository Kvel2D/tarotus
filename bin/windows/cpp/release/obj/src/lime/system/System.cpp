...
HXLINE( 173)			Bool _hx_tmp1 = ::Reflect_obj::hasField(displayInfo,HX_("currentMode",3c,ac,f2,80));
HXDLIN( 173)			if (_hx_tmp1) {
HXLINE( 175)				display->currentMode = display->supportedModes->__get(( (Int)(displayInfo->__Field(HX_("currentMode",3c,ac,f2,80),hx::paccDynamic)) )).StaticCast<  ::lime::_hx_system::DisplayMode >();
            			}
            			else {
HXLINE( 179)				display->currentMode =  ::lime::_hx_system::DisplayMode_obj::__new((int)0,(int)0,(int)60,(int)1);
            			}
HXLINE( 183)			return display;
            		}
...
HXLINE( 220)		return ( (Int)(::lime::_hx_system::System_obj::cffi_lime_system_get_timer()) );
            	}
...
Bool lazy = __o_lazy.Default(false);
            	HX_STACK_FRAME("lime.system.System","load",0x1dbaa99f,"lime.system.System.load","lime/system/System.hx",235,0x6434b429)
            	HX_STACK_ARG(library,"library")
            	HX_STACK_ARG(method,"method")
            	HX_STACK_ARG(args,"args")
            	HX_STACK_ARG(lazy,"lazy")
HXLINE( 235)		return ::lime::_hx_system::CFFI_obj::load(library,method,args,lazy);
            	}
...
HXLINE( 253)		return ( (Bool)(::lime::_hx_system::System_obj::cffi_lime_system_get_allow_screen_timeout()) );
            	}
...
HXLINE( 264)		return ( (Bool)(::lime::_hx_system::System_obj::cffi_lime_system_set_allow_screen_timeout(value)) );
            	}
...
HXLINE( 275)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_directory((int)0,null(),null())) );
HXDLIN( 275)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE( 295)		HX_VARI( ::String,company) = HX_("MyCompany",11,c3,2e,cc);
HXLINE( 296)		HX_VARI( ::String,file) = HX_("MyApplication",24,d3,d1,1c);
HXLINE( 298)		Bool _hx_tmp;
HXDLIN( 298)		Bool _hx_tmp1 = hx::IsNotNull( ::lime::app::Application_obj::current );
HXDLIN( 298)		if (_hx_tmp1) {
HXLINE( 298)			_hx_tmp = hx::IsNotNull( ::lime::app::Application_obj::current->config );
            		}
            		else {
HXLINE( 298)			_hx_tmp = false;
            		}
HXDLIN( 298)		if (_hx_tmp) {
HXLINE( 300)			Bool _hx_tmp2 = hx::IsNotNull( ( (::String)(::lime::app::Application_obj::current->config->__Field(HX_("company",3d,15,69,83),hx::paccDynamic)) ) );
HXDLIN( 300)			if (_hx_tmp2) {
HXLINE( 302)				company = ( (::String)(::lime::app::Application_obj::current->config->__Field(HX_("company",3d,15,69,83),hx::paccDynamic)) );
            			}
HXLINE( 306)			Bool _hx_tmp3 = hx::IsNotNull( ( (::String)(::lime::app::Application_obj::current->config->__Field(HX_("file",7c,ce,bb,43),hx::paccDynamic)) ) );
HXDLIN( 306)			if (_hx_tmp3) {
HXLINE( 308)				file = ( (::String)(::lime::app::Application_obj::current->config->__Field(HX_("file",7c,ce,bb,43),hx::paccDynamic)) );
            			}
            		}
HXLINE( 315)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_directory((int)1,company,file)) );
HXDLIN( 315)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE( 336)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_directory((int)2,null(),null())) );
HXDLIN( 336)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE( 357)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_directory((int)3,null(),null())) );
HXDLIN( 357)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE( 378)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_directory((int)4,null(),null())) );
...
HXLINE( 389)		return ( (Int)(::lime::_hx_system::System_obj::cffi_lime_system_get_num_displays()) );
            	}
...
HXLINE( 400)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_directory((int)5,null(),null())) );
HXDLIN( 400)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE( 425)		return ::lime::_hx_system::Endian_obj::_hx_LITTLE_ENDIAN_dyn();
            	}
...
HXLINE( 439)		return ( (Bool)(::lime::_hx_system::System_obj::cffi_lime_system_get_allow_screen_timeout()) );
            	}
...
Bool System_obj::lime_system_set_allow_screen_timeout(Bool value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE( 440)		return ( (Bool)(::lime::_hx_system::System_obj::cffi_lime_system_set_allow_screen_timeout(value)) );
            	}
...
HXLINE( 441)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_directory(type,company,title)) );
HXDLIN( 441)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE( 442)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_display(index)) );
HXDLIN( 442)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE( 443)		return ( (Int)(::lime::_hx_system::System_obj::cffi_lime_system_get_num_displays()) );
            	}
...
HXLINE( 444)		return ( (Float)(::lime::_hx_system::System_obj::cffi_lime_system_get_timer()) );
            	}
...
HXLINE( 439)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_system_get_allow_screen_timeout",73,89,73,7a),HX_("b",62,00,00,00),false);
HXDLIN( 439)		cffi_lime_system_get_allow_screen_timeout = inValue;
            	}
{
            	HX_STACK_FRAME("lime.system.System","boot",0x171e93ab,"lime.system.System.boot","lime/system/System.hx",440,0x6434b429)
HXLINE( 440)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_system_set_allow_screen_timeout",e7,0a,4e,8d),HX_("bb",c0,55,00,00),false);
HXDLIN( 440)		cffi_lime_system_set_allow_screen_timeout = inValue;
            	}
{
            	HX_STACK_FRAME("lime.system.System","boot",0x171e93ab,"lime.system.System.boot","lime/system/System.hx",441,0x6434b429)
HXLINE( 441)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_system_get_directory",5e,9e,04,7c),HX_("isso",06,0f,bf,45),false);
HXDLIN( 441)		cffi_lime_system_get_directory = inValue;
            	}
{
            	HX_STACK_FRAME("lime.system.System","boot",0x171e93ab,"lime.system.System.boot","lime/system/System.hx",442,0x6434b429)
HXLINE( 442)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_system_get_display",f3,47,82,d2),HX_("io",e6,5b,00,00),false);
HXDLIN( 442)		cffi_lime_system_get_display = inValue;
            	}
{
            	HX_STACK_FRAME("lime.system.System","boot",0x171e93ab,"lime.system.System.boot","lime/system/System.hx",443,0x6434b429)
HXLINE( 443)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_system_get_num_displays",f9,90,37,4f),HX_("i",69,00,00,00),false);
HXDLIN( 443)		cffi_lime_system_get_num_displays = inValue;
            	}
{
            	HX_STACK_FRAME("lime.system.System","boot",0x171e93ab,"lime.system.System.boot","lime/system/System.hx",444,0x6434b429)
HXLINE( 444)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_system_get_timer",36,5f,72,67),HX_("d",64,00,00,00),false);
HXDLIN( 444)		cffi_lime_system_get_timer = inValue;
            	}
}
