...
HXLINE( 137)		Bool _hx_tmp = hx::IsNotNull( this->_hx___preloader );
HXDLIN( 137)		if (_hx_tmp) {
HXLINE( 139)			this->_hx___preloader->onProgress->remove(this->onPreloadProgress_dyn());
HXLINE( 140)			this->_hx___preloader->onComplete->remove(this->onPreloadComplete_dyn());
            		}
HXLINE( 144)		this->_hx___preloader = preloader;
HXLINE( 146)		Bool _hx_tmp1;
HXDLIN( 146)		Bool _hx_tmp2 = hx::IsNotNull( preloader );
HXDLIN( 146)		if (_hx_tmp2) {
HXLINE( 146)			_hx_tmp1 = preloader->complete;
            		}
            		else {
HXLINE( 146)			_hx_tmp1 = true;
            		}
HXDLIN( 146)		if (_hx_tmp1) {
HXLINE( 148)			this->onPreloadComplete();
            		}
            		else {
HXLINE( 152)			preloader->onProgress->add(this->onPreloadProgress_dyn(),null(),null());
HXLINE( 153)			preloader->onComplete->add(this->onPreloadComplete_dyn(),null(),null());
            		}
            	}
...
void Module_obj::unregisterModule( ::lime::app::Application application){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(application,"application")
HXLINE( 162)		this->_hx___application->onExit->remove(this->onModuleExit_dyn());
HXLINE( 163)		this->_hx___application->onUpdate->remove(this->update_dyn());
HXLINE( 165)		::lime::ui::Gamepad_obj::onConnect->remove(this->_hx___onGamepadConnect_dyn());
HXLINE( 166)		::lime::ui::Joystick_obj::onConnect->remove(this->_hx___onJoystickConnect_dyn());
HXLINE( 167)		::lime::ui::Touch_obj::onStart->remove(this->onTouchStart_dyn());
HXLINE( 168)		::lime::ui::Touch_obj::onMove->remove(this->onTouchMove_dyn());
HXLINE( 169)		::lime::ui::Touch_obj::onEnd->remove(this->onTouchEnd_dyn());
HXLINE( 171)		this->onModuleExit((int)0);
            	}
...
void Module_obj::onGamepadConnect( ::lime::ui::Gamepad gamepad){
            	HX_STACK_FRAME("lime.app.Module","onGamepadConnect",0xa4a7b504,"lime.app.Module.onGamepadConnect","lime/app/Module.hx",207,0x653a538a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(gamepad,"gamepad")
HXLINE( 207)		::haxe::Log_obj::trace(HX_("onGamepadConnect (module)",2d,67,c5,c4),hx::SourceInfo(HX_("Module.hx",72,21,cc,b7),207,HX_("lime.app.Module",b2,d5,db,18),HX_("onGamepadConnect",c8,56,d7,ec)));
            	}
