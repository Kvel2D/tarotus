...
HXLINE( 255)			Bool _hx_tmp2 = hx::IsEq( this->_hx___windows->__get((int)0).StaticCast<  ::lime::ui::Window >(),window );
HXDLIN( 255)			if (_hx_tmp2) {
HXLINE( 257)				this->window = null();
            			}
            		}
            	}
...
HXLINE( 268)		this->super::setPreloader(preloader);
HXLINE( 270)		{
HXLINE( 270)			HX_VARI( Int,_g) = (int)0;
HXDLIN( 270)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->modules;
HXDLIN( 270)			while((_g < _g1->length)){
HXLINE( 270)				HX_VARI( ::Dynamic,module) = _g1->__get(_g);
HXDLIN( 270)				++_g;
HXLINE( 272)				::lime::app::IModule_obj::setPreloader(module,preloader);
            			}
            		}
            	}
...
Float Application_obj::get_frameRate(){
            	HX_STACK_FRAME("lime.app.Application","get_frameRate",0x719f92a0,"lime.app.Application.get_frameRate","lime/app/Application.hx",288,0x8bc55476)
            	HX_STACK_THIS(this)
HXLINE( 288)		return this->backend->getFrameRate();
            	}
...
Float Application_obj::set_frameRate(Float value){
            	HX_STACK_FRAME("lime.app.Application","set_frameRate",0xb6a574ac,"lime.app.Application.set_frameRate","lime/app/Application.hx",295,0x8bc55476)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 295)		return this->backend->setFrameRate(value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Application_obj,set_frameRate,return )
 ...
 ::lime::app::Preloader Application_obj::get_preloader(){
            	HX_STACK_FRAME("lime.app.Application","get_preloader",0xbaf66569,"lime.app.Application.get_preloader","lime/app/Application.hx",302,0x8bc55476)
            	HX_STACK_THIS(this)
HXLINE( 302)		return this->_hx___preloader;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Application_obj,get_preloader,return )
 ...
 ::lime::graphics::Renderer Application_obj::get_renderer(){
            	HX_STACK_FRAME("lime.app.Application","get_renderer",0xa67be3b0,"lime.app.Application.get_renderer","lime/app/Application.hx",309,0x8bc55476)
            	HX_STACK_THIS(this)
HXLINE( 309)		return this->_hx___renderers->__get((int)0).StaticCast<  ::lime::graphics::Renderer >();
            	}
...
::Array< ::Dynamic> Application_obj::get_renderers(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 316)		return this->_hx___renderers;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Application_obj,get_renderers,return )
 ...
 ::lime::ui::Window Application_obj::get_window(){
            	HX_STACK_FRAME("lime.app.Application","get_window",0xc86a4d1d,"lime.app.Application.get_window","lime/app/Application.hx",323,0x8bc55476)
            	HX_STACK_THIS(this)
HXLINE( 323)		return this->_hx___windows->__get((int)0).StaticCast<  ::lime::ui::Window >();
            	}
...
::Array< ::Dynamic> Application_obj::get_windows(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 330)		return this->_hx___windows;
            	}
