...
HXLINE(1075)		this->version = (int)716180;
            	}
...
void AssetCache_obj::clear(::String prefix){
            	HX_STACK_FRAME("lime.AssetCache","clear",0xa2398fea,"lime.AssetCache.clear","lime/Assets.hx",1085,0x48c77341)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(prefix,"prefix")
HXLINE(1085)		Bool _hx_tmp = hx::IsNull( prefix );
HXDLIN(1085)		if (_hx_tmp) {
HXLINE(1087)			this->audio =  ::haxe::ds::StringMap_obj::__new();
HXLINE(1088)			this->font =  ::haxe::ds::StringMap_obj::__new();
HXLINE(1089)			this->image =  ::haxe::ds::StringMap_obj::__new();
            		}
            		else {
HXLINE(1093)			HX_VARI(  ::Dynamic,keys) = this->audio->keys();
HXLINE(1095)			while(true){
HXLINE(1095)				Bool _hx_tmp1 = !(( (Bool)( ::Dynamic(keys->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN(1095)				if (_hx_tmp1) {
HXLINE(1095)					goto _hx_goto_0;
            				}
HXDLIN(1095)				HX_VARI( ::String,key) = ( (::String)( ::Dynamic(keys->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE(1097)				Bool _hx_tmp2 = ::StringTools_obj::startsWith(key,prefix);
HXDLIN(1097)				if (_hx_tmp2) {
HXLINE(1099)					this->audio->remove(key);
            				}
            			}
            			_hx_goto_0:;
HXLINE(1105)			HX_VARI_NAME(  ::Dynamic,keys1,"keys") = this->font->keys();
HXLINE(1107)			while(true){
HXLINE(1107)				Bool _hx_tmp3 = !(( (Bool)( ::Dynamic(keys1->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN(1107)				if (_hx_tmp3) {
HXLINE(1107)					goto _hx_goto_1;
            				}
HXDLIN(1107)				HX_VARI_NAME( ::String,key1,"key") = ( (::String)( ::Dynamic(keys1->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE(1109)				Bool _hx_tmp4 = ::StringTools_obj::startsWith(key1,prefix);
HXDLIN(1109)				if (_hx_tmp4) {
HXLINE(1111)					this->font->remove(key1);
            				}
            			}
            			_hx_goto_1:;
HXLINE(1117)			HX_VARI_NAME(  ::Dynamic,keys2,"keys") = this->image->keys();
HXLINE(1119)			while(true){
HXLINE(1119)				Bool _hx_tmp5 = !(( (Bool)( ::Dynamic(keys2->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN(1119)				if (_hx_tmp5) {
HXLINE(1119)					goto _hx_goto_2;
            				}
HXDLIN(1119)				HX_VARI_NAME( ::String,key2,"key") = ( (::String)( ::Dynamic(keys2->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE(1121)				Bool _hx_tmp6 = ::StringTools_obj::startsWith(key2,prefix);
HXDLIN(1121)				if (_hx_tmp6) {
HXLINE(1123)					this->image->remove(key2);
            				}
            			}
            			_hx_goto_2:;
            		}
