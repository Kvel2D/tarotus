...
HXLINE( 287)				return ::lime::tools::helpers::ProcessHelper_obj::_runProcess(path,command,args,waitForOutput,ignoreErrors);
            			}
            			catch( ::Dynamic _hx_e){
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
...
HXLINE( 303)			return ::lime::tools::helpers::ProcessHelper_obj::_runProcess(path,command,args,waitForOutput,ignoreErrors);
            		}
...
HXLINE( 395)						::lime::tools::helpers::LogHelper_obj::error(error,null(),null());
            					}
HXLINE( 399)					return null();
            				}
            			}
HXLINE( 413)			if ((oldPath != HX_("",00,00,00,00))) {
HXLINE( 415)				::Sys_obj::setCwd(oldPath);
            			}
            		}
HXLINE( 421)		return output;
            	}
...
HXLINE( 435)		HX_VARI( Bool,cacheDryRun) = ::lime::tools::helpers::ProcessHelper_obj::dryRun;
HXLINE( 436)		::lime::tools::helpers::ProcessHelper_obj::dryRun = false;
HXLINE( 438)		Bool _hx_tmp = (::lime::tools::helpers::ProcessHelper_obj::_processorCores < (int)1);
HXDLIN( 438)		if (_hx_tmp) {
HXLINE( 440)			HX_VARI( ::String,result) = null();
HXLINE( 442)			::String _hx_tmp1 = ::lime::tools::helpers::PlatformHelper_obj::get_hostPlatform();
HXDLIN( 442)			if ((_hx_tmp1 == HX_("windows",83,de,74,e8))) {
HXLINE( 444)				HX_VARI( ::String,env) = ::Sys_obj::getEnv(HX_("NUMBER_OF_PROCESSORS",13,f1,5e,ee));
HXLINE( 446)				Bool _hx_tmp2 = hx::IsNotNull( env );
HXDLIN( 446)				if (_hx_tmp2) {
HXLINE( 448)					result = env;
            				}
            			}
            			else {
HXLINE( 452)				::String _hx_tmp3 = ::lime::tools::helpers::PlatformHelper_obj::get_hostPlatform();
HXDLIN( 452)				if ((_hx_tmp3 == HX_("linux",f4,eb,01,75))) {
HXLINE( 454)					result = ::lime::tools::helpers::ProcessHelper_obj::runProcess(HX_("",00,00,00,00),HX_("nproc",04,97,72,a0),::Array_obj< ::String >::__new(0),true,true,true,null());
HXLINE( 456)					Bool _hx_tmp4 = hx::IsNull( result );
HXDLIN( 456)					if (_hx_tmp4) {
HXLINE( 458)						HX_VARI( ::String,cpuinfo) = ::lime::tools::helpers::ProcessHelper_obj::runProcess(HX_("",00,00,00,00),HX_("cat",16,74,4b,00),::Array_obj< ::String >::fromData( _hx_array_data_6,1),true,true,true,null());
HXLINE( 460)						Bool _hx_tmp5 = hx::IsNotNull( cpuinfo );
HXDLIN( 460)						if (_hx_tmp5) {
HXLINE( 462)							HX_VARI( ::Array< ::String >,split) = cpuinfo.split(HX_("processor",52,bd,0b,d3));
HXLINE( 463)							Int _hx_tmp6 = (split->length - (int)1);
HXDLIN( 463)							result = ::Std_obj::string(_hx_tmp6);
            						}
            					}
            				}
            				else {
HXLINE( 469)					::String _hx_tmp7 = ::lime::tools::helpers::PlatformHelper_obj::get_hostPlatform();
HXDLIN( 469)					if ((_hx_tmp7 == HX_("mac",8f,0a,53,00))) {
HXLINE( 471)						HX_VARI(  ::EReg,cores) =  ::EReg_obj::__new(HX_("Total Number of Cores: (\\d+)",c2,4a,e3,a3),HX_("",00,00,00,00));
HXLINE( 472)						HX_VARI( ::String,output) = ::lime::tools::helpers::ProcessHelper_obj::runProcess(HX_("",00,00,00,00),HX_("/usr/sbin/system_profiler",a8,1e,29,cd),::Array_obj< ::String >::fromData( _hx_array_data_7,3),null(),null(),null(),null());
HXLINE( 474)						Bool _hx_tmp8 = cores->match(output);
HXDLIN( 474)						if (_hx_tmp8) {
HXLINE( 476)							result = cores->matched((int)1);
            						}
            					}
            				}
            			}
HXLINE( 482)			Bool _hx_tmp9;
HXDLIN( 482)			Bool _hx_tmp10 = hx::IsNotNull( result );
HXDLIN( 482)			if (_hx_tmp10) {
HXLINE( 482)				 ::Dynamic _hx_tmp11 = ::Std_obj::parseInt(result);
HXDLIN( 482)				_hx_tmp9 = hx::IsLess( _hx_tmp11,(int)1 );
            			}
            			else {
HXLINE( 482)				_hx_tmp9 = true;
            			}
HXDLIN( 482)			if (_hx_tmp9) {
HXLINE( 484)				::lime::tools::helpers::ProcessHelper_obj::_processorCores = (int)1;
            			}
            			else {
HXLINE( 488)				::lime::tools::helpers::ProcessHelper_obj::_processorCores = ::Std_obj::parseInt(result);
            			}
            		}
HXLINE( 494)		::lime::tools::helpers::ProcessHelper_obj::dryRun = cacheDryRun;
HXLINE( 496)		return ::lime::tools::helpers::ProcessHelper_obj::_processorCores;
            	}
