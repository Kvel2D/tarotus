...
HXDLIN(  80)				Int _hx_tmp1 = this2->byteOffset;
HXDLIN(  80)				 ::Dynamic _hx_tmp2 = ::__hxcpp_memory_get_ui32(this2->buffer->b,(_hx_tmp1 + (((int)this1 & (int)(int)255) * (int)4)));
HXDLIN(  80)				::lime::math::color::_RGBA::RGBA_Impl__obj::a16 = _hx_tmp2;
HXLINE(  81)				{
HXLINE(  81)					Int _hx_tmp3 = ((int)((int)((int)((int)((int)(((int)((int)this1 >> (int)(int)24) & (int)(int)255) * ::lime::math::color::_RGBA::RGBA_Impl__obj::a16) >> (int)(int)16) & (int)(int)255) << (int)(int)24) | (int)((int)((int)((int)(((int)((int)this1 >> (int)(int)16) & (int)(int)255) * ::lime::math::color::_RGBA::RGBA_Impl__obj::a16) >> (int)(int)16) & (int)(int)255) << (int)(int)16)) | (int)((int)((int)((int)(((int)((int)this1 >> (int)(int)8) & (int)(int)255) * ::lime::math::color::_RGBA::RGBA_Impl__obj::a16) >> (int)(int)16) & (int)(int)255) << (int)(int)8));
HXDLIN(  81)					Int _hx_tmp4 = ((int)((int)this1 & (int)(int)255) & (int)(int)255);
HXDLIN(  81)					this1 = ((int)_hx_tmp3 | (int)_hx_tmp4);
            				}
            			}
            		}
            	}
...
HXDLIN( 138)					Int _hx_tmp1 = this2->byteOffset;
HXDLIN( 138)					 ::Dynamic _hx_tmp2 = ::__hxcpp_memory_get_ui32(this2->buffer->b,(_hx_tmp1 + (((int)this1 & (int)(int)255) * (int)4)));
HXDLIN( 138)					::lime::math::color::_RGBA::RGBA_Impl__obj::a16 = _hx_tmp2;
HXDLIN( 138)					{
HXLINE( 138)						Int _hx_tmp3 = ((int)((int)((int)((int)((int)(((int)((int)this1 >> (int)(int)24) & (int)(int)255) * ::lime::math::color::_RGBA::RGBA_Impl__obj::a16) >> (int)(int)16) & (int)(int)255) << (int)(int)24) | (int)((int)((int)((int)(((int)((int)this1 >> (int)(int)16) & (int)(int)255) * ::lime::math::color::_RGBA::RGBA_Impl__obj::a16) >> (int)(int)16) & (int)(int)255) << (int)(int)16)) | (int)((int)((int)((int)(((int)((int)this1 >> (int)(int)8) & (int)(int)255) * ::lime::math::color::_RGBA::RGBA_Impl__obj::a16) >> (int)(int)16) & (int)(int)255) << (int)(int)8));
HXDLIN( 138)						Int _hx_tmp4 = ((int)((int)this1 & (int)(int)255) & (int)(int)255);
HXDLIN( 138)						this1 = ((int)_hx_tmp3 | (int)_hx_tmp4);
            					}
            				}
            			}
            		}
...
HXDLIN( 153)					{
HXLINE( 153)						Int byteOffset = (data->byteOffset + offset);
HXDLIN( 153)						::__hxcpp_memory_set_byte(data->buffer->b,byteOffset,val);
            					}
            				}
HXLINE( 154)				{
HXLINE( 154)					HX_VARI_NAME( Int,val1,"val") = ((int)((int)this1 >> (int)(int)16) & (int)(int)255);
HXDLIN( 154)					{
HXLINE( 154)						Int byteOffset1 = (data->byteOffset + (offset + (int)1));
HXDLIN( 154)						::__hxcpp_memory_set_byte(data->buffer->b,byteOffset1,val1);
            					}
            				}
HXLINE( 155)				{
HXLINE( 155)					HX_VARI_NAME( Int,val2,"val") = ((int)((int)this1 >> (int)(int)8) & (int)(int)255);
HXDLIN( 155)					{
HXLINE( 155)						Int byteOffset2 = (data->byteOffset + (offset + (int)2));
HXDLIN( 155)						::__hxcpp_memory_set_byte(data->buffer->b,byteOffset2,val2);
            					}
            				}
HXLINE( 156)				{
HXLINE( 156)					HX_VARI_NAME( Int,val3,"val") = ((int)this1 & (int)(int)255);
HXDLIN( 156)					{
HXLINE( 156)						Int byteOffset3 = (data->byteOffset + (offset + (int)3));
HXDLIN( 156)						::__hxcpp_memory_set_byte(data->buffer->b,byteOffset3,val3);
            					}
            				}
            			}
            			break;
...
HXDLIN( 160)					{
HXLINE( 160)						Int byteOffset4 = (data->byteOffset + offset);
HXDLIN( 160)						::__hxcpp_memory_set_byte(data->buffer->b,byteOffset4,val4);
            					}
            				}
HXLINE( 161)				{
HXLINE( 161)					HX_VARI_NAME( Int,val5,"val") = ((int)((int)this1 >> (int)(int)24) & (int)(int)255);
HXDLIN( 161)					{
HXLINE( 161)						Int byteOffset5 = (data->byteOffset + (offset + (int)1));
HXDLIN( 161)						::__hxcpp_memory_set_byte(data->buffer->b,byteOffset5,val5);
            					}
            				}
HXLINE( 162)				{
HXLINE( 162)					HX_VARI_NAME( Int,val6,"val") = ((int)((int)this1 >> (int)(int)16) & (int)(int)255);
HXDLIN( 162)					{
HXLINE( 162)						Int byteOffset6 = (data->byteOffset + (offset + (int)2));
HXDLIN( 162)						::__hxcpp_memory_set_byte(data->buffer->b,byteOffset6,val6);
            					}
            				}
HXLINE( 163)				{
HXLINE( 163)					HX_VARI_NAME( Int,val7,"val") = ((int)((int)this1 >> (int)(int)8) & (int)(int)255);
HXDLIN( 163)					{
HXLINE( 163)						Int byteOffset7 = (data->byteOffset + (offset + (int)3));
HXDLIN( 163)						::__hxcpp_memory_set_byte(data->buffer->b,byteOffset7,val7);
            					}
            				}
            			}
            			break;
...
HXDLIN( 146)					{
HXLINE( 146)						Int byteOffset8 = (data->byteOffset + offset);
HXDLIN( 146)						::__hxcpp_memory_set_byte(data->buffer->b,byteOffset8,val8);
            					}
            				}
HXLINE( 147)				{
HXLINE( 147)					HX_VARI_NAME( Int,val9,"val") = ((int)((int)this1 >> (int)(int)16) & (int)(int)255);
HXDLIN( 147)					{
HXLINE( 147)						Int byteOffset9 = (data->byteOffset + (offset + (int)1));
HXDLIN( 147)						::__hxcpp_memory_set_byte(data->buffer->b,byteOffset9,val9);
            					}
            				}
HXLINE( 148)				{
HXLINE( 148)					HX_VARI_NAME( Int,val10,"val") = ((int)((int)this1 >> (int)(int)24) & (int)(int)255);
HXDLIN( 148)					{
HXLINE( 148)						Int byteOffset10 = (data->byteOffset + (offset + (int)2));
HXDLIN( 148)						::__hxcpp_memory_set_byte(data->buffer->b,byteOffset10,val10);
            					}
            				}
HXLINE( 149)				{
HXLINE( 149)					HX_VARI_NAME( Int,val11,"val") = ((int)this1 & (int)(int)255);
HXDLIN( 149)					{
HXLINE( 149)						Int byteOffset11 = (data->byteOffset + (offset + (int)3));
HXDLIN( 149)						::__hxcpp_memory_set_byte(data->buffer->b,byteOffset11,val11);
            					}
            				}
            			}
            			break;
