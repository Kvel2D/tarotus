...
HXLINE(  23)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::utils::compress::LZMA_obj::cffi_lime_lzma_compress(hx::DynamicPtr(bytes))) );
HXDLIN(  23)		HX_VARI(  ::Dynamic,data) = Dynamic(hx::DynamicPtr(inVal));
HXLINE(  24)		Bool _hx_tmp = hx::IsNull( data );
HXDLIN(  24)		if (_hx_tmp) {
HXLINE(  24)			return null();
            		}
HXLINE(  25)		return  ::haxe::io::Bytes_obj::__new( ::Dynamic(data->__Field(HX_("length",e6,94,07,9f),hx::paccDynamic)), ::Dynamic(data->__Field(HX_("b",62,00,00,00),hx::paccDynamic)));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(LZMA_obj,compress,return )
 ...
 ::haxe::io::Bytes LZMA_obj::decompress( ::haxe::io::Bytes bytes){
            	...
            	HX_STACK_ARG(bytes,"bytes")
HXLINE(  50)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::utils::compress::LZMA_obj::cffi_lime_lzma_decompress(hx::DynamicPtr(bytes))) );
HXDLIN(  50)		HX_VARI(  ::Dynamic,data) = Dynamic(hx::DynamicPtr(inVal));
HXLINE(  51)		Bool _hx_tmp = hx::IsNull( data );
HXDLIN(  51)		if (_hx_tmp) {
HXLINE(  51)			return null();
            		}
HXLINE(  52)		return  ::haxe::io::Bytes_obj::__new( ::Dynamic(data->__Field(HX_("length",e6,94,07,9f),hx::paccDynamic)), ::Dynamic(data->__Field(HX_("b",62,00,00,00),hx::paccDynamic)));
            	}
...
HXLINE(  81)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::utils::compress::LZMA_obj::cffi_lime_lzma_compress(hx::DynamicPtr(data))) );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(LZMA_obj,lime_lzma_compress,return )
 ...
 ::Dynamic LZMA_obj::lime_lzma_decompress( ::Dynamic data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(  82)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::utils::compress::LZMA_obj::cffi_lime_lzma_decompress(hx::DynamicPtr(data))) );
...
{
{
            	HX_STACK_FRAME("lime.utils.compress.LZMA","boot",0x70edd588,"lime.utils.compress.LZMA.boot","lime/utils/compress/LZMA.hx",81,0x3a5f97c7)
HXLINE(  81)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_lzma_compress",75,e7,f2,95),HX_("oo",20,61,00,00),false);
HXDLIN(  81)		cffi_lime_lzma_compress = inValue;
            	}
{
            	HX_STACK_FRAME("lime.utils.compress.LZMA","boot",0x70edd588,"lime.utils.compress.LZMA.boot","lime/utils/compress/LZMA.hx",82,0x3a5f97c7)
HXLINE(  82)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_lzma_decompress",b6,02,4e,98),HX_("oo",20,61,00,00),false);
HXDLIN(  82)		cffi_lime_lzma_decompress = inValue;
            	}
}
