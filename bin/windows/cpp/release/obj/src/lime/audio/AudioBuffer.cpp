...
HXLINE(  75)		Bool _hx_tmp = hx::IsNull( bytes );
HXDLIN(  75)		if (_hx_tmp) {
HXLINE(  75)			return null();
            		}
HXLINE(  83)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::audio::AudioBuffer_obj::cffi_lime_audio_load(hx::DynamicPtr(bytes))) );
HXDLIN(  83)		HX_VARI(  ::Dynamic,data) = Dynamic(hx::DynamicPtr(inVal));
HXLINE(  85)		Bool _hx_tmp1 = hx::IsNotNull( data );
HXDLIN(  85)		if (_hx_tmp1) {
HXLINE(  87)			HX_VARI(  ::lime::audio::AudioBuffer,audioBuffer) =  ::lime::audio::AudioBuffer_obj::__new();
HXLINE(  88)			audioBuffer->bitsPerSample =  ::Dynamic(data->__Field(HX_("bitsPerSample",01,01,36,c4),hx::paccDynamic));
HXLINE(  89)			audioBuffer->channels =  ::Dynamic(data->__Field(HX_("channels",50,aa,ee,6a),hx::paccDynamic));
HXLINE(  90)			HX_VARI(  ::haxe::io::Bytes,buffer) =  ::haxe::io::Bytes_obj::__new( ::Dynamic( ::Dynamic(data->__Field(HX_("data",2a,56,63,42),hx::paccDynamic))->__Field(HX_("length",e6,94,07,9f),hx::paccDynamic)), ::Dynamic( ::Dynamic(data->__Field(HX_("data",2a,56,63,42),hx::paccDynamic))->__Field(HX_("b",62,00,00,00),hx::paccDynamic)));
HXDLIN(  90)			HX_VAR_NAME(  ::lime::utils::ArrayBufferView,this1,"this");
HXDLIN(  90)			Bool _hx_tmp2 = hx::IsNotNull( buffer );
HXDLIN(  90)			if (_hx_tmp2) {
HXLINE(  90)				HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__new((int)0,(int)4);
HXDLIN(  90)				if ((hx::Mod((int)0,_this->bytesPerElement) != (int)0)) {
HXLINE(  90)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN(  90)				HX_VARI( Int,bufferByteLength) = buffer->length;
HXDLIN(  90)				{
HXLINE(  90)					if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE(  90)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN(  90)					if ((bufferByteLength < (int)0)) {
HXLINE(  90)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
            				}
HXDLIN(  90)				_this->buffer = buffer;
HXDLIN(  90)				_this->byteOffset = (int)0;
HXDLIN(  90)				_this->byteLength = bufferByteLength;
HXDLIN(  90)				Float _hx_tmp3 = ((Float)bufferByteLength / (Float)_this->bytesPerElement);
HXDLIN(  90)				_this->length = ::Std_obj::_hx_int(_hx_tmp3);
...
HXLINE(  91)			audioBuffer->sampleRate =  ::Dynamic(data->__Field(HX_("sampleRate",2a,3c,4c,67),hx::paccDynamic));
HXLINE(  92)			return audioBuffer;
            		}
...
HXLINE( 105)		Bool _hx_tmp = hx::IsNull( path );
HXDLIN( 105)		if (_hx_tmp) {
HXLINE( 105)			return null();
            		}
HXLINE( 134)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::audio::AudioBuffer_obj::cffi_lime_audio_load(hx::DynamicPtr(path))) );
HXDLIN( 134)		HX_VARI(  ::Dynamic,data) = Dynamic(hx::DynamicPtr(inVal));
HXLINE( 136)		Bool _hx_tmp1 = hx::IsNotNull( data );
HXDLIN( 136)		if (_hx_tmp1) {
HXLINE( 138)			HX_VARI(  ::lime::audio::AudioBuffer,audioBuffer) =  ::lime::audio::AudioBuffer_obj::__new();
HXLINE( 139)			audioBuffer->bitsPerSample =  ::Dynamic(data->__Field(HX_("bitsPerSample",01,01,36,c4),hx::paccDynamic));
HXLINE( 140)			audioBuffer->channels =  ::Dynamic(data->__Field(HX_("channels",50,aa,ee,6a),hx::paccDynamic));
HXLINE( 141)			HX_VARI(  ::haxe::io::Bytes,buffer) =  ::haxe::io::Bytes_obj::__new( ::Dynamic( ::Dynamic(data->__Field(HX_("data",2a,56,63,42),hx::paccDynamic))->__Field(HX_("length",e6,94,07,9f),hx::paccDynamic)), ::Dynamic( ::Dynamic(data->__Field(HX_("data",2a,56,63,42),hx::paccDynamic))->__Field(HX_("b",62,00,00,00),hx::paccDynamic)));
HXDLIN( 141)			HX_VAR_NAME(  ::lime::utils::ArrayBufferView,this1,"this");
HXDLIN( 141)			Bool _hx_tmp2 = hx::IsNotNull( buffer );
HXDLIN( 141)			if (_hx_tmp2) {
HXLINE( 141)				HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__new((int)0,(int)4);
HXDLIN( 141)				if ((hx::Mod((int)0,_this->bytesPerElement) != (int)0)) {
HXLINE( 141)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 141)				HX_VARI( Int,bufferByteLength) = buffer->length;
HXDLIN( 141)				{
HXLINE( 141)					if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 141)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 141)					if ((bufferByteLength < (int)0)) {
HXLINE( 141)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
            				}
HXDLIN( 141)				_this->buffer = buffer;
HXDLIN( 141)				_this->byteOffset = (int)0;
HXDLIN( 141)				_this->byteLength = bufferByteLength;
HXDLIN( 141)				Float _hx_tmp3 = ((Float)bufferByteLength / (Float)_this->bytesPerElement);
HXDLIN( 141)				_this->length = ::Std_obj::_hx_int(_hx_tmp3);
HXDLIN( 141)				this1 = _this;
            			}
            			else {
HXLINE( 141)				HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            			}
HXDLIN( 141)			audioBuffer->data = this1;
HXLINE( 142)			audioBuffer->sampleRate =  ::Dynamic(data->__Field(HX_("sampleRate",2a,3c,4c,67),hx::paccDynamic));
HXLINE( 143)			return audioBuffer;
            		}
...
void AudioBuffer_obj::fromURL(::String url, ::Dynamic handler){
            	HX_STACK_FRAME("lime.audio.AudioBuffer","fromURL",0x4f3e95dc,"lime.audio.AudioBuffer.fromURL","lime/audio/AudioBuffer.hx",156,0x5fb686fb)
            	HX_STACK_ARG(url,"url")
            	HX_STACK_ARG(handler,"handler")
HXLINE( 156)		Bool _hx_tmp;
HXDLIN( 156)		Bool _hx_tmp1;
HXDLIN( 156)		Bool _hx_tmp2 = hx::IsNotNull( url );
HXDLIN( 156)		if (_hx_tmp2) {
HXLINE( 156)			Int _hx_tmp3 = url.indexOf(HX_("http://",52,75,cd,5a),null());
HXDLIN( 156)			_hx_tmp1 = (_hx_tmp3 == (int)-1);
            		}
            		else {
HXLINE( 156)			_hx_tmp1 = false;
            		}
HXDLIN( 156)		if (_hx_tmp1) {
HXLINE( 156)			Int _hx_tmp4 = url.indexOf(HX_("https://",cf,b4,ae,3e),null());
HXDLIN( 156)			_hx_tmp = (_hx_tmp4 == (int)-1);
            		}
            		else {
HXLINE( 156)			_hx_tmp = false;
            		}
HXDLIN( 156)		if (_hx_tmp) {
HXLINE( 158)			 ::lime::audio::AudioBuffer _hx_tmp5 = ::lime::audio::AudioBuffer_obj::fromFile(url);
HXDLIN( 158)			handler(_hx_tmp5);
            		}
            	}
...
HXLINE( 195)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::audio::AudioBuffer_obj::cffi_lime_audio_load(hx::DynamicPtr(data))) );
...
{
{
            	HX_STACK_FRAME("lime.audio.AudioBuffer","boot",0x987e261b,"lime.audio.AudioBuffer.boot","lime/audio/AudioBuffer.hx",195,0x5fb686fb)
HXLINE( 195)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_audio_load",99,89,38,30),HX_("oo",20,61,00,00),false);
HXDLIN( 195)		cffi_lime_audio_load = inValue;
            	}
}
