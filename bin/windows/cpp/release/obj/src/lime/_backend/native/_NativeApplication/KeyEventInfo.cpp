...
HXLINE( 815)		this->type = type;
HXLINE( 816)		this->windowID = windowID;
HXLINE( 817)		this->keyCode = keyCode;
HXLINE( 818)		this->modifier = modifier;
            	}
...
Dynamic KeyEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::KeyEventInfo KeyEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.KeyEventInfo","clone",0x1c2dc9f5,"lime._backend.native._NativeApplication.KeyEventInfo.clone","lime/_backend/native/NativeApplication.hx",825,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 825)		return  ::lime::_backend::native::_NativeApplication::KeyEventInfo_obj::__new(this->type,this->windowID,this->keyCode,this->modifier);
            	}
