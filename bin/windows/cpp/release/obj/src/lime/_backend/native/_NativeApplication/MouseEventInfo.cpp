...
HXLINE( 856)		this->type = type;
HXLINE( 857)		this->windowID = (int)0;
HXLINE( 858)		this->x = x;
HXLINE( 859)		this->y = y;
HXLINE( 860)		this->button = button;
HXLINE( 861)		this->movementX = movementX;
HXLINE( 862)		this->movementY = movementY;
            	}
...
Dynamic MouseEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::MouseEventInfo MouseEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.MouseEventInfo","clone",0xea05ad6f,"lime._backend.native._NativeApplication.MouseEventInfo.clone","lime/_backend/native/NativeApplication.hx",869,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 869)		return  ::lime::_backend::native::_NativeApplication::MouseEventInfo_obj::__new(this->type,this->windowID,this->x,this->y,this->button,this->movementX,this->movementY);
            	}
