...
Int y = __o_y.Default(0);
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 771)		this->type = type;
HXLINE( 772)		this->id = id;
HXLINE( 773)		this->index = index;
HXLINE( 774)		this->value = value;
HXLINE( 775)		this->x = x;
HXLINE( 776)		this->y = y;
            	}
...
Dynamic JoystickEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::JoystickEventInfo JoystickEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.JoystickEventInfo","clone",0x8796a4de,"lime._backend.native._NativeApplication.JoystickEventInfo.clone","lime/_backend/native/NativeApplication.hx",783,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 783)		return  ::lime::_backend::native::_NativeApplication::JoystickEventInfo_obj::__new(this->type,this->id,this->index,this->value,this->x,this->y);
            	}
