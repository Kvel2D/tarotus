...
HXLINE( 729)		this->id = id;
HXLINE( 730)		this->button = button;
HXLINE( 731)		this->axis = axis;
HXLINE( 732)		this->value = value;
            	}
...
Dynamic GamepadEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::GamepadEventInfo GamepadEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.GamepadEventInfo","clone",0x156147b3,"lime._backend.native._NativeApplication.GamepadEventInfo.clone","lime/_backend/native/NativeApplication.hx",739,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 739)		return  ::lime::_backend::native::_NativeApplication::GamepadEventInfo_obj::__new(this->type,this->id,this->button,this->axis,this->value);
            	}
