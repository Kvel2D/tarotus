...
Dynamic SensorEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::SensorEventInfo SensorEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.SensorEventInfo","clone",0x0a92d260,"lime._backend.native._NativeApplication.SensorEventInfo.clone","lime/_backend/native/NativeApplication.hx",944,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 944)		return  ::lime::_backend::native::_NativeApplication::SensorEventInfo_obj::__new(this->type,this->id,this->x,this->y,this->z);
            	}
