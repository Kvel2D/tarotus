...
Dynamic DropEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::DropEventInfo DropEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.DropEventInfo","clone",0xb714194b,"lime._backend.native._NativeApplication.DropEventInfo.clone","lime/_backend/native/NativeApplication.hx",701,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 701)		return  ::lime::_backend::native::_NativeApplication::DropEventInfo_obj::__new(this->type,this->file);
            	}
