...
HXLINE(1014)		this->type = type;
HXLINE(1015)		this->x = x;
HXLINE(1016)		this->y = y;
HXLINE(1017)		this->id = id;
HXLINE(1018)		this->dx = dx;
HXLINE(1019)		this->dy = dy;
HXLINE(1020)		this->pressure = pressure;
HXLINE(1021)		this->device = device;
            	}
...
Dynamic TouchEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::TouchEventInfo TouchEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.TouchEventInfo","clone",0xdd198915,"lime._backend.native._NativeApplication.TouchEventInfo.clone","lime/_backend/native/NativeApplication.hx",1028,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE(1028)		return  ::lime::_backend::native::_NativeApplication::TouchEventInfo_obj::__new(this->type,this->x,this->y,this->id,this->dx,this->dy,this->pressure,this->device);
            	}
