...
HXLINE( 400)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_active_texture(texture);
            	}
...
HXLINE( 413)		program->attach(shader);
HXLINE( 414)		{
HXLINE( 414)			 ::Dynamic program1 = program->id;
HXDLIN( 414)			 ::Dynamic shader1 = shader->id;
HXDLIN( 414)			 ::hx::Object * _hx_tmp = hx::DynamicPtr(program1);
HXDLIN( 414)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_attach_shader(_hx_tmp,hx::DynamicPtr(shader1));
            		}
            	}
...
HXLINE( 428)		 ::Dynamic program1 = program->id;
HXDLIN( 428)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_attrib_location(hx::DynamicPtr(program1),index,name);
            	}
...
HXLINE( 441)		 ::Dynamic buffer1;
HXDLIN( 441)		Bool _hx_tmp = hx::IsNull( buffer );
HXDLIN( 441)		if (_hx_tmp) {
HXLINE( 441)			buffer1 = null();
            		}
            		else {
HXLINE( 441)			buffer1 = buffer->id;
            		}
HXDLIN( 441)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_buffer(target,hx::DynamicPtr(buffer1));
            	}
...
HXLINE( 454)		 ::Dynamic framebuffer1;
HXDLIN( 454)		Bool _hx_tmp = hx::IsNull( framebuffer );
HXDLIN( 454)		if (_hx_tmp) {
HXLINE( 454)			framebuffer1 = null();
            		}
            		else {
HXLINE( 454)			framebuffer1 = framebuffer->id;
            		}
HXDLIN( 454)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_framebuffer(target,hx::DynamicPtr(framebuffer1));
            	}
...
HXLINE( 467)		 ::Dynamic renderbuffer1;
HXDLIN( 467)		Bool _hx_tmp = hx::IsNull( renderbuffer );
HXDLIN( 467)		if (_hx_tmp) {
HXLINE( 467)			renderbuffer1 = null();
            		}
            		else {
HXLINE( 467)			renderbuffer1 = renderbuffer->id;
            		}
HXDLIN( 467)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_renderbuffer(target,hx::DynamicPtr(renderbuffer1));
            	}
...
void GL_obj::bindTexture(Int target, ::lime::graphics::opengl::GLTexture texture){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(texture,"texture")
HXLINE( 480)		 ::Dynamic texture1;
HXDLIN( 480)		Bool _hx_tmp = hx::IsNull( texture );
HXDLIN( 480)		if (_hx_tmp) {
HXLINE( 480)			texture1 = null();
            		}
            		else {
HXLINE( 480)			texture1 = texture->id;
            		}
HXDLIN( 480)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_texture(target,hx::DynamicPtr(texture1));
            	}
...
HXLINE( 493)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_color(red,green,blue,alpha);
            	}
...
HXLINE( 506)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_equation(mode);
            	}
...
HXLINE( 519)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_equation_separate(modeRGB,modeAlpha);
            	}
...
HXLINE( 532)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_func(sfactor,dfactor);
            	}
...
HXLINE( 545)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_func_separate(srcRGB,dstRGB,srcAlpha,dstAlpha);
            	}
...
HXLINE( 558)		Int byteOffset = data->byteOffset;
HXDLIN( 558)		Int size = data->byteLength;
HXDLIN( 558)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_buffer_data(target,hx::DynamicPtr(data->buffer),byteOffset,size,usage);
            	}
...
void GL_obj::bufferSubData(Int target,Int offset, ::lime::utils::ArrayBufferView data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 573)		Int byteOffset = data->byteOffset;
HXDLIN( 573)		Int size = data->byteLength;
HXDLIN( 573)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_buffer_sub_data(target,offset,hx::DynamicPtr(data->buffer),byteOffset,size);
            	}
...
Int GL_obj::checkFramebufferStatus(Int target){
            	...
            	HX_STACK_ARG(target,"target")
HXLINE( 588)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_check_framebuffer_status(target)) );
            	}
...
HXLINE( 603)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_clear(mask);
            	}
...
void GL_obj::clearColor(Float red,Float green,Float blue,Float alpha){
            	...
            	HX_STACK_ARG(blue,"blue")
            	HX_STACK_ARG(alpha,"alpha")
HXLINE( 616)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_clear_color(red,green,blue,alpha);
            	}
...
HXLINE( 629)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_clear_depth(depth);
            	}
...
void GL_obj::clearStencil(Int s){
            	...
            	HX_STACK_ARG(s,"s")
HXLINE( 642)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_clear_stencil(s);
            	}
...
void GL_obj::colorMask(Bool red,Bool green,Bool blue,Bool alpha){
            	...
            	HX_STACK_ARG(blue,"blue")
            	HX_STACK_ARG(alpha,"alpha")
HXLINE( 655)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_color_mask(red,green,blue,alpha);
            	}
...
void GL_obj::compileShader( ::lime::graphics::opengl::GLShader shader){
            	...
            	HX_STACK_ARG(shader,"shader")
HXLINE( 668)		 ::Dynamic shader1 = shader->id;
HXDLIN( 668)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_compile_shader(hx::DynamicPtr(shader1));
            	}
...
void GL_obj::compressedTexImage2D(Int target,Int level,Int internalformat,Int width,Int height,Int border, ::lime::utils::ArrayBufferView data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 681)		HX_VAR(  ::haxe::io::Bytes,buffer);
HXDLIN( 681)		Bool _hx_tmp = hx::IsNull( data );
HXDLIN( 681)		if (_hx_tmp) {
HXLINE( 681)			buffer = null();
            		}
            		else {
HXLINE( 681)			buffer = data->buffer;
            		}
HXLINE( 682)		{
HXLINE( 682)			Int byteOffset;
HXDLIN( 682)			Bool _hx_tmp1 = hx::IsNull( data );
HXDLIN( 682)			if (_hx_tmp1) {
HXLINE( 682)				byteOffset = (int)0;
            			}
            			else {
HXLINE( 682)				byteOffset = data->byteOffset;
            			}
HXDLIN( 682)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_compressed_tex_image_2d(target,level,internalformat,width,height,border,hx::DynamicPtr(buffer),byteOffset);
            		}
            	}
...
void GL_obj::compressedTexSubImage2D(Int target,Int level,Int xoffset,Int yoffset,Int width,Int height,Int format, ::lime::utils::ArrayBufferView data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 697)		HX_VAR(  ::haxe::io::Bytes,buffer);
HXDLIN( 697)		Bool _hx_tmp = hx::IsNull( data );
HXDLIN( 697)		if (_hx_tmp) {
HXLINE( 697)			buffer = null();
            		}
            		else {
HXLINE( 697)			buffer = data->buffer;
            		}
HXLINE( 698)		{
HXLINE( 698)			Int byteOffset;
HXDLIN( 698)			Bool _hx_tmp1 = hx::IsNull( data );
HXDLIN( 698)			if (_hx_tmp1) {
HXLINE( 698)				byteOffset = (int)0;
            			}
            			else {
HXLINE( 698)				byteOffset = data->byteOffset;
            			}
HXDLIN( 698)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_compressed_tex_sub_image_2d(target,level,xoffset,yoffset,width,height,format,hx::DynamicPtr(buffer),byteOffset);
            		}
            	}
...
void GL_obj::copyTexImage2D(Int target,Int level,Int internalformat,Int x,Int y,Int width,Int height,Int border){
            	...
            	HX_STACK_ARG(height,"height")
            	HX_STACK_ARG(border,"border")
HXLINE( 713)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_copy_tex_image_2d(target,level,internalformat,x,y,width,height,border);
            	}
...
void GL_obj::copyTexSubImage2D(Int target,Int level,Int xoffset,Int yoffset,Int x,Int y,Int width,Int height){
            	...
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE( 726)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_copy_tex_sub_image_2d(target,level,xoffset,yoffset,x,y,width,height);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC8(GL_obj,copyTexSubImage2D,(void))
 ...
 ::lime::graphics::opengl::GLBuffer GL_obj::createBuffer(){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","createBuffer",0x3ea5f4f0,"lime.graphics.opengl.GL.createBuffer","lime/graphics/opengl/GL.hx",739,0xa5aa2623)
HXLINE( 739)		Int _hx_tmp = ::lime::graphics::opengl::GL_obj::get_version();
HXDLIN( 739)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_buffer()) );
HXDLIN( 739)		 ::Dynamic _hx_tmp1 = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 739)		return  ::lime::graphics::opengl::GLBuffer_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(GL_obj,createBuffer,return )
 ...
 ::lime::graphics::opengl::GLFramebuffer GL_obj::createFramebuffer(){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","createFramebuffer",0x051616fd,"lime.graphics.opengl.GL.createFramebuffer","lime/graphics/opengl/GL.hx",755,0xa5aa2623)
HXLINE( 755)		Int _hx_tmp = ::lime::graphics::opengl::GL_obj::get_version();
HXDLIN( 755)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_framebuffer()) );
HXDLIN( 755)		 ::Dynamic _hx_tmp1 = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 755)		return  ::lime::graphics::opengl::GLFramebuffer_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(GL_obj,createFramebuffer,return )
 ...
 ::lime::graphics::opengl::GLProgram GL_obj::createProgram(){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","createProgram",0xd4f90494,"lime.graphics.opengl.GL.createProgram","lime/graphics/opengl/GL.hx",771,0xa5aa2623)
HXLINE( 771)		Int _hx_tmp = ::lime::graphics::opengl::GL_obj::get_version();
HXDLIN( 771)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_program()) );
HXDLIN( 771)		 ::Dynamic _hx_tmp1 = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 771)		return  ::lime::graphics::opengl::GLProgram_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(GL_obj,createProgram,return )
 ...
 ::lime::graphics::opengl::GLRenderbuffer GL_obj::createRenderbuffer(){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","createRenderbuffer",0xf4ca18c6,"lime.graphics.opengl.GL.createRenderbuffer","lime/graphics/opengl/GL.hx",786,0xa5aa2623)
HXLINE( 786)		Int _hx_tmp = ::lime::graphics::opengl::GL_obj::get_version();
HXDLIN( 786)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_render_buffer()) );
HXDLIN( 786)		 ::Dynamic _hx_tmp1 = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 786)		return  ::lime::graphics::opengl::GLRenderbuffer_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(GL_obj,createRenderbuffer,return )
 ...
 ::lime::graphics::opengl::GLShader GL_obj::createShader(Int type){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","createShader",0x8b31f715,"lime.graphics.opengl.GL.createShader","lime/graphics/opengl/GL.hx",802,0xa5aa2623)
            	HX_STACK_ARG(type,"type")
HXLINE( 802)		Int _hx_tmp = ::lime::graphics::opengl::GL_obj::get_version();
HXDLIN( 802)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_shader(type)) );
HXDLIN( 802)		 ::Dynamic _hx_tmp1 = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 802)		return  ::lime::graphics::opengl::GLShader_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(GL_obj,createShader,return )
 ...
 ::lime::graphics::opengl::GLTexture GL_obj::createTexture(){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","createTexture",0x7fe082eb,"lime.graphics.opengl.GL.createTexture","lime/graphics/opengl/GL.hx",817,0xa5aa2623)
HXLINE( 817)		Int _hx_tmp = ::lime::graphics::opengl::GL_obj::get_version();
HXDLIN( 817)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_texture()) );
HXDLIN( 817)		 ::Dynamic _hx_tmp1 = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 817)		return  ::lime::graphics::opengl::GLTexture_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
void GL_obj::cullFace(Int mode){
            	...
            	HX_STACK_ARG(mode,"mode")
HXLINE( 833)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_cull_face(mode);
            	}
...
void GL_obj::deleteBuffer( ::lime::graphics::opengl::GLBuffer buffer){
            	...
            	HX_STACK_ARG(buffer,"buffer")
HXLINE( 846)		{
HXLINE( 846)			 ::Dynamic buffer1 = buffer->id;
HXDLIN( 846)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_buffer(hx::DynamicPtr(buffer1));
            		}
HXLINE( 847)		buffer->invalidate();
            	}
...
void GL_obj::deleteFramebuffer( ::lime::graphics::opengl::GLFramebuffer framebuffer){
            	...
            	HX_STACK_ARG(framebuffer,"framebuffer")
HXLINE( 861)		{
HXLINE( 861)			 ::Dynamic framebuffer1 = framebuffer->id;
HXDLIN( 861)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_framebuffer(hx::DynamicPtr(framebuffer1));
            		}
HXLINE( 862)		framebuffer->invalidate();
            	}
...
void GL_obj::deleteProgram( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE( 876)		{
HXLINE( 876)			 ::Dynamic program1 = program->id;
HXDLIN( 876)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_program(hx::DynamicPtr(program1));
            		}
HXLINE( 877)		program->invalidate();
            	}
...
void GL_obj::deleteRenderbuffer( ::lime::graphics::opengl::GLRenderbuffer renderbuffer){
            	...
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE( 891)		{
HXLINE( 891)			 ::Dynamic renderbuffer1 = renderbuffer->id;
HXDLIN( 891)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_render_buffer(hx::DynamicPtr(renderbuffer1));
            		}
HXLINE( 892)		renderbuffer->invalidate();
            	}
...
void GL_obj::deleteShader( ::lime::graphics::opengl::GLShader shader){
            	...
            	HX_STACK_ARG(shader,"shader")
HXLINE( 906)		{
HXLINE( 906)			 ::Dynamic shader1 = shader->id;
HXDLIN( 906)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_shader(hx::DynamicPtr(shader1));
            		}
HXLINE( 907)		shader->invalidate();
            	}
...
void GL_obj::deleteTexture( ::lime::graphics::opengl::GLTexture texture){
            	...
            	HX_STACK_ARG(texture,"texture")
HXLINE( 921)		{
HXLINE( 921)			 ::Dynamic texture1 = texture->id;
HXDLIN( 921)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_texture(hx::DynamicPtr(texture1));
            		}
HXLINE( 922)		texture->invalidate();
            	}
...
HXLINE( 936)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_depth_func(func);
            	}
...
HXLINE( 949)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_depth_mask(flag);
            	}
...
HXLINE( 962)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_depth_range(zNear,zFar);
            	}
...
void GL_obj::detachShader( ::lime::graphics::opengl::GLProgram program, ::lime::graphics::opengl::GLShader shader){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(shader,"shader")
HXLINE( 975)		 ::Dynamic program1 = program->id;
HXDLIN( 975)		 ::Dynamic shader1 = shader->id;
HXDLIN( 975)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(program1);
HXDLIN( 975)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_detach_shader(_hx_tmp,hx::DynamicPtr(shader1));
            	}
...
HXLINE( 988)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_disable(cap);
            	}
...
void GL_obj::disableVertexAttribArray(Int index){
            	...
            	HX_STACK_ARG(index,"index")
HXLINE(1001)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_disable_vertex_attrib_array(index);
            	}
...
HXLINE(1014)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_draw_arrays(mode,first,count);
            	}
...
void GL_obj::drawElements(Int mode,Int count,Int type,Int offset){
            	...
            	HX_STACK_ARG(type,"type")
            	HX_STACK_ARG(offset,"offset")
HXLINE(1027)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_draw_elements(mode,count,type,offset);
            	}
...
void GL_obj::enable(Int cap){
            	...
            	HX_STACK_ARG(cap,"cap")
HXLINE(1040)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_enable(cap);
            	}
...
void GL_obj::enableVertexAttribArray(Int index){
            	...
            	HX_STACK_ARG(index,"index")
HXLINE(1053)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_enable_vertex_attrib_array(index);
            	}
...
HXLINE(1066)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_finish();
            	}
...
HXLINE(1079)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_flush();
            	}
...
void GL_obj::framebufferRenderbuffer(Int target,Int attachment,Int renderbuffertarget, ::lime::graphics::opengl::GLRenderbuffer renderbuffer){
            	...
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE(1092)		 ::Dynamic renderbuffer1 = renderbuffer->id;
HXDLIN(1092)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_framebuffer_renderbuffer(target,attachment,renderbuffertarget,hx::DynamicPtr(renderbuffer1));
            	}
...
void GL_obj::framebufferTexture2D(Int target,Int attachment,Int textarget, ::lime::graphics::opengl::GLTexture texture,Int level){
            	...
            	HX_STACK_ARG(texture,"texture")
            	HX_STACK_ARG(level,"level")
HXLINE(1105)		 ::Dynamic texture1 = texture->id;
HXDLIN(1105)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_framebuffer_texture2D(target,attachment,textarget,hx::DynamicPtr(texture1),level);
            	}
...
void GL_obj::frontFace(Int mode){
            	...
            	HX_STACK_ARG(mode,"mode")
HXLINE(1118)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_front_face(mode);
            	}
...
void GL_obj::generateMipmap(Int target){
            	...
            	HX_STACK_ARG(target,"target")
HXLINE(1131)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_generate_mipmap(target);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(GL_obj,generateMipmap,(void))
 ...
 ::Dynamic GL_obj::getActiveAttrib( ::lime::graphics::opengl::GLProgram program,Int index){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(index,"index")
HXLINE(1144)		 ::Dynamic program1 = program->id;
HXDLIN(1144)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_active_attrib(hx::DynamicPtr(program1),index)) );
HXDLIN(1144)		HX_VARI(  ::Dynamic,result) = Dynamic(hx::DynamicPtr(inVal));
HXLINE(1145)		return result;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(GL_obj,getActiveAttrib,return )
 ...
 ::Dynamic GL_obj::getActiveUniform( ::lime::graphics::opengl::GLProgram program,Int index){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(index,"index")
HXLINE(1161)		 ::Dynamic program1 = program->id;
HXDLIN(1161)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_active_uniform(hx::DynamicPtr(program1),index)) );
HXDLIN(1161)		HX_VARI(  ::Dynamic,result) = Dynamic(hx::DynamicPtr(inVal));
HXLINE(1162)		return result;
            	}
...
::Array< ::Dynamic> GL_obj::getAttachedShaders( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE(1178)		return program->getShaders();
            	}
...
Int GL_obj::getAttribLocation( ::lime::graphics::opengl::GLProgram program,::String name){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(name,"name")
HXLINE(1193)		 ::Dynamic program1 = program->id;
HXDLIN(1193)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_attrib_location(hx::DynamicPtr(program1),name)) );
            	}
...
HXLINE(1208)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_buffer_parameter(target,pname)) );
            	}
...
HXLINE(1224)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_context_attributes()) );
HXDLIN(1224)		HX_VARI(  ::Dynamic,base) = Dynamic(hx::DynamicPtr(inVal));
HXLINE(1225)		base->__SetField(HX_("premultipliedAlpha",28,8e,5c,1a),false,hx::paccDynamic);
HXLINE(1226)		base->__SetField(HX_("preserveDrawingBuffer",92,bb,1e,4b),false,hx::paccDynamic);
HXLINE(1227)		return base;
            	}
...
HXLINE(1246)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_error()) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(GL_obj,getError,return )
 ...
 ::Dynamic GL_obj::getExtension(::String name){
            	...
            	HX_STACK_ARG(name,"name")
HXLINE(1261)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_extension(name)) );
HXDLIN(1261)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Int GL_obj::getFramebufferAttachmentParameter(Int target,Int attachment,Int pname){
            	...
            	HX_STACK_ARG(attachment,"attachment")
            	HX_STACK_ARG(pname,"pname")
HXLINE(1274)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_framebuffer_attachment_parameter(target,attachment,pname)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(GL_obj,getFramebufferAttachmentParameter,return )
 ...
 ::Dynamic GL_obj::getParameter(Int pname){
            	...
            	HX_STACK_ARG(pname,"pname")
HXLINE(1290)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_parameter(pname)) );
HXDLIN(1290)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
::String GL_obj::getProgramInfoLog( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE(1305)		 ::Dynamic program1 = program->id;
HXDLIN(1305)		return ( (::String)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_program_info_log(hx::DynamicPtr(program1))) );
            	}
...
Int GL_obj::getProgramParameter( ::lime::graphics::opengl::GLProgram program,Int pname){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(pname,"pname")
HXLINE(1320)		 ::Dynamic program1 = program->id;
HXDLIN(1320)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_program_parameter(hx::DynamicPtr(program1),pname)) );
            	}
...
Int GL_obj::getRenderbufferParameter(Int target,Int pname){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(pname,"pname")
HXLINE(1336)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_render_buffer_parameter(target,pname)) );
            	}
...
::String GL_obj::getShaderInfoLog( ::lime::graphics::opengl::GLShader shader){
            	...
            	HX_STACK_ARG(shader,"shader")
HXLINE(1352)		 ::Dynamic shader1 = shader->id;
HXDLIN(1352)		return ( (::String)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_info_log(hx::DynamicPtr(shader1))) );
            	}
...
Int GL_obj::getShaderParameter( ::lime::graphics::opengl::GLShader shader,Int pname){
            	...
            	HX_STACK_ARG(shader,"shader")
            	HX_STACK_ARG(pname,"pname")
HXLINE(1367)		 ::Dynamic shader1 = shader->id;
HXDLIN(1367)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_parameter(hx::DynamicPtr(shader1),pname)) );
            	}
...
HXLINE(1383)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_precision_format(shadertype,precisiontype)) );
HXDLIN(1383)		HX_VARI(  ::Dynamic,result) = Dynamic(hx::DynamicPtr(inVal));
HXLINE(1384)		return result;
            	}
...
::String GL_obj::getShaderSource( ::lime::graphics::opengl::GLShader shader){
            	...
            	HX_STACK_ARG(shader,"shader")
HXLINE(1400)		 ::Dynamic shader1 = shader->id;
HXDLIN(1400)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_source(hx::DynamicPtr(shader1))) );
HXDLIN(1400)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE(1415)		HX_VARI( ::Array< ::String >,result) = ::Array_obj< ::String >::__new();
HXLINE(1416)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_supported_extensions(hx::DynamicPtr(result));
HXLINE(1417)		return result;
            	}
...
Int GL_obj::getTexParameter(Int target,Int pname){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(pname,"pname")
HXLINE(1432)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_tex_parameter(target,pname)) );
            	}
...
HXLINE(1448)		 ::Dynamic program1 = program->id;
HXDLIN(1448)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_uniform(hx::DynamicPtr(program1),location)) );
HXDLIN(1448)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Int GL_obj::getUniformLocation( ::lime::graphics::opengl::GLProgram program,::String name){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(name,"name")
HXLINE(1464)		 ::Dynamic program1 = program->id;
HXDLIN(1464)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_uniform_location(hx::DynamicPtr(program1),name)) );
            	}
...
Int GL_obj::getVertexAttrib(Int index,Int pname){
            	...
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(pname,"pname")
HXLINE(1479)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_vertex_attrib(index,pname)) );
            	}
...
Int GL_obj::getVertexAttribOffset(Int index,Int pname){
            	...
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(pname,"pname")
HXLINE(1494)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_vertex_attrib_offset(index,pname)) );
            	}
...
void GL_obj::hint(Int target,Int mode){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(mode,"mode")
HXLINE(1509)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_hint(target,mode);
            	}
...
Bool GL_obj::isBuffer( ::lime::graphics::opengl::GLBuffer buffer){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","isBuffer",0x3244d65e,"lime.graphics.opengl.GL.isBuffer","lime/graphics/opengl/GL.hx",1520,0xa5aa2623)
            	HX_STACK_ARG(buffer,"buffer")
HXLINE(1520)		Bool _hx_tmp;
HXDLIN(1520)		Bool _hx_tmp1 = hx::IsNotNull( buffer );
HXDLIN(1520)		if (_hx_tmp1) {
HXLINE(1520)			 ::Dynamic a = buffer->id;
HXDLIN(1520)			Float _hx_tmp2 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(a);
HXDLIN(1520)			_hx_tmp = (_hx_tmp2 > (int)0);
            		}
            		else {
HXLINE(1520)			_hx_tmp = false;
            		}
HXDLIN(1520)		if (_hx_tmp) {
HXLINE(1520)			 ::Dynamic buffer1 = buffer->id;
HXDLIN(1520)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_buffer(hx::DynamicPtr(buffer1))) );
            		}
            		else {
HXLINE(1520)			return false;
            		}
HXDLIN(1520)		return false;
            	}
...
Bool GL_obj::isEnabled(Int cap){
            	...
            	HX_STACK_ARG(cap,"cap")
HXLINE(1544)		return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_enabled(cap)) );
            	}
...
Bool GL_obj::isFramebuffer( ::lime::graphics::opengl::GLFramebuffer framebuffer){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","isFramebuffer",0x7c2946cf,"lime.graphics.opengl.GL.isFramebuffer","lime/graphics/opengl/GL.hx",1557,0xa5aa2623)
            	HX_STACK_ARG(framebuffer,"framebuffer")
HXLINE(1557)		Bool _hx_tmp;
HXDLIN(1557)		Bool _hx_tmp1 = hx::IsNotNull( framebuffer );
HXDLIN(1557)		if (_hx_tmp1) {
HXLINE(1557)			 ::Dynamic a = framebuffer->id;
HXDLIN(1557)			Float _hx_tmp2 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(a);
HXDLIN(1557)			_hx_tmp = (_hx_tmp2 > (int)0);
            		}
            		else {
HXLINE(1557)			_hx_tmp = false;
            		}
HXDLIN(1557)		if (_hx_tmp) {
HXLINE(1557)			 ::Dynamic framebuffer1 = framebuffer->id;
HXDLIN(1557)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_framebuffer(hx::DynamicPtr(framebuffer1))) );
            		}
            		else {
HXLINE(1557)			return false;
            		}
HXDLIN(1557)		return false;
            	}
...
Bool GL_obj::isProgram( ::lime::graphics::opengl::GLProgram program){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","isProgram",0x0c5f6366,"lime.graphics.opengl.GL.isProgram","lime/graphics/opengl/GL.hx",1570,0xa5aa2623)
            	HX_STACK_ARG(program,"program")
HXLINE(1570)		Bool _hx_tmp;
HXDLIN(1570)		Bool _hx_tmp1 = hx::IsNotNull( program );
HXDLIN(1570)		if (_hx_tmp1) {
HXLINE(1570)			 ::Dynamic a = program->id;
HXDLIN(1570)			Float _hx_tmp2 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(a);
HXDLIN(1570)			_hx_tmp = (_hx_tmp2 > (int)0);
            		}
            		else {
HXLINE(1570)			_hx_tmp = false;
            		}
HXDLIN(1570)		if (_hx_tmp) {
HXLINE(1570)			 ::Dynamic program1 = program->id;
HXDLIN(1570)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_program(hx::DynamicPtr(program1))) );
            		}
            		else {
HXLINE(1570)			return false;
            		}
HXDLIN(1570)		return false;
            	}
...
Bool GL_obj::isRenderbuffer( ::lime::graphics::opengl::GLRenderbuffer renderbuffer){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","isRenderbuffer",0xae80c0b4,"lime.graphics.opengl.GL.isRenderbuffer","lime/graphics/opengl/GL.hx",1583,0xa5aa2623)
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE(1583)		Bool _hx_tmp;
HXDLIN(1583)		Bool _hx_tmp1 = hx::IsNotNull( renderbuffer );
HXDLIN(1583)		if (_hx_tmp1) {
HXLINE(1583)			 ::Dynamic a = renderbuffer->id;
HXDLIN(1583)			Float _hx_tmp2 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(a);
HXDLIN(1583)			_hx_tmp = (_hx_tmp2 > (int)0);
            		}
            		else {
HXLINE(1583)			_hx_tmp = false;
            		}
HXDLIN(1583)		if (_hx_tmp) {
HXLINE(1583)			 ::Dynamic renderbuffer1 = renderbuffer->id;
HXDLIN(1583)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_renderbuffer(hx::DynamicPtr(renderbuffer1))) );
            		}
            		else {
HXLINE(1583)			return false;
            		}
HXDLIN(1583)		return false;
            	}
...
Bool GL_obj::isShader( ::lime::graphics::opengl::GLShader shader){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","isShader",0x7ed0d883,"lime.graphics.opengl.GL.isShader","lime/graphics/opengl/GL.hx",1596,0xa5aa2623)
            	HX_STACK_ARG(shader,"shader")
HXLINE(1596)		Bool _hx_tmp;
HXDLIN(1596)		Bool _hx_tmp1 = hx::IsNotNull( shader );
HXDLIN(1596)		if (_hx_tmp1) {
HXLINE(1596)			 ::Dynamic a = shader->id;
HXDLIN(1596)			Float _hx_tmp2 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(a);
HXDLIN(1596)			_hx_tmp = (_hx_tmp2 > (int)0);
            		}
            		else {
HXLINE(1596)			_hx_tmp = false;
            		}
HXDLIN(1596)		if (_hx_tmp) {
HXLINE(1596)			 ::Dynamic shader1 = shader->id;
HXDLIN(1596)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_shader(hx::DynamicPtr(shader1))) );
            		}
            		else {
...
Bool GL_obj::isTexture( ::lime::graphics::opengl::GLTexture texture){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","isTexture",0xb746e1bd,"lime.graphics.opengl.GL.isTexture","lime/graphics/opengl/GL.hx",1609,0xa5aa2623)
            	HX_STACK_ARG(texture,"texture")
HXLINE(1609)		Bool _hx_tmp;
HXDLIN(1609)		Bool _hx_tmp1 = hx::IsNotNull( texture );
HXDLIN(1609)		if (_hx_tmp1) {
HXLINE(1609)			 ::Dynamic a = texture->id;
HXDLIN(1609)			Float _hx_tmp2 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(a);
HXDLIN(1609)			_hx_tmp = (_hx_tmp2 > (int)0);
            		}
            		else {
HXLINE(1609)			_hx_tmp = false;
            		}
HXDLIN(1609)		if (_hx_tmp) {
HXLINE(1609)			 ::Dynamic texture1 = texture->id;
HXDLIN(1609)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_texture(hx::DynamicPtr(texture1))) );
            		}
            		else {
...
void GL_obj::lineWidth(Float width){
            	...
            	HX_STACK_ARG(width,"width")
HXLINE(1622)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_line_width(width);
            	}
...
void GL_obj::linkProgram( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE(1633)		 ::Dynamic program1 = program->id;
HXDLIN(1633)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_link_program(hx::DynamicPtr(program1));
            	}
...
HXLINE(1644)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_pixel_storei(pname,param);
            	}
...
HXLINE(1655)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_polygon_offset(factor,units);
            	}
...
HXLINE(1666)		HX_VAR(  ::haxe::io::Bytes,buffer);
HXDLIN(1666)		Bool _hx_tmp = hx::IsNull( pixels );
HXDLIN(1666)		if (_hx_tmp) {
HXLINE(1666)			buffer = null();
            		}
            		else {
HXLINE(1666)			buffer = pixels->buffer;
            		}
HXLINE(1667)		{
HXLINE(1667)			Int byteOffset;
HXDLIN(1667)			Bool _hx_tmp1 = hx::IsNull( pixels );
HXDLIN(1667)			if (_hx_tmp1) {
HXLINE(1667)				byteOffset = (int)0;
            			}
            			else {
HXLINE(1667)				byteOffset = pixels->byteOffset;
            			}
HXDLIN(1667)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_read_pixels(x,y,width,height,format,type,hx::DynamicPtr(buffer),byteOffset);
            		}
            	}
...
void GL_obj::renderbufferStorage(Int target,Int internalformat,Int width,Int height){
            	...
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE(1680)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_renderbuffer_storage(target,internalformat,width,height);
            	}
...
HXLINE(1691)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_sample_coverage(value,invert);
            	}
...
void GL_obj::scissor(Int x,Int y,Int width,Int height){
            	...
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE(1702)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_scissor(x,y,width,height);
            	}
...
HXLINE(1713)		 ::Dynamic shader1 = shader->id;
HXDLIN(1713)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_shader_source(hx::DynamicPtr(shader1),source);
            	}
...
void GL_obj::stencilFunc(Int func,Int ref,Int mask){
            	...
            	HX_STACK_ARG(mask,"mask")
HXLINE(1724)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_func(func,ref,mask);
            	}
...
void GL_obj::stencilFuncSeparate(Int face,Int func,Int ref,Int mask){
            	...
            	HX_STACK_ARG(ref,"ref")
            	HX_STACK_ARG(mask,"mask")
HXLINE(1735)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_func_separate(face,func,ref,mask);
            	}
...
void GL_obj::stencilMask(Int mask){
            	...
            	HX_STACK_ARG(mask,"mask")
HXLINE(1746)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_mask(mask);
            	}
...
void GL_obj::stencilMaskSeparate(Int face,Int mask){
            	...
            	HX_STACK_ARG(face,"face")
            	HX_STACK_ARG(mask,"mask")
HXLINE(1757)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_mask_separate(face,mask);
            	}
...
HXLINE(1768)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_op(fail,zfail,zpass);
            	}
...
void GL_obj::stencilOpSeparate(Int face,Int fail,Int zfail,Int zpass){
            	...
            	HX_STACK_ARG(zfail,"zfail")
            	HX_STACK_ARG(zpass,"zpass")
HXLINE(1779)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_op_separate(face,fail,zfail,zpass);
            	}
...
void GL_obj::texImage2D(Int target,Int level,Int internalformat,Int width,Int height,Int border,Int format,Int type, ::lime::utils::ArrayBufferView pixels){
            	...
            	HX_STACK_ARG(type,"type")
            	HX_STACK_ARG(pixels,"pixels")
HXLINE(1790)		HX_VAR(  ::haxe::io::Bytes,buffer);
HXDLIN(1790)		Bool _hx_tmp = hx::IsNull( pixels );
HXDLIN(1790)		if (_hx_tmp) {
HXLINE(1790)			buffer = null();
            		}
            		else {
HXLINE(1790)			buffer = pixels->buffer;
            		}
HXLINE(1791)		{
HXLINE(1791)			Int byteOffset;
HXDLIN(1791)			Bool _hx_tmp1 = hx::IsNull( pixels );
HXDLIN(1791)			if (_hx_tmp1) {
HXLINE(1791)				byteOffset = (int)0;
            			}
            			else {
HXLINE(1791)				byteOffset = pixels->byteOffset;
            			}
HXDLIN(1791)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_image_2d(target,level,internalformat,width,height,border,format,type,hx::DynamicPtr(buffer),byteOffset);
            		}
            	}
...
void GL_obj::texParameterf(Int target,Int pname,Float param){
            	...
            	HX_STACK_ARG(pname,"pname")
            	HX_STACK_ARG(param,"param")
HXLINE(1804)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_parameterf(target,pname,param);
            	}
...
void GL_obj::texParameteri(Int target,Int pname,Int param){
            	...
            	HX_STACK_ARG(pname,"pname")
            	HX_STACK_ARG(param,"param")
HXLINE(1815)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_parameteri(target,pname,param);
            	}
...
void GL_obj::texSubImage2D(Int target,Int level,Int xoffset,Int yoffset,Int width,Int height,Int format,Int type, ::lime::utils::ArrayBufferView pixels){
            	...
            	HX_STACK_ARG(type,"type")
            	HX_STACK_ARG(pixels,"pixels")
HXLINE(1826)		HX_VAR(  ::haxe::io::Bytes,buffer);
HXDLIN(1826)		Bool _hx_tmp = hx::IsNull( pixels );
HXDLIN(1826)		if (_hx_tmp) {
HXLINE(1826)			buffer = null();
            		}
            		else {
HXLINE(1826)			buffer = pixels->buffer;
            		}
HXLINE(1827)		{
HXLINE(1827)			Int byteOffset;
HXDLIN(1827)			Bool _hx_tmp1 = hx::IsNull( pixels );
HXDLIN(1827)			if (_hx_tmp1) {
HXLINE(1827)				byteOffset = (int)0;
            			}
            			else {
HXLINE(1827)				byteOffset = pixels->byteOffset;
            			}
HXDLIN(1827)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_sub_image_2d(target,level,xoffset,yoffset,width,height,format,type,hx::DynamicPtr(buffer),byteOffset);
            		}
            	}
...
void GL_obj::uniform1f(Int location,Float x){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
HXLINE(1840)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform1f(location,x);
            	}
...
void GL_obj::uniform1fv(Int location, ::lime::utils::ArrayBufferView x){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
HXLINE(1851)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform1fv(location,hx::DynamicPtr(x->buffer));
            	}
...
void GL_obj::uniform1i(Int location,Int x){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
HXLINE(1864)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform1i(location,x);
            	}
...
void GL_obj::uniform1iv(Int location, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(1875)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform1iv(location,hx::DynamicPtr(v->buffer));
            	}
...
void GL_obj::uniform2f(Int location,Float x,Float y){
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(1888)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform2f(location,x,y);
            	}
...
void GL_obj::uniform2fv(Int location, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(1899)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform2fv(location,hx::DynamicPtr(v->buffer));
            	}
...
void GL_obj::uniform2i(Int location,Int x,Int y){
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(1912)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform2i(location,x,y);
            	}
...
void GL_obj::uniform2iv(Int location, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(1923)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform2iv(location,hx::DynamicPtr(v->buffer));
            	}
...
void GL_obj::uniform3f(Int location,Float x,Float y,Float z){
            	...
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(z,"z")
HXLINE(1936)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform3f(location,x,y,z);
            	}
...
void GL_obj::uniform3fv(Int location, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(1947)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform3fv(location,hx::DynamicPtr(v->buffer));
            	}
...
void GL_obj::uniform3i(Int location,Int x,Int y,Int z){
            	...
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(z,"z")
HXLINE(1960)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform3i(location,x,y,z);
            	}
...
void GL_obj::uniform3iv(Int location, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(1971)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform3iv(location,hx::DynamicPtr(v->buffer));
            	}
...
void GL_obj::uniform4f(Int location,Float x,Float y,Float z,Float w){
            	...
            	HX_STACK_ARG(z,"z")
            	HX_STACK_ARG(w,"w")
HXLINE(1984)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4f(location,x,y,z,w);
            	}
...
void GL_obj::uniform4fv(Int location, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(1995)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4fv(location,hx::DynamicPtr(v->buffer));
            	}
...
void GL_obj::uniform4i(Int location,Int x,Int y,Int z,Int w){
            	...
            	HX_STACK_ARG(z,"z")
            	HX_STACK_ARG(w,"w")
HXLINE(2008)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4i(location,x,y,z,w);
            	}
...
void GL_obj::uniform4iv(Int location, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(2019)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4iv(location,hx::DynamicPtr(v->buffer));
            	}
...
void GL_obj::uniformMatrix2fv(Int location,Bool transpose, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(v,"v")
HXLINE(2032)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform_matrix(location,transpose,hx::DynamicPtr(v->buffer),(int)2);
            	}
...
void GL_obj::uniformMatrix3fv(Int location,Bool transpose, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(transpose,"transpose")
            	HX_STACK_ARG(v,"v")
HXLINE(2045)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform_matrix(location,transpose,hx::DynamicPtr(v->buffer),(int)3);
            	}
...
void GL_obj::uniformMatrix4fv(Int location,Bool transpose, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(transpose,"transpose")
            	HX_STACK_ARG(v,"v")
HXLINE(2058)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform_matrix(location,transpose,hx::DynamicPtr(v->buffer),(int)4);
            	}
...
void GL_obj::useProgram( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE(2078)		 ::Dynamic program1;
HXDLIN(2078)		Bool _hx_tmp = hx::IsNull( program );
HXDLIN(2078)		if (_hx_tmp) {
HXLINE(2078)			program1 = null();
            		}
            		else {
HXLINE(2078)			program1 = program->id;
            		}
HXDLIN(2078)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_use_program(hx::DynamicPtr(program1));
            	}
...
void GL_obj::validateProgram( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE(2089)		 ::Dynamic program1 = program->id;
HXDLIN(2089)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_validate_program(hx::DynamicPtr(program1));
            	}
...
void GL_obj::vertexAttrib1f(Int indx,Float x){
            	...
            	HX_STACK_ARG(x,"x")
HXLINE(2100)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib1f(indx,x);
            	}
...
HXLINE(2111)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib1fv(indx,hx::DynamicPtr(values->buffer));
            	}
...
void GL_obj::vertexAttrib2f(Int indx,Float x,Float y){
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(2124)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib2f(indx,x,y);
            	}
...
void GL_obj::vertexAttrib2fv(Int indx, ::lime::utils::ArrayBufferView values){
            	...
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(values,"values")
HXLINE(2135)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib2fv(indx,hx::DynamicPtr(values->buffer));
            	}
...
void GL_obj::vertexAttrib3f(Int indx,Float x,Float y,Float z){
            	...
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(z,"z")
HXLINE(2148)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib3f(indx,x,y,z);
            	}
...
void GL_obj::vertexAttrib3fv(Int indx, ::lime::utils::ArrayBufferView values){
            	...
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(values,"values")
HXLINE(2159)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib3fv(indx,hx::DynamicPtr(values->buffer));
            	}
...
void GL_obj::vertexAttrib4f(Int indx,Float x,Float y,Float z,Float w){
            	...
            	HX_STACK_ARG(z,"z")
            	HX_STACK_ARG(w,"w")
HXLINE(2172)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib4f(indx,x,y,z,w);
            	}
...
void GL_obj::vertexAttrib4fv(Int indx, ::lime::utils::ArrayBufferView values){
            	...
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(values,"values")
HXLINE(2183)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib4fv(indx,hx::DynamicPtr(values->buffer));
            	}
...
void GL_obj::vertexAttribPointer(Int indx,Int size,Int type,Bool normalized,Int stride,Int offset){
            	...
            	HX_STACK_ARG(offset,"offset")
HXLINE(2196)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib_pointer(indx,size,type,normalized,stride,offset);
            	}
...
void GL_obj::viewport(Int x,Int y,Int width,Int height){
            	...
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE(2207)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_viewport(x,y,width,height);
            	}
...
void GL_obj::lime_gl_active_texture(Int texture){
            	...
            	HX_STACK_ARG(texture,"texture")
HXLINE(2217)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_active_texture(texture);
            	}
...
void GL_obj::lime_gl_attach_shader( ::Dynamic program, ::Dynamic shader){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(shader,"shader")
HXLINE(2218)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(program);
HXDLIN(2218)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_attach_shader(_hx_tmp,hx::DynamicPtr(shader));
            	}
...
void GL_obj::lime_gl_bind_attrib_location( ::Dynamic program,Int index,::String name){
            	...
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(name,"name")
HXLINE(2219)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_attrib_location(hx::DynamicPtr(program),index,name);
            	}
...
void GL_obj::lime_gl_bind_buffer(Int target, ::Dynamic buffer){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(buffer,"buffer")
HXLINE(2220)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_buffer(target,hx::DynamicPtr(buffer));
            	}
...
void GL_obj::lime_gl_bind_framebuffer(Int target, ::Dynamic framebuffer){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(framebuffer,"framebuffer")
HXLINE(2221)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_framebuffer(target,hx::DynamicPtr(framebuffer));
            	}
...
void GL_obj::lime_gl_bind_renderbuffer(Int target, ::Dynamic renderbuffer){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE(2222)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_renderbuffer(target,hx::DynamicPtr(renderbuffer));
            	}
...
void GL_obj::lime_gl_bind_texture(Int target, ::Dynamic texture){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(texture,"texture")
HXLINE(2223)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_texture(target,hx::DynamicPtr(texture));
            	}
...
void GL_obj::lime_gl_blend_color(float red,float green,float blue,float alpha){
            	...
            	HX_STACK_ARG(blue,"blue")
            	HX_STACK_ARG(alpha,"alpha")
HXLINE(2224)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_color(red,green,blue,alpha);
            	}
...
void GL_obj::lime_gl_blend_equation(Int mode){
            	...
            	HX_STACK_ARG(mode,"mode")
HXLINE(2225)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_equation(mode);
            	}
...
void GL_obj::lime_gl_blend_equation_separate(Int modeRGB,Int modeAlpha){
            	...
            	HX_STACK_ARG(modeRGB,"modeRGB")
            	HX_STACK_ARG(modeAlpha,"modeAlpha")
HXLINE(2226)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_equation_separate(modeRGB,modeAlpha);
            	}
...
void GL_obj::lime_gl_blend_func(Int sfactor,Int dfactor){
            	...
            	HX_STACK_ARG(sfactor,"sfactor")
            	HX_STACK_ARG(dfactor,"dfactor")
HXLINE(2227)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_func(sfactor,dfactor);
            	}
...
void GL_obj::lime_gl_blend_func_separate(Int srcRGB,Int dstRGB,Int srcAlpha,Int dstAlpha){
            	...
            	HX_STACK_ARG(srcAlpha,"srcAlpha")
            	HX_STACK_ARG(dstAlpha,"dstAlpha")
HXLINE(2228)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_func_separate(srcRGB,dstRGB,srcAlpha,dstAlpha);
            	}
...
void GL_obj::lime_gl_buffer_data(Int target, ::Dynamic buffer,Int byteOffset,Int size,Int usage){
            	...
            	HX_STACK_ARG(size,"size")
            	HX_STACK_ARG(usage,"usage")
HXLINE(2229)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_buffer_data(target,hx::DynamicPtr(buffer),byteOffset,size,usage);
            	}
...
void GL_obj::lime_gl_buffer_sub_data(Int target,Int offset, ::Dynamic buffer,Int byteOffset,Int size){
            	...
            	HX_STACK_ARG(byteOffset,"byteOffset")
            	HX_STACK_ARG(size,"size")
HXLINE(2230)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_buffer_sub_data(target,offset,hx::DynamicPtr(buffer),byteOffset,size);
            	}
...
Int GL_obj::lime_gl_check_framebuffer_status(Int target){
            	...
            	HX_STACK_ARG(target,"target")
HXLINE(2231)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_check_framebuffer_status(target)) );
            	}
...
void GL_obj::lime_gl_clear(Int mask){
            	...
            	HX_STACK_ARG(mask,"mask")
HXLINE(2232)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_clear(mask);
            	}
...
void GL_obj::lime_gl_clear_color(float red,float green,float blue,float alpha){
            	...
            	HX_STACK_ARG(blue,"blue")
            	HX_STACK_ARG(alpha,"alpha")
HXLINE(2233)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_clear_color(red,green,blue,alpha);
            	}
...
void GL_obj::lime_gl_clear_depth(float depth){
            	...
            	HX_STACK_ARG(depth,"depth")
HXLINE(2234)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_clear_depth(depth);
            	}
...
void GL_obj::lime_gl_clear_stencil(Int s){
            	...
            	HX_STACK_ARG(s,"s")
HXLINE(2235)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_clear_stencil(s);
            	}
...
void GL_obj::lime_gl_color_mask(Bool red,Bool green,Bool blue,Bool alpha){
            	...
            	HX_STACK_ARG(blue,"blue")
            	HX_STACK_ARG(alpha,"alpha")
HXLINE(2236)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_color_mask(red,green,blue,alpha);
            	}
...
void GL_obj::lime_gl_compile_shader( ::Dynamic shader){
            	...
            	HX_STACK_ARG(shader,"shader")
HXLINE(2237)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_compile_shader(hx::DynamicPtr(shader));
            	}
...
void GL_obj::lime_gl_compressed_tex_image_2d(Int target,Int level,Int internalformat,Int width,Int height,Int border, ::Dynamic buffer,Int byteOffset){
            	...
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(byteOffset,"byteOffset")
HXLINE(2238)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_compressed_tex_image_2d(target,level,internalformat,width,height,border,hx::DynamicPtr(buffer),byteOffset);
            	}
...
void GL_obj::lime_gl_compressed_tex_sub_image_2d(Int target,Int level,Int xoffset,Int yoffset,Int width,Int height,Int format, ::Dynamic buffer,Int byteOffset){
            	...
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(byteOffset,"byteOffset")
HXLINE(2239)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_compressed_tex_sub_image_2d(target,level,xoffset,yoffset,width,height,format,hx::DynamicPtr(buffer),byteOffset);
            	}
...
void GL_obj::lime_gl_copy_tex_image_2d(Int target,Int level,Int internalformat,Int x,Int y,Int width,Int height,Int border){
            	...
            	HX_STACK_ARG(height,"height")
            	HX_STACK_ARG(border,"border")
HXLINE(2240)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_copy_tex_image_2d(target,level,internalformat,x,y,width,height,border);
            	}
...
void GL_obj::lime_gl_copy_tex_sub_image_2d(Int target,Int level,Int xoffset,Int yoffset,Int x,Int y,Int width,Int height){
            	...
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE(2241)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_copy_tex_sub_image_2d(target,level,xoffset,yoffset,x,y,width,height);
            	}
...
HXLINE(2242)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_buffer()) );
HXDLIN(2242)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE(2243)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_framebuffer()) );
HXDLIN(2243)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE(2244)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_program()) );
HXDLIN(2244)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE(2245)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_render_buffer()) );
HXDLIN(2245)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(GL_obj,lime_gl_create_render_buffer,return )
 ...
 ::Dynamic GL_obj::lime_gl_create_shader(Int type){
            	...
            	HX_STACK_ARG(type,"type")
HXLINE(2246)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_shader(type)) );
...
HXLINE(2247)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_texture()) );
...
void GL_obj::lime_gl_cull_face(Int mode){
            	...
            	HX_STACK_ARG(mode,"mode")
HXLINE(2248)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_cull_face(mode);
            	}
...
void GL_obj::lime_gl_delete_buffer( ::Dynamic buffer){
            	...
            	HX_STACK_ARG(buffer,"buffer")
HXLINE(2249)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_buffer(hx::DynamicPtr(buffer));
            	}
...
void GL_obj::lime_gl_delete_framebuffer( ::Dynamic framebuffer){
            	...
            	HX_STACK_ARG(framebuffer,"framebuffer")
HXLINE(2250)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_framebuffer(hx::DynamicPtr(framebuffer));
            	}
...
void GL_obj::lime_gl_delete_program( ::Dynamic program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE(2251)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_program(hx::DynamicPtr(program));
            	}
...
void GL_obj::lime_gl_delete_render_buffer( ::Dynamic renderbuffer){
            	...
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE(2252)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_render_buffer(hx::DynamicPtr(renderbuffer));
            	}
...
void GL_obj::lime_gl_delete_shader( ::Dynamic shader){
            	...
            	HX_STACK_ARG(shader,"shader")
HXLINE(2253)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_shader(hx::DynamicPtr(shader));
            	}
...
void GL_obj::lime_gl_delete_texture( ::Dynamic texture){
            	...
            	HX_STACK_ARG(texture,"texture")
HXLINE(2254)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_texture(hx::DynamicPtr(texture));
            	}
...
void GL_obj::lime_gl_depth_func(Int func){
            	...
            	HX_STACK_ARG(func,"func")
HXLINE(2255)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_depth_func(func);
            	}
...
void GL_obj::lime_gl_depth_mask(Bool flag){
            	...
            	HX_STACK_ARG(flag,"flag")
HXLINE(2256)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_depth_mask(flag);
            	}
...
void GL_obj::lime_gl_depth_range(float zNear,float zFar){
            	...
            	HX_STACK_ARG(zNear,"zNear")
            	HX_STACK_ARG(zFar,"zFar")
HXLINE(2257)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_depth_range(zNear,zFar);
            	}
...
void GL_obj::lime_gl_detach_shader( ::Dynamic program, ::Dynamic shader){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(shader,"shader")
HXLINE(2258)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(program);
HXDLIN(2258)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_detach_shader(_hx_tmp,hx::DynamicPtr(shader));
            	}
...
void GL_obj::lime_gl_disable(Int cap){
            	...
            	HX_STACK_ARG(cap,"cap")
HXLINE(2259)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_disable(cap);
            	}
...
void GL_obj::lime_gl_disable_vertex_attrib_array(Int index){
            	...
            	HX_STACK_ARG(index,"index")
HXLINE(2260)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_disable_vertex_attrib_array(index);
            	}
...
void GL_obj::lime_gl_draw_arrays(Int mode,Int first,Int count){
            	...
            	HX_STACK_ARG(first,"first")
            	HX_STACK_ARG(count,"count")
HXLINE(2261)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_draw_arrays(mode,first,count);
            	}
...
void GL_obj::lime_gl_draw_elements(Int mode,Int count,Int type,Int offset){
            	...
            	HX_STACK_ARG(type,"type")
            	HX_STACK_ARG(offset,"offset")
HXLINE(2262)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_draw_elements(mode,count,type,offset);
            	}
...
void GL_obj::lime_gl_enable(Int cap){
            	...
            	HX_STACK_ARG(cap,"cap")
HXLINE(2263)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_enable(cap);
            	}
...
void GL_obj::lime_gl_enable_vertex_attrib_array(Int index){
            	...
            	HX_STACK_ARG(index,"index")
HXLINE(2264)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_enable_vertex_attrib_array(index);
            	}
...
HXLINE(2265)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_finish();
            	}
...
HXLINE(2266)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_flush();
            	}
...
void GL_obj::lime_gl_framebuffer_renderbuffer(Int target,Int attachment,Int renderbuffertarget, ::Dynamic renderbuffer){
            	...
            	HX_STACK_ARG(renderbuffertarget,"renderbuffertarget")
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE(2267)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_framebuffer_renderbuffer(target,attachment,renderbuffertarget,hx::DynamicPtr(renderbuffer));
            	}
...
void GL_obj::lime_gl_framebuffer_texture2D(Int target,Int attachment,Int textarget, ::Dynamic texture,Int level){
            	...
            	HX_STACK_ARG(texture,"texture")
            	HX_STACK_ARG(level,"level")
HXLINE(2268)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_framebuffer_texture2D(target,attachment,textarget,hx::DynamicPtr(texture),level);
            	}
...
void GL_obj::lime_gl_front_face(Int mode){
            	...
            	HX_STACK_ARG(mode,"mode")
HXLINE(2269)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_front_face(mode);
            	}
...
void GL_obj::lime_gl_generate_mipmap(Int target){
            	...
            	HX_STACK_ARG(target,"target")
HXLINE(2270)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_generate_mipmap(target);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(GL_obj,lime_gl_generate_mipmap,(void))
 ...
 ::Dynamic GL_obj::lime_gl_get_active_attrib( ::Dynamic program,Int index){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(index,"index")
HXLINE(2271)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_active_attrib(hx::DynamicPtr(program),index)) );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(GL_obj,lime_gl_get_active_attrib,return )
 ...
 ::Dynamic GL_obj::lime_gl_get_active_uniform( ::Dynamic program,Int index){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(index,"index")
HXLINE(2272)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_active_uniform(hx::DynamicPtr(program),index)) );
HXDLIN(2272)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Int GL_obj::lime_gl_get_attrib_location( ::Dynamic program,::String name){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(name,"name")
HXLINE(2273)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_attrib_location(hx::DynamicPtr(program),name)) );
            	}
...
Int GL_obj::lime_gl_get_buffer_parameter(Int target,Int pname){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(pname,"pname")
HXLINE(2274)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_buffer_parameter(target,pname)) );
            	}
...
HXLINE(2275)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_context_attributes()) );
...
HXLINE(2276)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_error()) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(GL_obj,lime_gl_get_error,return )
 ...
 ::Dynamic GL_obj::lime_gl_get_extension(::String name){
            	...
            	HX_STACK_ARG(name,"name")
HXLINE(2277)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_extension(name)) );
HXDLIN(2277)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Int GL_obj::lime_gl_get_framebuffer_attachment_parameter(Int target,Int attachment,Int pname){
            	...
            	HX_STACK_ARG(attachment,"attachment")
            	HX_STACK_ARG(pname,"pname")
HXLINE(2278)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_framebuffer_attachment_parameter(target,attachment,pname)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(GL_obj,lime_gl_get_framebuffer_attachment_parameter,return )
 ...
 ::Dynamic GL_obj::lime_gl_get_parameter(Int pname){
            	...
            	HX_STACK_ARG(pname,"pname")
HXLINE(2279)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_parameter(pname)) );
...
::String GL_obj::lime_gl_get_program_info_log( ::Dynamic program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE(2280)		return ( (::String)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_program_info_log(hx::DynamicPtr(program))) );
            	}
...
Int GL_obj::lime_gl_get_program_parameter( ::Dynamic program,Int pname){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(pname,"pname")
HXLINE(2281)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_program_parameter(hx::DynamicPtr(program),pname)) );
            	}
...
Int GL_obj::lime_gl_get_render_buffer_parameter(Int target,Int pname){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(pname,"pname")
HXLINE(2282)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_render_buffer_parameter(target,pname)) );
            	}
...
::String GL_obj::lime_gl_get_shader_info_log( ::Dynamic shader){
            	...
            	HX_STACK_ARG(shader,"shader")
HXLINE(2283)		return ( (::String)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_info_log(hx::DynamicPtr(shader))) );
            	}
...
Int GL_obj::lime_gl_get_shader_parameter( ::Dynamic shader,Int pname){
            	...
            	HX_STACK_ARG(shader,"shader")
            	HX_STACK_ARG(pname,"pname")
HXLINE(2284)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_parameter(hx::DynamicPtr(shader),pname)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(GL_obj,lime_gl_get_shader_parameter,return )
 ...
 ::Dynamic GL_obj::lime_gl_get_shader_precision_format(Int shadertype,Int precisiontype){
            	...
            	HX_STACK_ARG(shadertype,"shadertype")
            	HX_STACK_ARG(precisiontype,"precisiontype")
HXLINE(2285)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_precision_format(shadertype,precisiontype)) );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(GL_obj,lime_gl_get_shader_precision_format,return )
 ...
 ::Dynamic GL_obj::lime_gl_get_shader_source( ::Dynamic shader){
            	...
            	HX_STACK_ARG(shader,"shader")
HXLINE(2286)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_source(hx::DynamicPtr(shader))) );
HXDLIN(2286)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE(2287)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_supported_extensions(hx::DynamicPtr(result));
            	}
...
Int GL_obj::lime_gl_get_tex_parameter(Int target,Int pname){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(pname,"pname")
HXLINE(2288)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_tex_parameter(target,pname)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(GL_obj,lime_gl_get_tex_parameter,return )
 ...
 ::Dynamic GL_obj::lime_gl_get_uniform( ::Dynamic program,Int location){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(location,"location")
HXLINE(2289)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_uniform(hx::DynamicPtr(program),location)) );
...
Int GL_obj::lime_gl_get_uniform_location( ::Dynamic program,::String name){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(name,"name")
HXLINE(2290)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_uniform_location(hx::DynamicPtr(program),name)) );
            	}
...
Int GL_obj::lime_gl_get_vertex_attrib(Int index,Int pname){
            	...
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(pname,"pname")
HXLINE(2291)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_vertex_attrib(index,pname)) );
            	}
...
Int GL_obj::lime_gl_get_vertex_attrib_offset(Int index,Int pname){
            	...
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(pname,"pname")
HXLINE(2292)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_vertex_attrib_offset(index,pname)) );
            	}
...
void GL_obj::lime_gl_hint(Int target,Int mode){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(mode,"mode")
HXLINE(2293)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_hint(target,mode);
            	}
...
Bool GL_obj::lime_gl_is_buffer( ::Dynamic buffer){
            	...
            	HX_STACK_ARG(buffer,"buffer")
HXLINE(2294)		return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_buffer(hx::DynamicPtr(buffer))) );
            	}
...
Bool GL_obj::lime_gl_is_enabled(Int cap){
            	...
            	HX_STACK_ARG(cap,"cap")
HXLINE(2295)		return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_enabled(cap)) );
            	}
...
Bool GL_obj::lime_gl_is_framebuffer( ::Dynamic framebuffer){
            	...
            	HX_STACK_ARG(framebuffer,"framebuffer")
HXLINE(2296)		return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_framebuffer(hx::DynamicPtr(framebuffer))) );
            	}
...
Bool GL_obj::lime_gl_is_program( ::Dynamic program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE(2297)		return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_program(hx::DynamicPtr(program))) );
            	}
...
Bool GL_obj::lime_gl_is_renderbuffer( ::Dynamic renderbuffer){
            	...
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE(2298)		return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_renderbuffer(hx::DynamicPtr(renderbuffer))) );
            	}
...
Bool GL_obj::lime_gl_is_shader( ::Dynamic shader){
            	...
            	HX_STACK_ARG(shader,"shader")
HXLINE(2299)		return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_shader(hx::DynamicPtr(shader))) );
            	}
...
Bool GL_obj::lime_gl_is_texture( ::Dynamic texture){
            	...
            	HX_STACK_ARG(texture,"texture")
HXLINE(2300)		return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_texture(hx::DynamicPtr(texture))) );
            	}
...
void GL_obj::lime_gl_line_width(float width){
            	...
            	HX_STACK_ARG(width,"width")
HXLINE(2301)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_line_width(width);
            	}
...
void GL_obj::lime_gl_link_program( ::Dynamic program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE(2302)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_link_program(hx::DynamicPtr(program));
            	}
...
void GL_obj::lime_gl_pixel_storei(Int pname,Int param){
            	...
            	HX_STACK_ARG(pname,"pname")
            	HX_STACK_ARG(param,"param")
HXLINE(2303)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_pixel_storei(pname,param);
            	}
...
void GL_obj::lime_gl_polygon_offset(float factor,float units){
            	...
            	HX_STACK_ARG(factor,"factor")
            	HX_STACK_ARG(units,"units")
HXLINE(2304)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_polygon_offset(factor,units);
            	}
...
void GL_obj::lime_gl_read_pixels(Int x,Int y,Int width,Int height,Int format,Int type, ::Dynamic buffer,Int byteOffset){
            	...
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(byteOffset,"byteOffset")
HXLINE(2305)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_read_pixels(x,y,width,height,format,type,hx::DynamicPtr(buffer),byteOffset);
            	}
...
void GL_obj::lime_gl_renderbuffer_storage(Int target,Int internalformat,Int width,Int height){
            	...
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE(2306)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_renderbuffer_storage(target,internalformat,width,height);
            	}
...
void GL_obj::lime_gl_sample_coverage(float value,Bool invert){
            	...
            	HX_STACK_ARG(value,"value")
            	HX_STACK_ARG(invert,"invert")
HXLINE(2307)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_sample_coverage(value,invert);
            	}
...
void GL_obj::lime_gl_scissor(Int x,Int y,Int width,Int height){
            	...
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE(2308)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_scissor(x,y,width,height);
            	}
...
void GL_obj::lime_gl_shader_source( ::Dynamic shader,::String source){
            	...
            	HX_STACK_ARG(shader,"shader")
            	HX_STACK_ARG(source,"source")
HXLINE(2309)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_shader_source(hx::DynamicPtr(shader),source);
            	}
...
void GL_obj::lime_gl_stencil_func(Int func,Int ref,Int mask){
            	...
            	HX_STACK_ARG(ref,"ref")
            	HX_STACK_ARG(mask,"mask")
HXLINE(2310)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_func(func,ref,mask);
            	}
...
void GL_obj::lime_gl_stencil_func_separate(Int face,Int func,Int ref,Int mask){
            	...
            	HX_STACK_ARG(ref,"ref")
            	HX_STACK_ARG(mask,"mask")
HXLINE(2311)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_func_separate(face,func,ref,mask);
            	}
...
void GL_obj::lime_gl_stencil_mask(Int mask){
            	...
            	HX_STACK_ARG(mask,"mask")
HXLINE(2312)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_mask(mask);
            	}
...
void GL_obj::lime_gl_stencil_mask_separate(Int face,Int mask){
            	...
            	HX_STACK_ARG(face,"face")
            	HX_STACK_ARG(mask,"mask")
HXLINE(2313)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_mask_separate(face,mask);
            	}
...
void GL_obj::lime_gl_stencil_op(Int fail,Int zfail,Int zpass){
            	...
            	HX_STACK_ARG(zfail,"zfail")
            	HX_STACK_ARG(zpass,"zpass")
HXLINE(2314)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_op(fail,zfail,zpass);
            	}
...
void GL_obj::lime_gl_stencil_op_separate(Int face,Int fail,Int zfail,Int zpass){
            	...
            	HX_STACK_ARG(zfail,"zfail")
            	HX_STACK_ARG(zpass,"zpass")
HXLINE(2315)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_op_separate(face,fail,zfail,zpass);
            	}
...
void GL_obj::lime_gl_tex_image_2d(Int target,Int level,Int internalformat,Int width,Int height,Int border,Int format,Int type, ::Dynamic buffer,Int byteOffset){
            	...
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(byteOffset,"byteOffset")
HXLINE(2316)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_image_2d(target,level,internalformat,width,height,border,format,type,hx::DynamicPtr(buffer),byteOffset);
            	}
...
void GL_obj::lime_gl_tex_parameterf(Int target,Int pname,float param){
            	...
            	HX_STACK_ARG(pname,"pname")
            	HX_STACK_ARG(param,"param")
HXLINE(2317)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_parameterf(target,pname,param);
            	}
...
void GL_obj::lime_gl_tex_parameteri(Int target,Int pname,Int param){
            	...
            	HX_STACK_ARG(pname,"pname")
            	HX_STACK_ARG(param,"param")
HXLINE(2318)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_parameteri(target,pname,param);
            	}
...
void GL_obj::lime_gl_tex_sub_image_2d(Int target,Int level,Int xoffset,Int yoffset,Int width,Int height,Int format,Int type, ::Dynamic buffer,Int byteOffset){
            	...
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(byteOffset,"byteOffset")
HXLINE(2319)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_sub_image_2d(target,level,xoffset,yoffset,width,height,format,type,hx::DynamicPtr(buffer),byteOffset);
            	}
...
void GL_obj::lime_gl_uniform1f(Int location,float x){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
HXLINE(2320)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform1f(location,x);
            	}
...
void GL_obj::lime_gl_uniform1fv(Int location, ::Dynamic v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(2321)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform1fv(location,hx::DynamicPtr(v));
            	}
...
void GL_obj::lime_gl_uniform1i(Int location,Int x){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
HXLINE(2322)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform1i(location,x);
            	}
...
void GL_obj::lime_gl_uniform1iv(Int location, ::Dynamic v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(2323)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform1iv(location,hx::DynamicPtr(v));
            	}
...
void GL_obj::lime_gl_uniform2f(Int location,float x,float y){
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(2324)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform2f(location,x,y);
            	}
...
void GL_obj::lime_gl_uniform2fv(Int location, ::Dynamic v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(2325)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform2fv(location,hx::DynamicPtr(v));
            	}
...
void GL_obj::lime_gl_uniform2i(Int location,Int x,Int y){
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(2326)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform2i(location,x,y);
            	}
...
void GL_obj::lime_gl_uniform2iv(Int location, ::Dynamic v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(2327)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform2iv(location,hx::DynamicPtr(v));
            	}
...
void GL_obj::lime_gl_uniform3f(Int location,float x,float y,float z){
            	...
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(z,"z")
HXLINE(2328)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform3f(location,x,y,z);
            	}
...
void GL_obj::lime_gl_uniform3fv(Int location, ::Dynamic v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(2329)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform3fv(location,hx::DynamicPtr(v));
            	}
...
void GL_obj::lime_gl_uniform3i(Int location,Int x,Int y,Int z){
            	...
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(z,"z")
HXLINE(2330)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform3i(location,x,y,z);
            	}
...
void GL_obj::lime_gl_uniform3iv(Int location, ::Dynamic v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(2331)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform3iv(location,hx::DynamicPtr(v));
            	}
...
void GL_obj::lime_gl_uniform4f(Int location,float x,float y,float z,float w){
            	...
            	HX_STACK_ARG(z,"z")
            	HX_STACK_ARG(w,"w")
HXLINE(2332)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4f(location,x,y,z,w);
            	}
...
void GL_obj::lime_gl_uniform4fv(Int location, ::Dynamic v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(2333)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4fv(location,hx::DynamicPtr(v));
            	}
...
void GL_obj::lime_gl_uniform4i(Int location,Int x,Int y,Int z,Int w){
            	...
            	HX_STACK_ARG(z,"z")
            	HX_STACK_ARG(w,"w")
HXLINE(2334)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4i(location,x,y,z,w);
            	}
...
void GL_obj::lime_gl_uniform4iv(Int location, ::Dynamic v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(2335)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4iv(location,hx::DynamicPtr(v));
            	}
...
void GL_obj::lime_gl_uniform_matrix(Int location,Bool transpose, ::Dynamic buffer,Int count){
            	...
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(count,"count")
HXLINE(2336)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform_matrix(location,transpose,hx::DynamicPtr(buffer),count);
            	}
...
void GL_obj::lime_gl_use_program( ::Dynamic program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE(2337)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_use_program(hx::DynamicPtr(program));
            	}
...
void GL_obj::lime_gl_validate_program( ::Dynamic program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE(2338)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_validate_program(hx::DynamicPtr(program));
            	}
...
HXLINE(2339)		return ( (::String)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_version()) );
            	}
...
void GL_obj::lime_gl_vertex_attrib1f(Int indx,float x){
            	...
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(x,"x")
HXLINE(2340)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib1f(indx,x);
            	}
...
void GL_obj::lime_gl_vertex_attrib1fv(Int indx, ::Dynamic values){
            	...
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(values,"values")
HXLINE(2341)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib1fv(indx,hx::DynamicPtr(values));
            	}
...
void GL_obj::lime_gl_vertex_attrib2f(Int indx,float x,float y){
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(2342)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib2f(indx,x,y);
            	}
...
void GL_obj::lime_gl_vertex_attrib2fv(Int indx, ::Dynamic values){
            	...
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(values,"values")
HXLINE(2343)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib2fv(indx,hx::DynamicPtr(values));
            	}
...
void GL_obj::lime_gl_vertex_attrib3f(Int indx,float x,float y,float z){
            	...
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(z,"z")
HXLINE(2344)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib3f(indx,x,y,z);
            	}
...
void GL_obj::lime_gl_vertex_attrib3fv(Int indx, ::Dynamic values){
            	...
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(values,"values")
HXLINE(2345)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib3fv(indx,hx::DynamicPtr(values));
            	}
...
void GL_obj::lime_gl_vertex_attrib4f(Int indx,float x,float y,float z,float w){
            	...
            	HX_STACK_ARG(z,"z")
            	HX_STACK_ARG(w,"w")
HXLINE(2346)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib4f(indx,x,y,z,w);
            	}
...
void GL_obj::lime_gl_vertex_attrib4fv(Int indx, ::Dynamic values){
            	...
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(values,"values")
HXLINE(2347)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib4fv(indx,hx::DynamicPtr(values));
            	}
...
void GL_obj::lime_gl_vertex_attrib_pointer(Int indx,Int size,Int type,Bool normalized,Int stride,Int offset){
            	...
            	HX_STACK_ARG(stride,"stride")
            	HX_STACK_ARG(offset,"offset")
HXLINE(2348)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib_pointer(indx,size,type,normalized,stride,offset);
            	}
...
void GL_obj::lime_gl_viewport(Int x,Int y,Int width,Int height){
            	...
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE(2349)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_viewport(x,y,width,height);
            	}
...
HXLINE(2217)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_active_texture",52,df,77,b3),HX_("iv",ed,5b,00,00),false);
HXDLIN(2217)		cffi_lime_gl_active_texture = inValue;
            	}
{
...
HXLINE(2218)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_attach_shader",6f,78,09,06),HX_("oov",56,9b,54,00),false);
HXDLIN(2218)		cffi_lime_gl_attach_shader = inValue;
            	}
{
...
HXLINE(2219)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_bind_attrib_location",78,d0,23,1a),HX_("oisv",3d,c0,ae,49),false);
HXDLIN(2219)		cffi_lime_gl_bind_attrib_location = inValue;
            	}
{
...
HXLINE(2220)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_bind_buffer",52,57,d9,e2),HX_("iov",d0,0d,50,00),false);
HXDLIN(2220)		cffi_lime_gl_bind_buffer = inValue;
            	}
{
...
HXLINE(2221)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_bind_framebuffer",5b,d1,58,70),HX_("iov",d0,0d,50,00),false);
HXDLIN(2221)		cffi_lime_gl_bind_framebuffer = inValue;
            	}
{
...
HXLINE(2222)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_bind_renderbuffer",a8,70,ea,63),HX_("iov",d0,0d,50,00),false);
HXDLIN(2222)		cffi_lime_gl_bind_renderbuffer = inValue;
            	}
{
...
HXLINE(2223)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_bind_texture",49,36,a3,88),HX_("iov",d0,0d,50,00),false);
HXDLIN(2223)		cffi_lime_gl_bind_texture = inValue;
            	}
{
...
HXLINE(2224)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_blend_color",85,d0,ce,3a),HX_("ffffv",f6,ad,98,fe),false);
HXDLIN(2224)		cffi_lime_gl_blend_color = inValue;
            	}
{
...
HXLINE(2225)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_blend_equation",aa,fd,08,1f),HX_("iv",ed,5b,00,00),false);
HXDLIN(2225)		cffi_lime_gl_blend_equation = inValue;
            	}
{
...
HXLINE(2226)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_blend_equation_separate",d8,13,95,58),HX_("iiv",96,08,50,00),false);
HXDLIN(2226)		cffi_lime_gl_blend_equation_separate = inValue;
            	}
{
...
HXLINE(2227)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_blend_func",62,46,02,e9),HX_("iiv",96,08,50,00),false);
HXDLIN(2227)		cffi_lime_gl_blend_func = inValue;
            	}
{
...
HXLINE(2228)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_blend_func_separate",20,f4,b8,2e),HX_("iiiiv",b6,58,ca,ba),false);
HXDLIN(2228)		cffi_lime_gl_blend_func_separate = inValue;
            	}
{
...
HXLINE(2229)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_buffer_data",d9,31,40,74),HX_("ioiiiv",b3,b6,aa,2a),false);
HXDLIN(2229)		cffi_lime_gl_buffer_data = inValue;
            	}
{
...
HXLINE(2230)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_buffer_sub_data",b8,37,6c,ab),HX_("iioiiv",67,83,3a,ba),false);
HXDLIN(2230)		cffi_lime_gl_buffer_sub_data = inValue;
            	}
{
...
HXLINE(2231)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_check_framebuffer_status",0b,35,e1,ea),HX_("ii",e0,5b,00,00),false);
HXDLIN(2231)		cffi_lime_gl_check_framebuffer_status = inValue;
            	}
{
...
HXLINE(2232)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_clear",5d,92,00,3b),HX_("iv",ed,5b,00,00),false);
HXDLIN(2232)		cffi_lime_gl_clear = inValue;
            	}
{
...
HXLINE(2233)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_clear_color",c1,ee,49,1a),HX_("ffffv",f6,ad,98,fe),false);
HXDLIN(2233)		cffi_lime_gl_clear_color = inValue;
            	}
{
...
HXLINE(2234)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_clear_depth",61,6e,17,a7),HX_("fv",50,59,00,00),false);
HXDLIN(2234)		cffi_lime_gl_clear_depth = inValue;
            	}
{
...
HXLINE(2235)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_clear_stencil",da,ce,51,44),HX_("iv",ed,5b,00,00),false);
HXDLIN(2235)		cffi_lime_gl_clear_stencil = inValue;
            	}
{
...
HXLINE(2236)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_color_mask",b8,f1,a7,79),HX_("bbbbv",f6,74,56,ae),false);
HXDLIN(2236)		cffi_lime_gl_color_mask = inValue;
            	}
{
...
HXLINE(2237)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_compile_shader",e1,d4,68,7c),HX_("ov",27,61,00,00),false);
HXDLIN(2237)		cffi_lime_gl_compile_shader = inValue;
            	}
{
...
HXLINE(2238)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_compressed_tex_image_2d",bc,70,b8,76),HX_("iiiiiioiv",7c,5e,4a,bf),false);
HXDLIN(2238)		cffi_lime_gl_compressed_tex_image_2d = inValue;
            	}
{
...
HXLINE(2239)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_compressed_tex_sub_image_2d",9b,19,2d,07),HX_("iiiiiiioiv",f3,88,d5,9d),false);
HXDLIN(2239)		cffi_lime_gl_compressed_tex_sub_image_2d = inValue;
            	}
{
...
HXLINE(2240)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_copy_tex_image_2d",08,15,17,3a),HX_("iiiiiiiiv",f6,d0,45,bf),false);
HXDLIN(2240)		cffi_lime_gl_copy_tex_image_2d = inValue;
            	}
{
...
HXLINE(2241)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_copy_tex_sub_image_2d",e7,d3,21,4b),HX_("iiiiiiiiv",f6,d0,45,bf),false);
HXDLIN(2241)		cffi_lime_gl_copy_tex_sub_image_2d = inValue;
            	}
{
...
HXLINE(2242)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_create_buffer",f3,ef,e7,8a),HX_("o",6f,00,00,00),false);
HXDLIN(2242)		cffi_lime_gl_create_buffer = inValue;
            	}
{
...
HXLINE(2243)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_create_framebuffer",1a,51,d8,73),HX_("o",6f,00,00,00),false);
HXDLIN(2243)		cffi_lime_gl_create_framebuffer = inValue;
            	}
{
...
HXLINE(2244)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_create_program",31,ac,72,42),HX_("o",6f,00,00,00),false);
HXDLIN(2244)		cffi_lime_gl_create_program = inValue;
            	}
{
...
HXLINE(2245)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_create_render_buffer",76,7b,e1,18),HX_("o",6f,00,00,00),false);
HXDLIN(2245)		cffi_lime_gl_create_render_buffer = inValue;
            	}
{
...
HXLINE(2246)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_create_shader",18,f2,73,d7),HX_("io",e6,5b,00,00),false);
HXDLIN(2246)		cffi_lime_gl_create_shader = inValue;
            	}
{
...
HXLINE(2247)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_create_texture",88,2a,5a,ed),HX_("o",6f,00,00,00),false);
HXDLIN(2247)		cffi_lime_gl_create_texture = inValue;
            	}
{
...
HXLINE(2248)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_cull_face",5a,6e,d7,a6),HX_("iv",ed,5b,00,00),false);
HXDLIN(2248)		cffi_lime_gl_cull_face = inValue;
            	}
{
...
HXLINE(2249)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_delete_buffer",a4,aa,2e,01),HX_("ov",27,61,00,00),false);
HXDLIN(2249)		cffi_lime_gl_delete_buffer = inValue;
            	}
{
...
HXLINE(2250)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_delete_framebuffer",c9,34,1a,a6),HX_("ov",27,61,00,00),false);
HXDLIN(2250)		cffi_lime_gl_delete_framebuffer = inValue;
            	}
{
...
HXLINE(2251)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_delete_program",60,4c,0f,4a),HX_("ov",27,61,00,00),false);
HXDLIN(2251)		cffi_lime_gl_delete_program = inValue;
            	}
{
...
HXLINE(2252)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_delete_render_buffer",e5,e8,26,ca),HX_("ov",27,61,00,00),false);
HXDLIN(2252)		cffi_lime_gl_delete_render_buffer = inValue;
            	}
{
...
HXLINE(2253)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_delete_shader",c9,ac,ba,4d),HX_("ov",27,61,00,00),false);
HXDLIN(2253)		cffi_lime_gl_delete_shader = inValue;
            	}
{
...
HXLINE(2254)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_delete_texture",b7,ca,f6,f4),HX_("ov",27,61,00,00),false);
HXDLIN(2254)		cffi_lime_gl_delete_texture = inValue;
            	}
{
...
HXLINE(2255)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_depth_func",70,78,16,ad),HX_("iv",ed,5b,00,00),false);
HXDLIN(2255)		cffi_lime_gl_depth_func = inValue;
            	}
{
...
HXLINE(2256)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_depth_mask",18,ce,a7,b1),HX_("bv",d4,55,00,00),false);
HXDLIN(2256)		cffi_lime_gl_depth_mask = inValue;
            	}
{
...
HXLINE(2257)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_depth_range",11,9f,29,a2),HX_("ffv",36,bf,4d,00),false);
HXDLIN(2257)		cffi_lime_gl_depth_range = inValue;
            	}
{
...
HXLINE(2258)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_detach_shader",a1,84,13,fd),HX_("oov",56,9b,54,00),false);
HXDLIN(2258)		cffi_lime_gl_detach_shader = inValue;
            	}
{
...
HXLINE(2259)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_disable",b8,5e,23,70),HX_("iv",ed,5b,00,00),false);
HXDLIN(2259)		cffi_lime_gl_disable = inValue;
            	}
{
...
HXLINE(2260)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_disable_vertex_attrib_array",58,ba,8e,0a),HX_("iv",ed,5b,00,00),false);
HXDLIN(2260)		cffi_lime_gl_disable_vertex_attrib_array = inValue;
            	}
{
...
HXLINE(2261)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_draw_arrays",a5,43,0c,17),HX_("iiiv",cd,6f,b7,45),false);
HXDLIN(2261)		cffi_lime_gl_draw_arrays = inValue;
            	}
{
...
HXLINE(2262)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_draw_elements",e2,d1,98,b9),HX_("iiiiv",b6,58,ca,ba),false);
HXDLIN(2262)		cffi_lime_gl_draw_elements = inValue;
            	}
{
...
HXLINE(2263)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_enable",b3,43,5f,56),HX_("iv",ed,5b,00,00),false);
HXDLIN(2263)		cffi_lime_gl_enable = inValue;
            	}
{
...
HXLINE(2264)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_enable_vertex_attrib_array",d3,1e,a2,ea),HX_("iv",ed,5b,00,00),false);
HXDLIN(2264)		cffi_lime_gl_enable_vertex_attrib_array = inValue;
            	}
{
...
HXLINE(2265)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_finish",83,d5,56,e4),HX_("v",76,00,00,00),false);
HXDLIN(2265)		cffi_lime_gl_finish = inValue;
            	}
{
...
HXLINE(2266)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_flush",94,83,40,f5),HX_("v",76,00,00,00),false);
HXDLIN(2266)		cffi_lime_gl_flush = inValue;
            	}
{
...
HXLINE(2267)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_framebuffer_renderbuffer",d8,1b,4b,9a),HX_("iiiov",f0,5d,ca,ba),false);
HXDLIN(2267)		cffi_lime_gl_framebuffer_renderbuffer = inValue;
            	}
{
...
HXLINE(2268)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_framebuffer_texture2D",2b,bd,7d,0a),HX_("iiioiv",33,c9,47,b6),false);
HXDLIN(2268)		cffi_lime_gl_framebuffer_texture2D = inValue;
            	}
{
...
HXLINE(2269)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_front_face",63,a0,73,7d),HX_("iv",ed,5b,00,00),false);
HXDLIN(2269)		cffi_lime_gl_front_face = inValue;
            	}
{
...
HXLINE(2270)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_generate_mipmap",62,a5,38,e6),HX_("iv",ed,5b,00,00),false);
HXDLIN(2270)		cffi_lime_gl_generate_mipmap = inValue;
            	}
{
...
HXLINE(2271)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_active_attrib",0a,40,b7,d1),HX_("oio",15,96,54,00),false);
HXDLIN(2271)		cffi_lime_gl_get_active_attrib = inValue;
            	}
{
...
HXLINE(2272)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_active_uniform",74,90,d7,2a),HX_("oio",15,96,54,00),false);
HXDLIN(2272)		cffi_lime_gl_get_active_uniform = inValue;
            	}
{
...
HXLINE(2273)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_attrib_location",f1,00,cb,a5),HX_("osi",c5,9e,54,00),false);
HXDLIN(2273)		cffi_lime_gl_get_attrib_location = inValue;
            	}
{
...
HXLINE(2274)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_buffer_parameter",a3,5c,c0,74),HX_("iii",89,08,50,00),false);
HXDLIN(2274)		cffi_lime_gl_get_buffer_parameter = inValue;
            	}
{
...
HXLINE(2275)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_context_attributes",e0,c6,c6,3e),HX_("o",6f,00,00,00),false);
HXDLIN(2275)		cffi_lime_gl_get_context_attributes = inValue;
            	}
{
...
HXLINE(2276)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_error",ef,f0,e0,f5),HX_("i",69,00,00,00),false);
HXDLIN(2276)		cffi_lime_gl_get_error = inValue;
            	}
{
...
HXLINE(2277)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_extension",26,d8,5e,d7),HX_("so",9c,64,00,00),false);
HXDLIN(2277)		cffi_lime_gl_get_extension = inValue;
            	}
{
...
HXLINE(2278)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_framebuffer_attachment_parameter",18,53,fb,61),HX_("iiii",c0,6f,b7,45),false);
HXDLIN(2278)		cffi_lime_gl_get_framebuffer_attachment_parameter = inValue;
            	}
{
...
HXLINE(2279)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_parameter",50,7a,fe,3a),HX_("io",e6,5b,00,00),false);
HXDLIN(2279)		cffi_lime_gl_get_parameter = inValue;
            	}
{
...
HXLINE(2280)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_program_info_log",87,8b,1c,48),HX_("os",24,61,00,00),false);
HXDLIN(2280)		cffi_lime_gl_get_program_info_log = inValue;
            	}
{
...
HXLINE(2281)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_program_parameter",95,8c,e9,12),HX_("oii",0f,96,54,00),false);
HXDLIN(2281)		cffi_lime_gl_get_program_parameter = inValue;
            	}
{
...
HXLINE(2282)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_render_buffer_parameter",9a,8b,13,f8),HX_("iii",89,08,50,00),false);
HXDLIN(2282)		cffi_lime_gl_get_render_buffer_parameter = inValue;
            	}
{
...
HXLINE(2283)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_shader_info_log",74,08,6b,9a),HX_("os",24,61,00,00),false);
HXDLIN(2283)		cffi_lime_gl_get_shader_info_log = inValue;
            	}
{
...
HXLINE(2284)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_shader_parameter",08,5f,48,c5),HX_("oii",0f,96,54,00),false);
HXDLIN(2284)		cffi_lime_gl_get_shader_parameter = inValue;
            	}
{
...
HXLINE(2285)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_shader_precision_format",d9,5f,b1,89),HX_("iio",8f,08,50,00),false);
HXDLIN(2285)		cffi_lime_gl_get_shader_precision_format = inValue;
            	}
{
...
HXLINE(2286)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_shader_source",1c,86,a3,e7),HX_("oo",20,61,00,00),false);
HXDLIN(2286)		cffi_lime_gl_get_shader_source = inValue;
            	}
{
...
HXLINE(2287)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_supported_extensions",7e,b4,30,92),HX_("ov",27,61,00,00),false);
HXDLIN(2287)		cffi_lime_gl_get_supported_extensions = inValue;
            	}
{
...
HXLINE(2288)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_tex_parameter",38,3a,ff,30),HX_("iii",89,08,50,00),false);
HXDLIN(2288)		cffi_lime_gl_get_tex_parameter = inValue;
            	}
{
...
HXLINE(2289)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_uniform",1b,3e,0c,b0),HX_("oio",15,96,54,00),false);
HXDLIN(2289)		cffi_lime_gl_get_uniform = inValue;
            	}
{
...
HXLINE(2290)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_uniform_location",19,0c,33,6c),HX_("osi",c5,9e,54,00),false);
HXDLIN(2290)		cffi_lime_gl_get_uniform_location = inValue;
            	}
{
...
HXLINE(2291)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_vertex_attrib",2c,36,2d,8c),HX_("iii",89,08,50,00),false);
HXDLIN(2291)		cffi_lime_gl_get_vertex_attrib = inValue;
            	}
{
...
HXLINE(2292)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_vertex_attrib_offset",86,d0,e7,4a),HX_("iii",89,08,50,00),false);
HXDLIN(2292)		cffi_lime_gl_get_vertex_attrib_offset = inValue;
            	}
{
...
HXLINE(2293)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_hint",b7,26,75,cc),HX_("iiv",96,08,50,00),false);
HXDLIN(2293)		cffi_lime_gl_hint = inValue;
            	}
{
...
HXLINE(2294)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_is_buffer",c5,ec,c6,b4),HX_("ob",13,61,00,00),false);
HXDLIN(2294)		cffi_lime_gl_is_buffer = inValue;
            	}
{
...
HXLINE(2295)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_is_enabled",1c,a1,e8,45),HX_("ib",d9,5b,00,00),false);
HXDLIN(2295)		cffi_lime_gl_is_enabled = inValue;
            	}
{
...
HXLINE(2296)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_is_framebuffer",08,9b,19,ab),HX_("ob",13,61,00,00),false);
HXDLIN(2296)		cffi_lime_gl_is_framebuffer = inValue;
            	}
{
...
HXLINE(2297)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_is_program",1f,e7,b0,bb),HX_("ob",13,61,00,00),false);
HXDLIN(2297)		cffi_lime_gl_is_program = inValue;
            	}
{
...
HXLINE(2298)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_is_renderbuffer",5b,1e,da,91),HX_("ob",13,61,00,00),false);
HXDLIN(2298)		cffi_lime_gl_is_renderbuffer = inValue;
            	}
{
...
HXLINE(2299)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_is_shader",ea,ee,52,01),HX_("ob",13,61,00,00),false);
HXDLIN(2299)		cffi_lime_gl_is_shader = inValue;
            	}
{
...
HXLINE(2300)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_is_texture",76,65,98,66),HX_("ob",13,61,00,00),false);
HXDLIN(2300)		cffi_lime_gl_is_texture = inValue;
            	}
{
...
HXLINE(2301)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_line_width",6b,71,5f,53),HX_("fv",50,59,00,00),false);
HXDLIN(2301)		cffi_lime_gl_line_width = inValue;
            	}
{
...
HXLINE(2302)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_link_program",2f,df,cf,33),HX_("ov",27,61,00,00),false);
HXDLIN(2302)		cffi_lime_gl_link_program = inValue;
            	}
{
...
HXLINE(2303)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_pixel_storei",71,b2,56,3d),HX_("iiv",96,08,50,00),false);
HXDLIN(2303)		cffi_lime_gl_pixel_storei = inValue;
            	}
{
...
HXLINE(2304)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_polygon_offset",28,8f,6c,e3),HX_("ffv",36,bf,4d,00),false);
HXDLIN(2304)		cffi_lime_gl_polygon_offset = inValue;
            	}
{
...
HXLINE(2305)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_read_pixels",06,09,69,f5),HX_("iiiiiioiv",7c,5e,4a,bf),false);
HXDLIN(2305)		cffi_lime_gl_read_pixels = inValue;
            	}
{
...
HXLINE(2306)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_renderbuffer_storage",c2,94,f1,7b),HX_("iiiiv",b6,58,ca,ba),false);
HXDLIN(2306)		cffi_lime_gl_renderbuffer_storage = inValue;
            	}
{
...
HXLINE(2307)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_sample_coverage",ad,98,c5,86),HX_("fbv",ba,bb,4d,00),false);
HXDLIN(2307)		cffi_lime_gl_sample_coverage = inValue;
            	}
{
...
HXLINE(2308)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_scissor",ec,1c,b2,c3),HX_("iiiiv",b6,58,ca,ba),false);
HXDLIN(2308)		cffi_lime_gl_scissor = inValue;
            	}
{
...
HXLINE(2309)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_shader_source",c5,d2,e2,7f),HX_("osv",d2,9e,54,00),false);
HXDLIN(2309)		cffi_lime_gl_shader_source = inValue;
            	}
{
...
HXLINE(2310)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_stencil_func",d7,b0,4f,64),HX_("iiiv",cd,6f,b7,45),false);
HXDLIN(2310)		cffi_lime_gl_stencil_func = inValue;
            	}
{
...
HXLINE(2311)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_stencil_func_separate",0b,13,77,19),HX_("iiiiv",b6,58,ca,ba),false);
HXDLIN(2311)		cffi_lime_gl_stencil_func_separate = inValue;
            	}
{
...
HXLINE(2312)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_stencil_mask",7f,06,e1,68),HX_("iv",ed,5b,00,00),false);
HXDLIN(2312)		cffi_lime_gl_stencil_mask = inValue;
            	}
{
...
HXLINE(2313)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_stencil_mask_separate",63,c8,71,65),HX_("iiv",96,08,50,00),false);
HXDLIN(2313)		cffi_lime_gl_stencil_mask_separate = inValue;
            	}
{
...
HXLINE(2314)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_stencil_op",f4,8b,0c,a5),HX_("iiiv",cd,6f,b7,45),false);
HXDLIN(2314)		cffi_lime_gl_stencil_op = inValue;
            	}
{
...
HXLINE(2315)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_stencil_op_separate",4e,6c,36,5e),HX_("iiiiv",b6,58,ca,ba),false);
HXDLIN(2315)		cffi_lime_gl_stencil_op_separate = inValue;
            	}
{
...
HXLINE(2316)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_tex_image_2d",5e,ab,7a,34),HX_("iiiiiiiioiv",9c,86,0f,79),false);
HXDLIN(2316)		cffi_lime_gl_tex_image_2d = inValue;
            	}
{
...
HXLINE(2317)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_tex_parameterf",65,7e,77,4d),HX_("iifv",30,6d,b7,45),false);
HXDLIN(2317)		cffi_lime_gl_tex_parameterf = inValue;
            	}
{
...
HXLINE(2318)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_tex_parameteri",68,7e,77,4d),HX_("iiiv",cd,6f,b7,45),false);
HXDLIN(2318)		cffi_lime_gl_tex_parameteri = inValue;
            	}
{
...
HXLINE(2319)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_tex_sub_image_2d",3d,4d,7e,52),HX_("iiiiiiiioiv",9c,86,0f,79),false);
HXDLIN(2319)		cffi_lime_gl_tex_sub_image_2d = inValue;
            	}
{
...
HXLINE(2320)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform1f",19,ea,eb,46),HX_("ifv",f9,05,50,00),false);
HXDLIN(2320)		cffi_lime_gl_uniform1f = inValue;
            	}
{
...
HXLINE(2321)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform1fv",3d,ec,80,c7),HX_("iov",d0,0d,50,00),false);
HXDLIN(2321)		cffi_lime_gl_uniform1fv = inValue;
            	}
{
...
HXLINE(2322)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform1i",1c,ea,eb,46),HX_("iiv",96,08,50,00),false);
HXDLIN(2322)		cffi_lime_gl_uniform1i = inValue;
            	}
{
...
HXLINE(2323)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform1iv",da,ee,80,c7),HX_("iov",d0,0d,50,00),false);
HXDLIN(2323)		cffi_lime_gl_uniform1iv = inValue;
            	}
{
...
HXLINE(2324)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform2f",f8,ea,eb,46),HX_("iffv",6d,26,b5,45),false);
HXDLIN(2324)		cffi_lime_gl_uniform2f = inValue;
            	}
{
...
HXLINE(2325)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform2fv",7e,ae,81,c7),HX_("iov",d0,0d,50,00),false);
HXDLIN(2325)		cffi_lime_gl_uniform2fv = inValue;
            	}
{
...
HXLINE(2326)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform2i",fb,ea,eb,46),HX_("iiiv",cd,6f,b7,45),false);
HXDLIN(2326)		cffi_lime_gl_uniform2i = inValue;
            	}
{
...
HXLINE(2327)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform2iv",1b,b1,81,c7),HX_("iov",d0,0d,50,00),false);
HXDLIN(2327)		cffi_lime_gl_uniform2iv = inValue;
            	}
{
...
HXLINE(2328)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform3f",d7,eb,eb,46),HX_("ifffv",79,6b,cc,b8),false);
HXDLIN(2328)		cffi_lime_gl_uniform3f = inValue;
            	}
{
...
HXLINE(2329)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform3fv",bf,70,82,c7),HX_("iov",d0,0d,50,00),false);
HXDLIN(2329)		cffi_lime_gl_uniform3fv = inValue;
            	}
{
...
HXLINE(2330)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform3i",da,eb,eb,46),HX_("iiiiv",b6,58,ca,ba),false);
HXDLIN(2330)		cffi_lime_gl_uniform3i = inValue;
            	}
{
...
HXLINE(2331)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform3iv",5c,73,82,c7),HX_("iov",d0,0d,50,00),false);
HXDLIN(2331)		cffi_lime_gl_uniform3iv = inValue;
            	}
{
...
HXLINE(2332)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform4f",b6,ec,eb,46),HX_("iffffv",ed,90,11,fa),false);
HXDLIN(2332)		cffi_lime_gl_uniform4f = inValue;
            	}
{
...
HXLINE(2333)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform4fv",00,33,83,c7),HX_("iov",d0,0d,50,00),false);
HXDLIN(2333)		cffi_lime_gl_uniform4fv = inValue;
            	}
{
...
HXLINE(2334)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform4i",b9,ec,eb,46),HX_("iiiiiv",ad,3b,43,b6),false);
HXDLIN(2334)		cffi_lime_gl_uniform4i = inValue;
            	}
{
...
HXLINE(2335)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform4iv",9d,35,83,c7),HX_("iov",d0,0d,50,00),false);
HXDLIN(2335)		cffi_lime_gl_uniform4iv = inValue;
            	}
{
...
HXLINE(2336)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform_matrix",5c,9a,cc,b2),HX_("iboiv",e3,67,2e,b6),false);
HXDLIN(2336)		cffi_lime_gl_uniform_matrix = inValue;
            	}
{
...
HXLINE(2337)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_use_program",1c,8c,b8,22),HX_("ov",27,61,00,00),false);
HXDLIN(2337)		cffi_lime_gl_use_program = inValue;
            	}
{
...
HXLINE(2338)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_validate_program",cb,eb,10,5b),HX_("ov",27,61,00,00),false);
HXDLIN(2338)		cffi_lime_gl_validate_program = inValue;
            	}
{
...
HXLINE(2339)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_version",e8,db,bc,3b),HX_("s",73,00,00,00),false);
HXDLIN(2339)		cffi_lime_gl_version = inValue;
            	}
{
...
HXLINE(2340)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_vertex_attrib1f",2a,cd,b2,7a),HX_("ifv",f9,05,50,00),false);
HXDLIN(2340)		cffi_lime_gl_vertex_attrib1f = inValue;
            	}
{
...
HXLINE(2341)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_vertex_attrib1fv",0c,b8,c0,e1),HX_("iov",d0,0d,50,00),false);
HXDLIN(2341)		cffi_lime_gl_vertex_attrib1fv = inValue;
            	}
{
...
HXLINE(2342)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_vertex_attrib2f",09,ce,b2,7a),HX_("iffv",6d,26,b5,45),false);
HXDLIN(2342)		cffi_lime_gl_vertex_attrib2f = inValue;
            	}
{
...
HXLINE(2343)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_vertex_attrib2fv",4d,7a,c1,e1),HX_("iov",d0,0d,50,00),false);
HXDLIN(2343)		cffi_lime_gl_vertex_attrib2fv = inValue;
            	}
{
...
HXLINE(2344)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_vertex_attrib3f",e8,ce,b2,7a),HX_("ifffv",79,6b,cc,b8),false);
HXDLIN(2344)		cffi_lime_gl_vertex_attrib3f = inValue;
            	}
{
...
HXLINE(2345)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_vertex_attrib3fv",8e,3c,c2,e1),HX_("iov",d0,0d,50,00),false);
HXDLIN(2345)		cffi_lime_gl_vertex_attrib3fv = inValue;
            	}
{
...
HXLINE(2346)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_vertex_attrib4f",c7,cf,b2,7a),HX_("iffffv",ed,90,11,fa),false);
HXDLIN(2346)		cffi_lime_gl_vertex_attrib4f = inValue;
            	}
{
...
HXLINE(2347)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_vertex_attrib4fv",cf,fe,c2,e1),HX_("iov",d0,0d,50,00),false);
HXDLIN(2347)		cffi_lime_gl_vertex_attrib4fv = inValue;
            	}
{
...
HXLINE(2348)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_vertex_attrib_pointer",13,fa,74,15),HX_("iiibiiv",7d,72,f0,bf),false);
HXDLIN(2348)		cffi_lime_gl_vertex_attrib_pointer = inValue;
            	}
{
...
HXLINE(2349)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_viewport",96,8d,70,cf),HX_("iiiiv",b6,58,ca,ba),false);
HXDLIN(2349)		cffi_lime_gl_viewport = inValue;
            	}
}
