...
void AssetCache_obj::__construct(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 933)		this->_hx___enabled = true;
HXLINE( 938)		this->bitmapData =  ::haxe::ds::StringMap_obj::__new();
HXLINE( 939)		this->font =  ::haxe::ds::StringMap_obj::__new();
HXLINE( 940)		this->sound =  ::haxe::ds::StringMap_obj::__new();
            	}
...
void AssetCache_obj::clear(::String prefix){
            	HX_STACK_FRAME("openfl.AssetCache","clear",0x1c26890f,"openfl.AssetCache.clear","openfl/Assets.hx",947,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(prefix,"prefix")
HXLINE( 947)		Bool _hx_tmp = hx::IsNull( prefix );
HXDLIN( 947)		if (_hx_tmp) {
HXLINE( 949)			this->bitmapData =  ::haxe::ds::StringMap_obj::__new();
HXLINE( 950)			this->font =  ::haxe::ds::StringMap_obj::__new();
HXLINE( 951)			this->sound =  ::haxe::ds::StringMap_obj::__new();
            		}
            		else {
HXLINE( 955)			HX_VARI(  ::Dynamic,keys) = this->bitmapData->keys();
HXLINE( 957)			while(true){
HXLINE( 957)				Bool _hx_tmp1 = !(( (Bool)( ::Dynamic(keys->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN( 957)				if (_hx_tmp1) {
HXLINE( 957)					goto _hx_goto_0;
            				}
HXDLIN( 957)				HX_VARI( ::String,key) = ( (::String)( ::Dynamic(keys->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE( 959)				Bool _hx_tmp2 = ::StringTools_obj::startsWith(key,prefix);
HXDLIN( 959)				if (_hx_tmp2) {
HXLINE( 961)					this->bitmapData->remove(key);
            				}
            			}
            			_hx_goto_0:;
HXLINE( 967)			HX_VARI_NAME(  ::Dynamic,keys1,"keys") = this->font->keys();
HXLINE( 969)			while(true){
HXLINE( 969)				Bool _hx_tmp3 = !(( (Bool)( ::Dynamic(keys1->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN( 969)				if (_hx_tmp3) {
HXLINE( 969)					goto _hx_goto_1;
            				}
HXDLIN( 969)				HX_VARI_NAME( ::String,key1,"key") = ( (::String)( ::Dynamic(keys1->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE( 971)				Bool _hx_tmp4 = ::StringTools_obj::startsWith(key1,prefix);
HXDLIN( 971)				if (_hx_tmp4) {
HXLINE( 973)					this->font->remove(key1);
            				}
            			}
            			_hx_goto_1:;
HXLINE( 979)			HX_VARI_NAME(  ::Dynamic,keys2,"keys") = this->sound->keys();
HXLINE( 981)			while(true){
HXLINE( 981)				Bool _hx_tmp5 = !(( (Bool)( ::Dynamic(keys2->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN( 981)				if (_hx_tmp5) {
HXLINE( 981)					goto _hx_goto_2;
            				}
HXDLIN( 981)				HX_VARI_NAME( ::String,key2,"key") = ( (::String)( ::Dynamic(keys2->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE( 983)				Bool _hx_tmp6 = ::StringTools_obj::startsWith(key2,prefix);
HXDLIN( 983)				if (_hx_tmp6) {
HXLINE( 985)					this->sound->remove(key2);
            				}
            			}
            			_hx_goto_2:;
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(AssetCache_obj,clear,(void))
 ...
 ::openfl::display::BitmapData AssetCache_obj::getBitmapData(::String id){
            	HX_STACK_FRAME("openfl.AssetCache","getBitmapData",0x76047b71,"openfl.AssetCache.getBitmapData","openfl/Assets.hx",998,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE( 998)		return this->bitmapData->get(id).StaticCast<  ::openfl::display::BitmapData >();
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(AssetCache_obj,getBitmapData,return )
 ...
 ::openfl::text::Font AssetCache_obj::getFont(::String id){
            	HX_STACK_FRAME("openfl.AssetCache","getFont",0xc4a48987,"openfl.AssetCache.getFont","openfl/Assets.hx",1005,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(1005)		return this->font->get(id).StaticCast<  ::openfl::text::Font >();
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(AssetCache_obj,getFont,return )
 ...
 ::openfl::media::Sound AssetCache_obj::getSound(::String id){
            	HX_STACK_FRAME("openfl.AssetCache","getSound",0xc78ea217,"openfl.AssetCache.getSound","openfl/Assets.hx",1012,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(1012)		return this->sound->get(id).StaticCast<  ::openfl::media::Sound >();
            	}
...
Bool AssetCache_obj::hasBitmapData(::String id){
            	HX_STACK_FRAME("openfl.AssetCache","hasBitmapData",0x33e8d735,"openfl.AssetCache.hasBitmapData","openfl/Assets.hx",1019,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(1019)		return this->bitmapData->exists(id);
            	}
...
Bool AssetCache_obj::hasFont(::String id){
            	HX_STACK_FRAME("openfl.AssetCache","hasFont",0xc165fa4b,"openfl.AssetCache.hasFont","openfl/Assets.hx",1026,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(1026)		return this->font->exists(id);
            	}
...
Bool AssetCache_obj::hasSound(::String id){
            	HX_STACK_FRAME("openfl.AssetCache","hasSound",0xf40fdcd3,"openfl.AssetCache.hasSound","openfl/Assets.hx",1033,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(1033)		return this->sound->exists(id);
            	}
...
Bool AssetCache_obj::removeBitmapData(::String id){
            	HX_STACK_FRAME("openfl.AssetCache","removeBitmapData",0x7d8dc6db,"openfl.AssetCache.removeBitmapData","openfl/Assets.hx",1040,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(1040)		return this->bitmapData->remove(id);
            	}
...
Bool AssetCache_obj::removeFont(::String id){
            	HX_STACK_FRAME("openfl.AssetCache","removeFont",0x7ce60971,"openfl.AssetCache.removeFont","openfl/Assets.hx",1047,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(1047)		return this->font->remove(id);
            	}
...
Bool AssetCache_obj::removeSound(::String id){
            	HX_STACK_FRAME("openfl.AssetCache","removeSound",0x489d0eed,"openfl.AssetCache.removeSound","openfl/Assets.hx",1054,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(1054)		return this->sound->remove(id);
            	}
...
void AssetCache_obj::setBitmapData(::String id, ::openfl::display::BitmapData bitmapData){
            	HX_STACK_FRAME("openfl.AssetCache","setBitmapData",0xbb0a5d7d,"openfl.AssetCache.setBitmapData","openfl/Assets.hx",1061,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
            	HX_STACK_ARG(bitmapData,"bitmapData")
HXLINE(1061)		this->bitmapData->set(id,bitmapData);
            	}
...
void AssetCache_obj::setFont(::String id, ::openfl::text::Font font){
            	HX_STACK_FRAME("openfl.AssetCache","setFont",0xb7a61a93,"openfl.AssetCache.setFont","openfl/Assets.hx",1068,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
            	HX_STACK_ARG(font,"font")
HXLINE(1068)		this->font->set(id,font);
            	}
...
void AssetCache_obj::setSound(::String id, ::openfl::media::Sound sound){
            	HX_STACK_FRAME("openfl.AssetCache","setSound",0x75ebfb8b,"openfl.AssetCache.setSound","openfl/Assets.hx",1075,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
            	HX_STACK_ARG(sound,"sound")
HXLINE(1075)		this->sound->set(id,sound);
            	}
...
Bool AssetCache_obj::get_enabled(){
            	HX_STACK_FRAME("openfl.AssetCache","get_enabled",0xcdc8099a,"openfl.AssetCache.get_enabled","openfl/Assets.hx",1089,0x989d477c)
            	HX_STACK_THIS(this)
HXLINE(1089)		return this->_hx___enabled;
            	}
...
Bool AssetCache_obj::set_enabled(Bool value){
            	HX_STACK_FRAME("openfl.AssetCache","set_enabled",0xd83510a6,"openfl.AssetCache.set_enabled","openfl/Assets.hx",1096,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(1096)		return (this->_hx___enabled = value);
            	}
