...
HXLINE(  46)			 ::openfl::geom::Rectangle _hx_tmp1 = object->get_scrollRect();
HXDLIN(  46)			_hx_tmp = hx::IsNotNull( _hx_tmp1 );
            		}
            		else {
HXLINE(  46)			_hx_tmp = false;
            		}
HXDLIN(  46)		if (_hx_tmp) {
HXLINE(  48)			 ::openfl::geom::Rectangle _hx_tmp2 = object->get_scrollRect();
HXDLIN(  48)			this->pushRect(_hx_tmp2,object->_hx___worldTransform);
            		}
HXLINE(  52)		Bool _hx_tmp3 = hx::IsNotNull( object->_hx___mask );
...
HXLINE(  90)			 ::openfl::geom::Rectangle _hx_tmp2 = object->get_scrollRect();
HXDLIN(  90)			_hx_tmp1 = hx::IsNotNull( _hx_tmp2 );
            		}
            		else {
