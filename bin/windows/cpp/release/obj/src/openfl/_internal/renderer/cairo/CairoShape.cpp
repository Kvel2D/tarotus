...
HXDLIN(  19)		if (!(!(shape->_hx___renderable))) {
HXLINE(  19)			_hx_tmp = (shape->_hx___worldAlpha <= (int)0);
            		}
            		else {
...
HXLINE(  21)		HX_VARI(  ::openfl::display::Graphics,graphics) = shape->_hx___graphics;
HXLINE(  23)		Bool _hx_tmp1 = hx::IsNotNull( graphics );
HXDLIN(  23)		if (_hx_tmp1) {
HXLINE(  25)			::openfl::_internal::renderer::cairo::CairoGraphics_obj::render(graphics,renderSession,shape->_hx___worldTransform);
HXLINE(  27)			HX_VARI(  ::openfl::geom::Rectangle,bounds) = graphics->_hx___bounds;
HXLINE(  29)			Bool _hx_tmp2;
HXDLIN(  29)			Bool _hx_tmp3;
HXDLIN(  29)			Bool _hx_tmp4;
HXDLIN(  29)			Bool _hx_tmp5;
HXDLIN(  29)			Bool _hx_tmp6 = hx::IsNotNull( graphics->_hx___cairo );
HXDLIN(  29)			if (_hx_tmp6) {
HXLINE(  29)				_hx_tmp5 = graphics->_hx___visible;
            			}
            			else {
HXLINE(  29)				_hx_tmp5 = false;
            			}
HXDLIN(  29)			if (_hx_tmp5) {
HXLINE(  29)				_hx_tmp4 = hx::IsNotNull( bounds );
            			}
            			else {
HXLINE(  29)				_hx_tmp4 = false;
            			}
HXDLIN(  29)			if (_hx_tmp4) {
HXLINE(  29)				_hx_tmp3 = (graphics->_hx___width >= (int)1);
            			}
            			else {
HXLINE(  29)				_hx_tmp3 = false;
            			}
HXDLIN(  29)			if (_hx_tmp3) {
HXLINE(  29)				_hx_tmp2 = (graphics->_hx___height >= (int)1);
            			}
            			else {
HXLINE(  29)				_hx_tmp2 = false;
            			}
HXDLIN(  29)			if (_hx_tmp2) {
HXLINE(  31)				renderSession->maskManager->pushObject(shape,null());
HXLINE(  33)				HX_VARI(  ::lime::graphics::cairo::Cairo,cairo) = renderSession->cairo;
HXLINE(  35)				Bool _hx_tmp7 = renderSession->roundPixels;
HXDLIN(  35)				if (_hx_tmp7) {
HXLINE(  37)					HX_VARI(  ::lime::math::Matrix3,matrix) = graphics->_hx___worldTransform->_hx___toMatrix3();
HXLINE(  38)					matrix->tx = ::Math_obj::round(matrix->tx);
HXLINE(  39)					matrix->ty = ::Math_obj::round(matrix->ty);
HXLINE(  40)					cairo->set_matrix(matrix);
            				}
            				else {
HXLINE(  44)					 ::lime::math::Matrix3 _hx_tmp8 = graphics->_hx___worldTransform->_hx___toMatrix3();
HXDLIN(  44)					cairo->set_matrix(_hx_tmp8);
            				}
HXLINE(  48)				 ::Dynamic _hx_tmp9 = graphics->_hx___cairo->get_target();
HXDLIN(  48)				cairo->setSourceSurface(_hx_tmp9,(int)0,(int)0);
HXLINE(  49)				cairo->paintWithAlpha(shape->_hx___worldAlpha);
HXLINE(  51)				renderSession->maskManager->popObject(shape,null());
            			}
            		}
            	}
