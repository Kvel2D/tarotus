...
HXLINE( 148)		Bool _hx_tmp = !(stage->_hx___transparent);
HXDLIN( 148)		if (_hx_tmp) {
HXLINE( 150)			this->element->style->__SetField(HX_("background",ee,93,1d,26),stage->_hx___colorString,hx::paccDynamic);
            		}
            		else {
HXLINE( 154)			this->element->style->__SetField(HX_("background",ee,93,1d,26),HX_("none",b8,12,0a,49),hx::paccDynamic);
            		}
HXLINE( 158)		this->renderSession->z = (int)1;
HXLINE( 159)		stage->_hx___renderDOM(this->renderSession);
            	}
