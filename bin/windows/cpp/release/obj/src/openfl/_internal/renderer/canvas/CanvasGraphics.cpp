...
Bool CanvasGraphics_obj::isCCW(Float x1,Float y1,Float x2,Float y2,Float x3,Float y3){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","isCCW",0xce74af1d,"openfl._internal.renderer.canvas.CanvasGraphics.isCCW","openfl/_internal/renderer/canvas/CanvasGraphics.hx",453,0x0b9ff65e)
            	HX_STACK_ARG(x1,"x1")
            	HX_STACK_ARG(y1,"y1")
            	HX_STACK_ARG(x2,"x2")
            	HX_STACK_ARG(y2,"y2")
            	HX_STACK_ARG(x3,"x3")
            	HX_STACK_ARG(y3,"y3")
HXLINE( 453)		return ((((x2 - x1) * (y3 - y1)) - ((y2 - y1) * (x3 - x1))) < (int)0);
            	}
...
HXLINE( 460)		HX_VARI( Float,max) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 461)		HX_VARI( Float,tmp) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 462)		HX_VARI( Int,len) = uvt->get_length();
HXLINE( 464)		{
HXLINE( 464)			HX_VARI( Int,_g1) = (int)1;
HXDLIN( 464)			HX_VARI( Int,_g) = (len + (int)1);
HXDLIN( 464)			while((_g1 < _g)){
HXLINE( 464)				HX_VARI( Int,t) = _g1++;
HXLINE( 466)				Bool _hx_tmp;
HXDLIN( 466)				if (skipT) {
HXLINE( 466)					_hx_tmp = (hx::Mod(t,(int)3) == (int)0);
            				}
            				else {
...
HXLINE( 474)				Bool _hx_tmp1 = (max < tmp);
HXDLIN( 474)				if (_hx_tmp1) {
HXLINE( 476)					max = tmp;
            				}
            			}
            		}
HXLINE( 482)		Int length = null();
HXDLIN( 482)		Bool fixed = null();
HXDLIN( 482)		HX_VARI(  ::openfl::_Vector::FloatVector,result) =  ::openfl::_Vector::FloatVector_obj::__new(length,fixed,null());
HXLINE( 484)		{
HXLINE( 484)			HX_VARI_NAME( Int,_g11,"_g1") = (int)1;
HXDLIN( 484)			HX_VARI_NAME( Int,_g2,"_g") = (len + (int)1);
HXDLIN( 484)			while((_g11 < _g2)){
HXLINE( 484)				HX_VARI_NAME( Int,t1,"t") = _g11++;
HXLINE( 486)				Bool _hx_tmp2;
HXDLIN( 486)				if (skipT) {
HXLINE( 486)					_hx_tmp2 = (hx::Mod(t1,(int)3) == (int)0);
            				}
            				else {
...
HXLINE( 492)				{
HXLINE( 492)					Float x = ((Float)uvt->get((t1 - (int)1)) / (Float)max);
HXDLIN( 492)					result->push(x);
            				}
            			}
            		}
