...
void DrawCommandBuffer_obj::__construct(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  36)		this->types = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  38)		this->b = ::Array_obj< Bool >::__new(0);
HXLINE(  39)		this->i = ::Array_obj< Int >::__new(0);
HXLINE(  40)		this->f = ::Array_obj< Float >::__new(0);
HXLINE(  41)		this->o = ::cpp::VirtualArray_obj::__new(0);
HXLINE(  42)		this->ff = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  43)		this->ii = ::Array_obj< ::Dynamic>::__new(0);
            	}
...
HXLINE(  50)		HX_VARI(  ::openfl::_internal::renderer::DrawCommandReader,data) =  ::openfl::_internal::renderer::DrawCommandReader_obj::__new(other);
HXLINE(  52)		{
HXLINE(  52)			HX_VARI( Int,_g) = (int)0;
HXDLIN(  52)			HX_VARI( ::Array< ::Dynamic>,_g1) = other->types;
HXDLIN(  52)			while((_g < _g1->length)){
HXLINE(  52)				HX_VARI( ::hx::EnumBase,type) = _g1->__get(_g).StaticCast< ::hx::EnumBase >();
HXDLIN(  52)				++_g;
HXLINE(  54)				Int _hx_tmp = ( ( ::hx::EnumBase)(type) )->_hx_getIndex();
HXDLIN(  54)				switch((int)(_hx_tmp)){
            					case (int)0: {
HXLINE(  56)						{
HXLINE(  56)							Int _hx_tmp1 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  56)							switch((int)(_hx_tmp1)){
            								case (int)0: {
HXLINE(  56)									hx::AddEq(data->oPos,(int)2);
HXDLIN(  56)									hx::AddEq(data->bPos,(int)2);
            								}
            								break;
            								case (int)1: {
HXLINE(  56)									hx::AddEq(data->iPos,(int)1);
HXDLIN(  56)									hx::AddEq(data->fPos,(int)1);
            								}
            								break;
            								case (int)2: {
HXLINE(  56)									hx::AddEq(data->oPos,(int)4);
HXDLIN(  56)									hx::AddEq(data->iiPos,(int)2);
HXDLIN(  56)									hx::AddEq(data->ffPos,(int)1);
HXDLIN(  56)									hx::AddEq(data->fPos,(int)1);
            								}
            								break;
            								case (int)3: {
HXLINE(  56)									hx::AddEq(data->fPos,(int)6);
            								}
            								break;
            								case (int)4: {
HXLINE(  56)									hx::AddEq(data->fPos,(int)4);
            								}
            								break;
            								case (int)5: {
HXLINE(  56)									hx::AddEq(data->fPos,(int)3);
            								}
            								break;
            								case (int)6: {
HXLINE(  56)									hx::AddEq(data->fPos,(int)4);
...
HXLINE(  56)									hx::AddEq(data->fPos,(int)4);
            								...
            								break;
            								case (int)8: {
HXLINE(  56)									hx::AddEq(data->fPos,(int)5);
HXDLIN(  56)									hx::AddEq(data->oPos,(int)1);
            								}
            								break;
            								case (int)10: {
HXLINE(  56)									hx::AddEq(data->oPos,(int)4);
...
HXDLIN(  56)									hx::AddEq(data->fPos,(int)1);
            								...
            								case (int)14: {
HXLINE(  56)									hx::AddEq(data->oPos,(int)4);
HXDLIN(  56)									hx::AddEq(data->iPos,(int)1);
HXDLIN(  56)									hx::AddEq(data->fPos,(int)2);
HXDLIN(  56)									hx::AddEq(data->bPos,(int)1);
            								}
            								break;
            								case (int)15: {
HXLINE(  56)									hx::AddEq(data->fPos,(int)2);
            								}
            								break;
            								case (int)16: {
HXLINE(  56)									hx::AddEq(data->fPos,(int)2);
            								...
            								break;
            								case (int)17: {
HXLINE(  56)									hx::AddEq(data->oPos,(int)1);
            								}
            								break;
            								default:{
            								}
...
HXLINE(  56)						data->prev = ::openfl::_internal::renderer::DrawCommandType_obj::BEGIN_BITMAP_FILL_dyn();
HXDLIN(  56)						HX_VARI(  ::openfl::_internal::renderer::DrawCommandReader,c) = data;
HXDLIN(  56)						 ::openfl::display::BitmapData _hx_tmp2 = ( ( ::openfl::display::BitmapData)(c->buffer->o->__get(c->oPos)) );
HXDLIN(  56)						 ::openfl::geom::Matrix _hx_tmp3 = ( ( ::openfl::geom::Matrix)(c->buffer->o->__get((c->oPos + (int)1))) );
HXDLIN(  56)						Bool _hx_tmp4 = c->buffer->b->__get(c->bPos);
HXDLIN(  56)						Bool _hx_tmp5 = c->buffer->b->__get((c->bPos + (int)1));
HXDLIN(  56)						this->beginBitmapFill(_hx_tmp2,_hx_tmp3,_hx_tmp4,_hx_tmp5);
            					}
            					break;
            					case (int)1: {
HXLINE(  57)						{
HXLINE(  57)							Int _hx_tmp6 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  57)							switch((int)(_hx_tmp6)){
            								case (int)0: {
HXLINE(  57)									hx::AddEq(data->oPos,(int)2);
HXDLIN(  57)									hx::AddEq(data->bPos,(int)2);
            								}
            								break;
            								case (int)1: {
HXLINE(  57)									hx::AddEq(data->iPos,(int)1);
HXDLIN(  57)									hx::AddEq(data->fPos,(int)1);
            								}
            								break;
            								case (int)2: {
HXLINE(  57)									hx::AddEq(data->oPos,(int)4);
HXDLIN(  57)									hx::AddEq(data->iiPos,(int)2);
HXDLIN(  57)									hx::AddEq(data->ffPos,(int)1);
HXDLIN(  57)									hx::AddEq(data->fPos,(int)1);
            								}
            								break;
            								case (int)3: {
HXLINE(  57)									hx::AddEq(data->fPos,(int)6);
            								}
            								break;
            								case (int)4: {
HXLINE(  57)									hx::AddEq(data->fPos,(int)4);
            								}
            								break;
            								case (int)5: {
HXLINE(  57)									hx::AddEq(data->fPos,(int)3);
            								}
            								break;
            								case (int)6: {
HXLINE(  57)									hx::AddEq(data->fPos,(int)4);
...
HXLINE(  57)									hx::AddEq(data->fPos,(int)4);
            								...
            								break;
            								case (int)8: {
HXLINE(  57)									hx::AddEq(data->fPos,(int)5);
HXDLIN(  57)									hx::AddEq(data->oPos,(int)1);
            								}
            								break;
            								case (int)10: {
HXLINE(  57)									hx::AddEq(data->oPos,(int)4);
...
HXDLIN(  57)									hx::AddEq(data->fPos,(int)1);
            								...
            								case (int)14: {
HXLINE(  57)									hx::AddEq(data->oPos,(int)4);
HXDLIN(  57)									hx::AddEq(data->iPos,(int)1);
HXDLIN(  57)									hx::AddEq(data->fPos,(int)2);
HXDLIN(  57)									hx::AddEq(data->bPos,(int)1);
            								}
            								break;
            								case (int)15: {
HXLINE(  57)									hx::AddEq(data->fPos,(int)2);
            								}
            								break;
            								case (int)16: {
HXLINE(  57)									hx::AddEq(data->fPos,(int)2);
            								...
            								break;
            								case (int)17: {
HXLINE(  57)									hx::AddEq(data->oPos,(int)1);
            								}
            								break;
            								default:{
            								}
...
HXLINE(  57)						data->prev = ::openfl::_internal::renderer::DrawCommandType_obj::BEGIN_FILL_dyn();
HXDLIN(  57)						HX_VARI_NAME(  ::openfl::_internal::renderer::DrawCommandReader,c1,"c") = data;
HXDLIN(  57)						Int _hx_tmp7 = c1->buffer->i->__get(c1->iPos);
HXDLIN(  57)						Float _hx_tmp8 = c1->buffer->f->__get(c1->fPos);
HXDLIN(  57)						this->beginFill(_hx_tmp7,_hx_tmp8);
            					}
            					break;
            					case (int)2: {
HXLINE(  58)						{
HXLINE(  58)							Int _hx_tmp9 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  58)							switch((int)(_hx_tmp9)){
            								case (int)0: {
HXLINE(  58)									hx::AddEq(data->oPos,(int)2);
HXDLIN(  58)									hx::AddEq(data->bPos,(int)2);
            								}
            								break;
            								case (int)1: {
HXLINE(  58)									hx::AddEq(data->iPos,(int)1);
HXDLIN(  58)									hx::AddEq(data->fPos,(int)1);
            								}
            								break;
            								case (int)2: {
HXLINE(  58)									hx::AddEq(data->oPos,(int)4);
HXDLIN(  58)									hx::AddEq(data->iiPos,(int)2);
HXDLIN(  58)									hx::AddEq(data->ffPos,(int)1);
HXDLIN(  58)									hx::AddEq(data->fPos,(int)1);
            								}
            								break;
            								case (int)3: {
HXLINE(  58)									hx::AddEq(data->fPos,(int)6);
            								}
            								break;
            								case (int)4: {
HXLINE(  58)									hx::AddEq(data->fPos,(int)4);
            								}
            								break;
            								case (int)5: {
HXLINE(  58)									hx::AddEq(data->fPos,(int)3);
            								}
            								break;
            								case (int)6: {
HXLINE(  58)									hx::AddEq(data->fPos,(int)4);
...
HXLINE(  58)									hx::AddEq(data->fPos,(int)4);
            								...
            								break;
            								case (int)8: {
HXLINE(  58)									hx::AddEq(data->fPos,(int)5);
HXDLIN(  58)									hx::AddEq(data->oPos,(int)1);
            								}
            								break;
            								case (int)10: {
HXLINE(  58)									hx::AddEq(data->oPos,(int)4);
...
HXDLIN(  58)									hx::AddEq(data->fPos,(int)1);
            								...
            								case (int)14: {
HXLINE(  58)									hx::AddEq(data->oPos,(int)4);
HXDLIN(  58)									hx::AddEq(data->iPos,(int)1);
HXDLIN(  58)									hx::AddEq(data->fPos,(int)2);
HXDLIN(  58)									hx::AddEq(data->bPos,(int)1);
            								}
            								break;
            								case (int)15: {
HXLINE(  58)									hx::AddEq(data->fPos,(int)2);
            								}
            								break;
            								case (int)16: {
HXLINE(  58)									hx::AddEq(data->fPos,(int)2);
            								...
            								break;
            								case (int)17: {
HXLINE(  58)									hx::AddEq(data->oPos,(int)1);
            								}
            								break;
            								default:{
            								}
...
HXLINE(  58)						data->prev = ::openfl::_internal::renderer::DrawCommandType_obj::BEGIN_GRADIENT_FILL_dyn();
HXDLIN(  58)						HX_VARI_NAME(  ::openfl::_internal::renderer::DrawCommandReader,c2,"c") = data;
HXDLIN(  58)						Int _hx_tmp10 = (c2->iiPos + (int)1);
HXDLIN(  58)						Int _hx_tmp11 = (c2->oPos + (int)1);
HXDLIN(  58)						Int _hx_tmp12 = (c2->oPos + (int)2);
HXDLIN(  58)						Int _hx_tmp13 = (c2->oPos + (int)3);
HXDLIN(  58)						this->beginGradientFill(c2->buffer->o->__get(c2->oPos),c2->buffer->ii->__get(c2->iiPos).StaticCast< ::Array< Int > >(),c2->buffer->ff->__get(c2->ffPos).StaticCast< ::Array< Float > >(),c2->buffer->ii->__get(_hx_tmp10).StaticCast< ::Array< Int > >(),( ( ::openfl::geom::Matrix)(c2->buffer->o->__get(_hx_tmp11)) ),c2->buffer->o->__get(_hx_tmp12),c2->buffer->o->__get(_hx_tmp13),c2->buffer->f->__get(c2->fPos));
            					}
            					break;
            					case (int)3: {
HXLINE(  59)						{
HXLINE(  59)							Int _hx_tmp14 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  59)							switch((int)(_hx_tmp14)){
            								case (int)0: {
...
HXLINE(  59)						data->prev = ::openfl::_internal::renderer::DrawCommandType_obj::CUBIC_CURVE_TO_dyn();
HXDLIN(  59)						HX_VARI_NAME(  ::openfl::_internal::renderer::DrawCommandReader,c3,"c") = data;
HXDLIN(  59)						Float _hx_tmp15 = c3->buffer->f->__get(c3->fPos);
HXDLIN(  59)						Float _hx_tmp16 = c3->buffer->f->__get((c3->fPos + (int)1));
HXDLIN(  59)						Float _hx_tmp17 = c3->buffer->f->__get((c3->fPos + (int)2));
HXDLIN(  59)						Float _hx_tmp18 = c3->buffer->f->__get((c3->fPos + (int)3));
HXDLIN(  59)						Float _hx_tmp19 = c3->buffer->f->__get((c3->fPos + (int)4));
HXDLIN(  59)						Float _hx_tmp20 = c3->buffer->f->__get((c3->fPos + (int)5));
HXDLIN(  59)						this->cubicCurveTo(_hx_tmp15,_hx_tmp16,_hx_tmp17,_hx_tmp18,_hx_tmp19,_hx_tmp20);
            					}
            					break;
            					case (int)4: {
HXLINE(  60)						{
HXLINE(  60)							Int _hx_tmp21 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  60)							switch((int)(_hx_tmp21)){
            								case (int)0: {
...
HXLINE(  60)						data->prev = ::openfl::_internal::renderer::DrawCommandType_obj::CURVE_TO_dyn();
HXDLIN(  60)						HX_VARI_NAME(  ::openfl::_internal::renderer::DrawCommandReader,c4,"c") = data;
HXDLIN(  60)						Float _hx_tmp22 = c4->buffer->f->__get(c4->fPos);
HXDLIN(  60)						Float _hx_tmp23 = c4->buffer->f->__get((c4->fPos + (int)1));
HXDLIN(  60)						Float _hx_tmp24 = c4->buffer->f->__get((c4->fPos + (int)2));
HXDLIN(  60)						Float _hx_tmp25 = c4->buffer->f->__get((c4->fPos + (int)3));
HXDLIN(  60)						this->curveTo(_hx_tmp22,_hx_tmp23,_hx_tmp24,_hx_tmp25);
            					}
            					break;
            					case (int)5: {
HXLINE(  61)						{
HXLINE(  61)							Int _hx_tmp26 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  61)							switch((int)(_hx_tmp26)){
            								case (int)0: {
...
HXLINE(  61)						data->prev = ::openfl::_internal::renderer::DrawCommandType_obj::DRAW_CIRCLE_dyn();
HXDLIN(  61)						HX_VARI_NAME(  ::openfl::_internal::renderer::DrawCommandReader,c5,"c") = data;
HXDLIN(  61)						Float _hx_tmp27 = c5->buffer->f->__get(c5->fPos);
HXDLIN(  61)						Float _hx_tmp28 = c5->buffer->f->__get((c5->fPos + (int)1));
HXDLIN(  61)						Float _hx_tmp29 = c5->buffer->f->__get((c5->fPos + (int)2));
HXDLIN(  61)						this->drawCircle(_hx_tmp27,_hx_tmp28,_hx_tmp29);
            					}
            					break;
            					case (int)6: {
HXLINE(  62)						{
HXLINE(  62)							Int _hx_tmp30 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  62)							switch((int)(_hx_tmp30)){
            								case (int)0: {
...
HXLINE(  62)						data->prev = ::openfl::_internal::renderer::DrawCommandType_obj::DRAW_ELLIPSE_dyn();
HXDLIN(  62)						HX_VARI_NAME(  ::openfl::_internal::renderer::DrawCommandReader,c6,"c") = data;
HXDLIN(  62)						Float _hx_tmp31 = c6->buffer->f->__get(c6->fPos);
HXDLIN(  62)						Float _hx_tmp32 = c6->buffer->f->__get((c6->fPos + (int)1));
HXDLIN(  62)						Float _hx_tmp33 = c6->buffer->f->__get((c6->fPos + (int)2));
HXDLIN(  62)						Float _hx_tmp34 = c6->buffer->f->__get((c6->fPos + (int)3));
HXDLIN(  62)						this->drawEllipse(_hx_tmp31,_hx_tmp32,_hx_tmp33,_hx_tmp34);
            					}
            					break;
            					case (int)7: {
HXLINE(  63)						{
HXLINE(  63)							Int _hx_tmp35 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  63)							switch((int)(_hx_tmp35)){
            								case (int)0: {
...
HXLINE(  63)						data->prev = ::openfl::_internal::renderer::DrawCommandType_obj::DRAW_RECT_dyn();
HXDLIN(  63)						HX_VARI_NAME(  ::openfl::_internal::renderer::DrawCommandReader,c7,"c") = data;
HXDLIN(  63)						Float _hx_tmp36 = c7->buffer->f->__get(c7->fPos);
HXDLIN(  63)						Float _hx_tmp37 = c7->buffer->f->__get((c7->fPos + (int)1));
HXDLIN(  63)						Float _hx_tmp38 = c7->buffer->f->__get((c7->fPos + (int)2));
HXDLIN(  63)						Float _hx_tmp39 = c7->buffer->f->__get((c7->fPos + (int)3));
HXDLIN(  63)						this->drawRect(_hx_tmp36,_hx_tmp37,_hx_tmp38,_hx_tmp39);
            					}
            					break;
            					case (int)8: {
HXLINE(  64)						{
HXLINE(  64)							Int _hx_tmp40 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  64)							switch((int)(_hx_tmp40)){
            								case (int)0: {
...
HXLINE(  64)						data->prev = ::openfl::_internal::renderer::DrawCommandType_obj::DRAW_ROUND_RECT_dyn();
HXDLIN(  64)						HX_VARI_NAME(  ::openfl::_internal::renderer::DrawCommandReader,c8,"c") = data;
HXDLIN(  64)						Float _hx_tmp41 = c8->buffer->f->__get(c8->fPos);
HXDLIN(  64)						Float _hx_tmp42 = c8->buffer->f->__get((c8->fPos + (int)1));
HXDLIN(  64)						Float _hx_tmp43 = c8->buffer->f->__get((c8->fPos + (int)2));
HXDLIN(  64)						Float _hx_tmp44 = c8->buffer->f->__get((c8->fPos + (int)3));
HXDLIN(  64)						Float _hx_tmp45 = c8->buffer->f->__get((c8->fPos + (int)4));
HXDLIN(  64)						this->drawRoundRect(_hx_tmp41,_hx_tmp42,_hx_tmp43,_hx_tmp44,_hx_tmp45,c8->buffer->o->__get(c8->oPos));
            					}
            					break;
            					case (int)10: {
HXLINE(  65)						{
HXLINE(  65)							Int _hx_tmp46 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  65)							switch((int)(_hx_tmp46)){
            								case (int)0: {
...
HXLINE(  65)						data->prev = ::openfl::_internal::renderer::DrawCommandType_obj::DRAW_TRIANGLES_dyn();
HXDLIN(  65)						HX_VARI_NAME(  ::openfl::_internal::renderer::DrawCommandReader,c9,"c") = data;
HXDLIN(  65)						Int _hx_tmp47 = (c9->oPos + (int)1);
HXDLIN(  65)						Int _hx_tmp48 = (c9->oPos + (int)2);
HXDLIN(  65)						Int _hx_tmp49 = (c9->oPos + (int)3);
HXDLIN(  65)						this->drawTriangles(( ( ::openfl::_Vector::FloatVector)(c9->buffer->o->__get(c9->oPos)) ),( ( ::openfl::_Vector::IntVector)(c9->buffer->o->__get(_hx_tmp47)) ),( ( ::openfl::_Vector::FloatVector)(c9->buffer->o->__get(_hx_tmp48)) ),c9->buffer->o->__get(_hx_tmp49));
            					}
            					break;
            					case (int)11: {
HXLINE(  66)						{
HXLINE(  66)							Int _hx_tmp50 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  66)							switch((int)(_hx_tmp50)){
            								case (int)0: {
...
HXLINE(  66)						data->prev = ::openfl::_internal::renderer::DrawCommandType_obj::END_FILL_dyn();
HXDLIN(  66)						this->endFill();
            					}
            					break;
            					case (int)12: {
HXLINE(  67)						{
HXLINE(  67)							Int _hx_tmp51 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  67)							switch((int)(_hx_tmp51)){
            								case (int)0: {
...
HXLINE(  67)						data->prev = ::openfl::_internal::renderer::DrawCommandType_obj::LINE_BITMAP_STYLE_dyn();
HXDLIN(  67)						HX_VARI_NAME(  ::openfl::_internal::renderer::DrawCommandReader,c10,"c") = data;
HXDLIN(  67)						Int _hx_tmp52 = (c10->oPos + (int)1);
HXDLIN(  67)						Int _hx_tmp53 = (c10->bPos + (int)1);
HXDLIN(  67)						this->lineBitmapStyle(( ( ::openfl::display::BitmapData)(c10->buffer->o->__get(c10->oPos)) ),( ( ::openfl::geom::Matrix)(c10->buffer->o->__get(_hx_tmp52)) ),c10->buffer->b->__get(c10->bPos),c10->buffer->b->__get(_hx_tmp53));
            					}
            					break;
            					case (int)13: {
HXLINE(  68)						{
HXLINE(  68)							Int _hx_tmp54 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  68)							switch((int)(_hx_tmp54)){
            								case (int)0: {
...
HXLINE(  68)						data->prev = ::openfl::_internal::renderer::DrawCommandType_obj::LINE_GRADIENT_STYLE_dyn();
HXDLIN(  68)						HX_VARI_NAME(  ::openfl::_internal::renderer::DrawCommandReader,c11,"c") = data;
HXDLIN(  68)						Int _hx_tmp55 = (c11->iiPos + (int)1);
HXDLIN(  68)						Int _hx_tmp56 = (c11->oPos + (int)1);
HXDLIN(  68)						Int _hx_tmp57 = (c11->oPos + (int)2);
HXDLIN(  68)						Int _hx_tmp58 = (c11->oPos + (int)3);
HXDLIN(  68)						this->lineGradientStyle(c11->buffer->o->__get(c11->oPos),c11->buffer->ii->__get(c11->iiPos).StaticCast< ::Array< Int > >(),c11->buffer->ff->__get(c11->ffPos).StaticCast< ::Array< Float > >(),c11->buffer->ii->__get(_hx_tmp55).StaticCast< ::Array< Int > >(),( ( ::openfl::geom::Matrix)(c11->buffer->o->__get(_hx_tmp56)) ),c11->buffer->o->__get(_hx_tmp57),c11->buffer->o->__get(_hx_tmp58),c11->buffer->f->__get(c11->fPos));
            					}
            					break;
            					case (int)14: {
HXLINE(  69)						{
HXLINE(  69)							Int _hx_tmp59 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  69)							switch((int)(_hx_tmp59)){
            								case (int)0: {
...
HXLINE(  69)						data->prev = ::openfl::_internal::renderer::DrawCommandType_obj::LINE_STYLE_dyn();
HXDLIN(  69)						HX_VARI_NAME(  ::openfl::_internal::renderer::DrawCommandReader,c12,"c") = data;
HXDLIN(  69)						Int _hx_tmp60 = (c12->oPos + (int)1);
HXDLIN(  69)						Int _hx_tmp61 = (c12->oPos + (int)2);
HXDLIN(  69)						Int _hx_tmp62 = (c12->oPos + (int)3);
HXDLIN(  69)						Int _hx_tmp63 = (c12->fPos + (int)1);
HXDLIN(  69)						this->lineStyle(c12->buffer->o->__get(c12->oPos),c12->buffer->i->__get(c12->iPos),c12->buffer->f->__get(c12->fPos),c12->buffer->b->__get(c12->bPos),c12->buffer->o->__get(_hx_tmp60),c12->buffer->o->__get(_hx_tmp61),c12->buffer->o->__get(_hx_tmp62),c12->buffer->f->__get(_hx_tmp63));
            					}
            					break;
            					case (int)15: {
HXLINE(  70)						{
HXLINE(  70)							Int _hx_tmp64 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  70)							switch((int)(_hx_tmp64)){
            								case (int)0: {
...
HXLINE(  70)						data->prev = ::openfl::_internal::renderer::DrawCommandType_obj::LINE_TO_dyn();
HXDLIN(  70)						HX_VARI_NAME(  ::openfl::_internal::renderer::DrawCommandReader,c13,"c") = data;
HXDLIN(  70)						Float _hx_tmp65 = c13->buffer->f->__get(c13->fPos);
HXDLIN(  70)						Float _hx_tmp66 = c13->buffer->f->__get((c13->fPos + (int)1));
HXDLIN(  70)						this->lineTo(_hx_tmp65,_hx_tmp66);
            					}
            					break;
            					case (int)16: {
HXLINE(  71)						{
HXLINE(  71)							Int _hx_tmp67 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  71)							switch((int)(_hx_tmp67)){
            								case (int)0: {
...
HXLINE(  71)						data->prev = ::openfl::_internal::renderer::DrawCommandType_obj::MOVE_TO_dyn();
HXDLIN(  71)						HX_VARI_NAME(  ::openfl::_internal::renderer::DrawCommandReader,c14,"c") = data;
HXDLIN(  71)						Float _hx_tmp68 = c14->buffer->f->__get(c14->fPos);
HXDLIN(  71)						Float _hx_tmp69 = c14->buffer->f->__get((c14->fPos + (int)1));
HXDLIN(  71)						this->moveTo(_hx_tmp68,_hx_tmp69);
            					}
            					break;
            					case (int)17: {
HXLINE(  72)						{
HXLINE(  72)							Int _hx_tmp70 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  72)							switch((int)(_hx_tmp70)){
            								case (int)0: {
...
HXLINE(  72)						data->prev = ::openfl::_internal::renderer::DrawCommandType_obj::OVERRIDE_MATRIX_dyn();
HXDLIN(  72)						HX_VARI_NAME(  ::openfl::_internal::renderer::DrawCommandReader,c15,"c") = data;
HXDLIN(  72)						this->overrideMatrix(( ( ::openfl::geom::Matrix)(c15->buffer->o->__get(c15->oPos)) ));
            					}
            					break;
            					default:{
            					}
...
HXLINE(  87)		this->types->push(::openfl::_internal::renderer::DrawCommandType_obj::BEGIN_BITMAP_FILL_dyn());
HXLINE(  88)		this->o->push(bitmap);
HXLINE(  89)		this->o->push(matrix);
HXLINE(  90)		this->b->push(repeat);
HXLINE(  91)		this->b->push(smooth);
            	}
...
HXLINE(  97)		this->types->push(::openfl::_internal::renderer::DrawCommandType_obj::BEGIN_FILL_dyn());
HXLINE(  98)		this->i->push(color);
HXLINE(  99)		this->f->push(alpha);
            	}
...
HXLINE( 106)		this->types->push(::openfl::_internal::renderer::DrawCommandType_obj::BEGIN_GRADIENT_FILL_dyn());
HXLINE( 107)		this->o->push(type);
HXLINE( 108)		this->ii->push(colors);
HXLINE( 109)		this->ff->push(alphas);
HXLINE( 110)		this->ii->push(ratios);
HXLINE( 111)		this->o->push(matrix);
HXLINE( 112)		this->o->push(spreadMethod);
HXLINE( 113)		this->o->push(interpolationMethod);
HXLINE( 114)		this->f->push(focalPointRatio);
            	}
...
void DrawCommandBuffer_obj::clear(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 121)		this->types->removeRange((int)0,this->types->length);
HXLINE( 123)		this->b->removeRange((int)0,this->b->length);
HXLINE( 124)		this->i->removeRange((int)0,this->i->length);
HXLINE( 125)		this->f->removeRange((int)0,this->f->length);
HXLINE( 126)		this->o->splice((int)0,this->o->get_length());
HXLINE( 127)		this->ff->removeRange((int)0,this->ff->length);
HXLINE( 128)		this->ii->removeRange((int)0,this->ii->length);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(DrawCommandBuffer_obj,clear,(void))
 ...
 ::openfl::_internal::renderer::DrawCommandBuffer DrawCommandBuffer_obj::copy(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 135)		HX_VARI(  ::openfl::_internal::renderer::DrawCommandBuffer,copy) =  ::openfl::_internal::renderer::DrawCommandBuffer_obj::__new();
HXLINE( 136)		copy->append(hx::ObjectPtr<OBJ_>(this));
HXLINE( 137)		return copy;
            	}
...
HXLINE( 144)		this->types->push(::openfl::_internal::renderer::DrawCommandType_obj::CUBIC_CURVE_TO_dyn());
HXLINE( 145)		this->f->push(controlX1);
HXLINE( 146)		this->f->push(controlY1);
HXLINE( 147)		this->f->push(controlX2);
HXLINE( 148)		this->f->push(controlY2);
HXLINE( 149)		this->f->push(anchorX);
HXLINE( 150)		this->f->push(anchorY);
            	}
...
void DrawCommandBuffer_obj::curveTo(Float controlX,Float controlY,Float anchorX,Float anchorY){
            	...
            	HX_STACK_ARG(anchorX,"anchorX")
            	HX_STACK_ARG(anchorY,"anchorY")
HXLINE( 156)		this->types->push(::openfl::_internal::renderer::DrawCommandType_obj::CURVE_TO_dyn());
HXLINE( 157)		this->f->push(controlX);
HXLINE( 158)		this->f->push(controlY);
HXLINE( 159)		this->f->push(anchorX);
HXLINE( 160)		this->f->push(anchorY);
            	}
...
void DrawCommandBuffer_obj::destroy(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 167)		this->clear();
HXLINE( 169)		this->types = null();
HXLINE( 171)		this->b = null();
HXLINE( 172)		this->i = null();
HXLINE( 173)		this->f = null();
HXLINE( 174)		this->o = null();
HXLINE( 175)		this->ff = null();
HXLINE( 176)		this->ii = null();
            	}
...
HXLINE( 183)		this->types->push(::openfl::_internal::renderer::DrawCommandType_obj::DRAW_CIRCLE_dyn());
HXLINE( 184)		this->f->push(x);
HXLINE( 185)		this->f->push(y);
HXLINE( 186)		this->f->push(radius);
            	}
...
HXLINE( 193)		this->types->push(::openfl::_internal::renderer::DrawCommandType_obj::DRAW_ELLIPSE_dyn());
HXLINE( 194)		this->f->push(x);
HXLINE( 195)		this->f->push(y);
HXLINE( 196)		this->f->push(width);
HXLINE( 197)		this->f->push(height);
            	}
...
void DrawCommandBuffer_obj::drawRect(Float x,Float y,Float width,Float height){
            	...
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE( 204)		this->types->push(::openfl::_internal::renderer::DrawCommandType_obj::DRAW_RECT_dyn());
HXLINE( 205)		this->f->push(x);
HXLINE( 206)		this->f->push(y);
HXLINE( 207)		this->f->push(width);
HXLINE( 208)		this->f->push(height);
            	}
...
HXLINE( 214)		this->types->push(::openfl::_internal::renderer::DrawCommandType_obj::DRAW_ROUND_RECT_dyn());
HXLINE( 215)		this->f->push(x);
HXLINE( 216)		this->f->push(y);
HXLINE( 217)		this->f->push(width);
HXLINE( 218)		this->f->push(height);
HXLINE( 219)		this->f->push(ellipseWidth);
HXLINE( 220)		this->o->push(ellipseHeight);
            	}
...
HXLINE( 227)		this->types->push(::openfl::_internal::renderer::DrawCommandType_obj::DRAW_TRIANGLES_dyn());
HXLINE( 228)		this->o->push(vertices);
HXLINE( 229)		this->o->push(indices);
HXLINE( 230)		this->o->push(uvtData);
HXLINE( 231)		this->o->push(culling);
            	}
...
void DrawCommandBuffer_obj::endFill(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 238)		this->types->push(::openfl::_internal::renderer::DrawCommandType_obj::END_FILL_dyn());
            	}
...
void DrawCommandBuffer_obj::lineBitmapStyle( ::openfl::display::BitmapData bitmap, ::openfl::geom::Matrix matrix,Bool repeat,Bool smooth){
            	...
            	HX_STACK_ARG(repeat,"repeat")
            	HX_STACK_ARG(smooth,"smooth")
HXLINE( 245)		this->types->push(::openfl::_internal::renderer::DrawCommandType_obj::LINE_BITMAP_STYLE_dyn());
HXLINE( 246)		this->o->push(bitmap);
HXLINE( 247)		this->o->push(matrix);
HXLINE( 248)		this->b->push(repeat);
HXLINE( 249)		this->b->push(smooth);
            	}
...
void DrawCommandBuffer_obj::lineGradientStyle( ::Dynamic type,::Array< Int > colors,::Array< Float > alphas,::Array< Int > ratios, ::openfl::geom::Matrix matrix, ::Dynamic spreadMethod, ::Dynamic interpolationMethod,Float focalPointRatio){
            	...
            	HX_STACK_ARG(interpolationMethod,"interpolationMethod")
            	HX_STACK_ARG(focalPointRatio,"focalPointRatio")
HXLINE( 256)		this->types->push(::openfl::_internal::renderer::DrawCommandType_obj::LINE_GRADIENT_STYLE_dyn());
HXLINE( 257)		this->o->push(type);
HXLINE( 258)		this->ii->push(colors);
HXLINE( 259)		this->ff->push(alphas);
HXLINE( 260)		this->ii->push(ratios);
HXLINE( 261)		this->o->push(matrix);
HXLINE( 262)		this->o->push(spreadMethod);
HXLINE( 263)		this->o->push(interpolationMethod);
HXLINE( 264)		this->f->push(focalPointRatio);
            	}
...
HXLINE( 271)		this->types->push(::openfl::_internal::renderer::DrawCommandType_obj::LINE_STYLE_dyn());
HXLINE( 272)		this->o->push(thickness);
HXLINE( 273)		this->i->push(color);
HXLINE( 274)		this->f->push(alpha);
HXLINE( 275)		this->b->push(pixelHinting);
HXLINE( 276)		this->o->push(scaleMode);
HXLINE( 277)		this->o->push(caps);
HXLINE( 278)		this->o->push(joints);
HXLINE( 279)		this->f->push(miterLimit);
            	}
...
void DrawCommandBuffer_obj::lineTo(Float x,Float y){
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 286)		this->types->push(::openfl::_internal::renderer::DrawCommandType_obj::LINE_TO_dyn());
HXLINE( 287)		this->f->push(x);
HXLINE( 288)		this->f->push(y);
            	}
...
void DrawCommandBuffer_obj::moveTo(Float x,Float y){
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 295)		this->types->push(::openfl::_internal::renderer::DrawCommandType_obj::MOVE_TO_dyn());
...
void DrawCommandBuffer_obj::overrideMatrix( ::openfl::geom::Matrix matrix){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(matrix,"matrix")
HXLINE( 304)		this->types->push(::openfl::_internal::renderer::DrawCommandType_obj::OVERRIDE_MATRIX_dyn());
HXLINE( 305)		this->o->push(matrix);
            	}
...
Int DrawCommandBuffer_obj::get_length(){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","get_length",0x3877f3b1,"openfl._internal.renderer.DrawCommandBuffer.get_length","openfl/_internal/renderer/DrawCommandBuffer.hx",319,0xbc8e6e11)
            	HX_STACK_THIS(this)
HXLINE( 319)		return this->types->length;
            	}
