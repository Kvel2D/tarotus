...
HXLINE(  30)			HX_VARI(  ::openfl::geom::Matrix,transform) = bitmap->_hx___worldTransform;
...
HXLINE(  54)				Bool _hx_tmp7 = (bitmap->_hx___worldAlpha == (int)1);
