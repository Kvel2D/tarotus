...
HXLINE(  39)		this->cairo->identityMatrix();
HXLINE(  41)		Bool _hx_tmp = stage->_hx___clearBeforeRender;
HXDLIN(  41)		if (_hx_tmp) {
HXLINE(  43)			Float _hx_tmp1 = stage->_hx___colorSplit->__get((int)0);
HXDLIN(  43)			Float _hx_tmp2 = stage->_hx___colorSplit->__get((int)1);
HXDLIN(  43)			Float _hx_tmp3 = stage->_hx___colorSplit->__get((int)2);
HXDLIN(  43)			this->cairo->setSourceRGB(_hx_tmp1,_hx_tmp2,_hx_tmp3);
HXLINE(  44)			this->cairo->paint();
            		}
HXLINE(  48)		stage->_hx___renderCairo(this->renderSession);
            	}
...
HXLINE(  56)		object->_hx___renderCairo(this->renderSession);
            	}
