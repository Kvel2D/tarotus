...
void TextureBase_obj::_hx___setSamplerState( ::openfl::_internal::stage3D::SamplerState state){
            	HX_STACK_FRAME("openfl.display3D.textures.TextureBase","__setSamplerState",0x8e361f8c,"openfl.display3D.textures.TextureBase.__setSamplerState","openfl/display3D/textures/TextureBase.hx",118,0x7b0f92ae)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(state,"state")
HXLINE( 118)		Bool _hx_tmp = !(state->equals(this->_hx___samplerState));
HXDLIN( 118)		if (_hx_tmp) {
HXLINE( 120)			{
HXLINE( 120)				Int target = this->_hx___textureTarget;
HXDLIN( 120)				HX_VARI(  ::lime::graphics::opengl::GLTexture,texture) = this->_hx___textureID;
HXDLIN( 120)				{
HXLINE( 120)					 ::Dynamic texture1;
HXDLIN( 120)					Bool _hx_tmp1 = hx::IsNull( texture );
HXDLIN( 120)					if (_hx_tmp1) {
HXLINE( 120)						texture1 = null();
            					}
            					else {
HXLINE( 120)						texture1 = texture->id;
            					}
HXDLIN( 120)					::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_texture(target,hx::DynamicPtr(texture1));
            				}
            			}
HXLINE( 121)			::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE( 122)			{
HXLINE( 122)				Int target1 = this->_hx___textureTarget;
HXDLIN( 122)				Int param = state->minFilter;
HXDLIN( 122)				::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_parameteri(target1,(int)10241,param);
            			}
HXLINE( 123)			::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE( 124)			{
HXLINE( 124)				Int target2 = this->_hx___textureTarget;
HXDLIN( 124)				Int param1 = state->magFilter;
HXDLIN( 124)				::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_parameteri(target2,(int)10240,param1);
            			}
HXLINE( 125)			::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE( 126)			{
HXLINE( 126)				Int target3 = this->_hx___textureTarget;
HXDLIN( 126)				Int param2 = state->wrapModeS;
HXDLIN( 126)				::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_parameteri(target3,(int)10242,param2);
            			}
HXLINE( 127)			::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE( 128)			{
HXLINE( 128)				Int target4 = this->_hx___textureTarget;
HXDLIN( 128)				Int param3 = state->wrapModeT;
HXDLIN( 128)				::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_parameteri(target4,(int)10243,param3);
            			}
HXLINE( 129)			::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE( 138)			this->_hx___samplerState = state;
            		}
            	}
...
HXLINE( 147)		Bool _hx_tmp = (this->_hx___compressedMemoryUsage == (int)0);
HXDLIN( 147)		if (_hx_tmp) {
HXLINE( 149)			this->_hx___context->_hx___statsIncrement((int)4);
            		}
HXLINE( 153)		hx::AddEq(this->_hx___compressedMemoryUsage,memory);
HXLINE( 154)		this->_hx___context->_hx___statsAdd((int)9,memory);
HXLINE( 164)		this->_hx___trackMemoryUsage(memory);
            	}
...
void TextureBase_obj::_hx___trackMemoryUsage(Int memory){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(memory,"memory")
HXLINE( 171)		Bool _hx_tmp = (this->_hx___memoryUsage == (int)0);
HXDLIN( 171)		if (_hx_tmp) {
HXLINE( 173)			this->_hx___context->_hx___statsIncrement((int)3);
            		}
HXLINE( 177)		hx::AddEq(this->_hx___memoryUsage,memory);
HXLINE( 178)		this->_hx___context->_hx___statsAdd((int)8,memory);
            	}
