...
HXDLIN(  45)		Bool _hx_tmp3 = !(image->get_premultiplied());
HXDLIN(  45)		if (_hx_tmp3) {
HXLINE(  45)			_hx_tmp2 = image->get_transparent();
            		}
            		else {
HXLINE(  45)			_hx_tmp2 = false;
            		}
HXDLIN(  45)		if (_hx_tmp2) {
HXLINE(  47)			image = image->clone();
HXLINE(  48)			image->set_premultiplied(true);
            		}
HXLINE(  52)		 ::lime::utils::ArrayBufferView _hx_tmp4 = image->get_data();
HXDLIN(  52)		this->uploadFromTypedArray(_hx_tmp4);
            	}
...
void RectangleTexture_obj::uploadFromByteArray( ::openfl::utils::ByteArrayData data,Int byteArrayOffset){
            	HX_STACK_FRAME("openfl.display3D.textures.RectangleTexture","uploadFromByteArray",0xfd7a0ae1,"openfl.display3D.textures.RectangleTexture.uploadFromByteArray","openfl/display3D/textures/RectangleTexture.hx",68,0x83565556)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(data,"data")
            	HX_STACK_ARG(byteArrayOffset,"byteArrayOffset")
HXLINE(  68)		HX_VARI(  ::haxe::io::Bytes,buffer) = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(data);
HXDLIN(  68)		HX_VAR_NAME(  ::lime::utils::ArrayBufferView,this1,"this");
HXDLIN(  68)		Bool _hx_tmp = hx::IsNotNull( buffer );
HXDLIN(  68)		if (_hx_tmp) {
HXLINE(  68)			HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__new((int)0,(int)4);
HXDLIN(  68)			if ((byteArrayOffset < (int)0)) {
HXLINE(  68)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN(  68)			if ((hx::Mod(byteArrayOffset,_this->bytesPerElement) != (int)0)) {
HXLINE(  68)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN(  68)			HX_VARI( Int,bufferByteLength) = buffer->length;
HXDLIN(  68)			HX_VARI( Int,newByteLength) = bufferByteLength;
HXDLIN(  68)			{
HXLINE(  68)				newByteLength = (bufferByteLength - byteArrayOffset);
HXDLIN(  68)				if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE(  68)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN(  68)				if ((newByteLength < (int)0)) {
HXLINE(  68)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
HXDLIN(  68)			_this->buffer = buffer;
HXDLIN(  68)			_this->byteOffset = byteArrayOffset;
HXDLIN(  68)			_this->byteLength = newByteLength;
HXDLIN(  68)			Float _hx_tmp1 = ((Float)newByteLength / (Float)_this->bytesPerElement);
HXDLIN(  68)			_this->length = ::Std_obj::_hx_int(_hx_tmp1);
HXDLIN(  68)			this1 = _this;
            		}
            		else {
HXLINE(  68)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            		}
HXDLIN(  68)		this->uploadFromTypedArray(this1);
            	}
...
void RectangleTexture_obj::uploadFromTypedArray( ::lime::utils::ArrayBufferView data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(  81)		{
HXLINE(  81)			Int target = this->_hx___textureTarget;
HXDLIN(  81)			HX_VARI(  ::lime::graphics::opengl::GLTexture,texture) = this->_hx___textureID;
HXDLIN(  81)			{
HXLINE(  81)				 ::Dynamic texture1;
HXDLIN(  81)				Bool _hx_tmp = hx::IsNull( texture );
HXDLIN(  81)				if (_hx_tmp) {
HXLINE(  81)					texture1 = null();
            				}
            				else {
HXLINE(  81)					texture1 = texture->id;
            				}
HXDLIN(  81)				::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_texture(target,hx::DynamicPtr(texture1));
            			}
            		}
HXLINE(  82)		::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE(  84)		{
HXLINE(  84)			Int target1 = this->_hx___textureTarget;
HXDLIN(  84)			Int internalformat = this->_hx___internalFormat;
HXDLIN(  84)			Int width = this->_hx___width;
HXDLIN(  84)			Int height = this->_hx___height;
HXDLIN(  84)			Int format = this->_hx___format;
HXDLIN(  84)			HX_VAR(  ::haxe::io::Bytes,buffer);
HXDLIN(  84)			Bool _hx_tmp1 = hx::IsNull( data );
HXDLIN(  84)			if (_hx_tmp1) {
HXLINE(  84)				buffer = null();
            			}
            			else {
HXLINE(  84)				buffer = data->buffer;
            			}
HXDLIN(  84)			{
HXLINE(  84)				Int byteOffset;
HXDLIN(  84)				Bool _hx_tmp2 = hx::IsNull( data );
HXDLIN(  84)				if (_hx_tmp2) {
HXLINE(  84)					byteOffset = (int)0;
            				}
            				else {
HXLINE(  84)					byteOffset = data->byteOffset;
            				}
HXDLIN(  84)				::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_image_2d(target1,(int)0,internalformat,width,height,(int)0,format,(int)5121,hx::DynamicPtr(buffer),byteOffset);
            			}
            		}
HXLINE(  85)		::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE(  87)		{
HXLINE(  87)			Int target2 = this->_hx___textureTarget;
HXDLIN(  87)			{
HXLINE(  87)				 ::Dynamic texture2 = null();
HXDLIN(  87)				::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_texture(target2,hx::DynamicPtr(texture2));
            			}
            		}
HXLINE(  88)		::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE(  90)		HX_VARI( Int,memUsage) = ((this->_hx___width * this->_hx___height) * (int)4);
HXLINE(  91)		this->_hx___trackMemoryUsage(memUsage);
            	}
