 ...
 ::lime::app::Future AssetLibrary_obj::loadMovieClip(::String id){
            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_0,::String,id, ::openfl::AssetLibrary,_gthis) HXARGC(0)
            		 ::openfl::display::MovieClip _hx_run(){
            			HX_STACK_FRAME("openfl.AssetLibrary","loadMovieClip",0x8eb64315,"openfl.AssetLibrary.loadMovieClip","openfl/Assets.hx",916,0x989d477c)
HXLINE( 916)			return _gthis->getMovieClip(id);
            		}
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE( 914)		HX_VARI(  ::openfl::AssetLibrary,_gthis) = hx::ObjectPtr<OBJ_>(this);
HXLINE( 916)		return  ::lime::app::Future_obj::__new( ::Dynamic(new _hx_Closure_0(id,_gthis)));
            	}
