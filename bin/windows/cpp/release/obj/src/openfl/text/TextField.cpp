...
static const ::String _hx_array_data_23[] = {
	HX_("quot",09,45,0a,4b),HX_("\"",22,00,00,00),
};
static const ::String _hx_array_data_24[] = {
	HX_("apos",d3,0f,73,40),HX_("'",27,00,00,00),
};
static const ::String _hx_array_data_25[] = {
	HX_("amp",04,fa,49,00),HX_("&",26,00,00,00),
};
static const ::String _hx_array_data_26[] = {
	HX_("lt",88,5e,00,00),HX_("<",3c,00,00,00),
};
static const ::String _hx_array_data_27[] = {
	HX_("gt",2d,5a,00,00),HX_(">",3e,00,00,00),
};
namespace openfl{
namespace text{
...
HXLINE(  96)		this->_hx___graphics =  ::openfl::display::Graphics_obj::__new(hx::ObjectPtr<OBJ_>(this));
...
HXLINE( 210)		HX_VARI( Int,index) = this->_hx___textEngine->getLineBreakIndex(null());
...
HXLINE( 225)			index = this->_hx___textEngine->getLineBreakIndex((index + (int)1));
            		}
            		_hx_goto_5:;
...
HXLINE( 394)		Int _hx_tmp1 = this->_hx___textEngine->getLineBreakIndex(charIndex);
...
HXLINE( 684)		::openfl::_internal::renderer::cairo::CairoTextField_obj::render(hx::ObjectPtr<OBJ_>(this),renderSession,this->_hx___worldTransform);
...
void TextField_obj::_hx___renderGL( ::openfl::_internal::renderer::RenderSession renderSession){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(renderSession,"renderSession")
HXLINE( 739)		::openfl::_internal::renderer::cairo::CairoTextField_obj::render(hx::ObjectPtr<OBJ_>(this),renderSession,this->_hx___worldTransform);
HXLINE( 742)		this->super::_hx___renderGL(renderSession);
            	}
...
void TextField_obj::_hx___startCursorTimer(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 749)		this->_hx___cursorTimer = ::haxe::Timer_obj::delay(this->_hx___startCursorTimer_dyn(),(int)600);
HXLINE( 750)		this->_hx___showCursor = !(this->_hx___showCursor);
HXLINE( 751)		this->_hx___dirty = true;
            	}
...
void TextField_obj::_hx___startTextInput(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 758)		Bool _hx_tmp = (this->_hx___caretIndex < (int)0);
HXDLIN( 758)		if (_hx_tmp) {
HXLINE( 760)			this->_hx___caretIndex = this->_hx___textEngine->text.length;
HXLINE( 761)			this->_hx___selectionIndex = this->_hx___caretIndex;
            		}
HXLINE( 765)		Bool _hx_tmp1 = hx::IsNotNull( this->stage );
HXDLIN( 765)		if (_hx_tmp1) {
HXLINE( 769)			this->stage->window->backend->setEnableTextEvents(true);
HXLINE( 771)			Bool _hx_tmp2 = !(this->_hx___inputEnabled);
HXDLIN( 771)			if (_hx_tmp2) {
HXLINE( 773)				this->stage->window->backend->setEnableTextEvents(true);
HXLINE( 775)				Bool _hx_tmp3 = !(this->stage->window->onTextInput->has(this->window_onTextInput_dyn()));
HXDLIN( 775)				if (_hx_tmp3) {
HXLINE( 777)					this->stage->window->onTextInput->add(this->window_onTextInput_dyn(),null(),null());
HXLINE( 778)					this->stage->window->onKeyDown->add(this->window_onKeyDown_dyn(),null(),null());
            				}
HXLINE( 782)				this->_hx___inputEnabled = true;
HXLINE( 783)				this->_hx___startCursorTimer();
            			}
            		}
            	}
...
void TextField_obj::_hx___stopCursorTimer(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 796)		Bool _hx_tmp = hx::IsNotNull( this->_hx___cursorTimer );
HXDLIN( 796)		if (_hx_tmp) {
HXLINE( 798)			this->_hx___cursorTimer->stop();
HXLINE( 799)			this->_hx___cursorTimer = null();
            		}
HXLINE( 803)		Bool _hx_tmp1 = this->_hx___showCursor;
HXDLIN( 803)		if (_hx_tmp1) {
HXLINE( 805)			this->_hx___showCursor = false;
HXLINE( 806)			this->_hx___dirty = true;
            		}
            	}
...
void TextField_obj::_hx___stopTextInput(){
            	HX_STACK_FRAME("openfl.text.TextField","__stopTextInput",0x6c7c2cf7,"openfl.text.TextField.__stopTextInput","openfl/text/TextField.hx",817,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE( 817)		Bool _hx_tmp;
HXDLIN( 817)		if (this->_hx___inputEnabled) {
HXLINE( 817)			_hx_tmp = hx::IsNotNull( this->stage );
            		}
            		else {
HXLINE( 817)			_hx_tmp = false;
            		}
HXDLIN( 817)		if (_hx_tmp) {
HXLINE( 819)			this->stage->window->backend->setEnableTextEvents(false);
HXLINE( 820)			this->stage->window->onTextInput->remove(this->window_onTextInput_dyn());
HXLINE( 821)			this->stage->window->onKeyDown->remove(this->window_onKeyDown_dyn());
HXLINE( 823)			this->_hx___inputEnabled = false;
HXLINE( 824)			this->_hx___stopCursorTimer();
            		}
            	}
...
void TextField_obj::_hx___updateLayout(){
            	HX_STACK_FRAME("openfl.text.TextField","__updateLayout",0x2d3b57d7,"openfl.text.TextField.__updateLayout","openfl/text/TextField.hx",835,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE( 835)		Bool _hx_tmp = this->_hx___layoutDirty;
HXDLIN( 835)		if (_hx_tmp) {
HXLINE( 837)			this->_hx___textEngine->update();
HXLINE( 839)			Bool _hx_tmp1 = hx::IsNotEq( this->_hx___textEngine->autoSize,(int)2 );
HXDLIN( 839)			if (_hx_tmp1) {
HXLINE( 841)				HX_VARI( Float,cacheWidth) = this->_hx___textEngine->width;
HXLINE( 844)				{
HXLINE( 844)					HX_VARI(  ::Dynamic,_g) = this->_hx___textEngine->autoSize;
HXDLIN( 844)					 ::Dynamic _hx_switch_0 = _g;
            					if (  (_hx_switch_0==(int)0) ||  (_hx_switch_0==(int)1) ||  (_hx_switch_0==(int)3) ){
HXLINE( 848)						Bool _hx_tmp2 = !(this->_hx___textEngine->wordWrap);
HXDLIN( 848)						if (_hx_tmp2) {
HXLINE( 850)							this->_hx___textEngine->width = (this->_hx___textEngine->textWidth + (int)4);
            						}
HXLINE( 854)						this->_hx___textEngine->height = (this->_hx___textEngine->textHeight + (int)4);
...
HXLINE( 861)				Bool _hx_tmp3 = (this->_hx___textEngine->width != cacheWidth);
HXDLIN( 861)				if (_hx_tmp3) {
HXLINE( 863)					HX_VARI(  ::Dynamic,_g1) = this->_hx___textEngine->autoSize;
HXDLIN( 863)					 ::Dynamic _hx_switch_1 = _g1;
            					if (  (_hx_switch_1==(int)0) ){
HXLINE( 871)						HX_VARI_NAME(  ::openfl::text::TextField,_g11,"_g1") = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 871)						Float _hx_tmp4 = _g11->get_x();
HXDLIN( 871)						Float _hx_tmp5 = ((Float)(cacheWidth - this->_hx___textEngine->width) / (Float)(int)2);
HXDLIN( 871)						_g11->set_x((_hx_tmp4 + _hx_tmp5));
HXDLIN( 871)						goto _hx_goto_19;
            					}
            					if (  (_hx_switch_1==(int)3) ){
HXLINE( 867)						HX_VARI_NAME(  ::openfl::text::TextField,_g12,"_g1") = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 867)						Float _hx_tmp6 = _g12->get_x();
HXDLIN( 867)						Float _hx_tmp7 = (_hx_tmp6 + (cacheWidth - this->_hx___textEngine->width));
HXDLIN( 867)						_g12->set_x(_hx_tmp7);
HXDLIN( 867)						goto _hx_goto_19;
            					}
            					/* default */{
            					}
            					_hx_goto_19:;
            				}
HXLINE( 881)				this->_hx___textEngine->getBounds();
            			}
HXLINE( 885)			this->_hx___layoutDirty = false;
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(TextField_obj,_hx___updateLayout,(void))
 ...
 ::Dynamic TextField_obj::get_antiAliasType(){
            	HX_STACK_FRAME("openfl.text.TextField","get_antiAliasType",0x57115f1b,"openfl.text.TextField.get_antiAliasType","openfl/text/TextField.hx",901,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE( 901)		return this->_hx___textEngine->antiAliasType;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(TextField_obj,get_antiAliasType,return )
 ...
 ::Dynamic TextField_obj::set_antiAliasType( ::Dynamic value){
            	HX_STACK_FRAME("openfl.text.TextField","set_antiAliasType",0x7a7f3727,"openfl.text.TextField.set_antiAliasType","openfl/text/TextField.hx",914,0xccf02094)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 914)		return (this->_hx___textEngine->antiAliasType = value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(TextField_obj,set_antiAliasType,return )
 ...
 ::Dynamic TextField_obj::get_autoSize(){
            	HX_STACK_FRAME("openfl.text.TextField","get_autoSize",0xd7aef1fd,"openfl.text.TextField.get_autoSize","openfl/text/TextField.hx",921,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE( 921)		return this->_hx___textEngine->autoSize;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(TextField_obj,get_autoSize,return )
 ...
 ::Dynamic TextField_obj::set_autoSize( ::Dynamic value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 928)		Bool _hx_tmp = hx::IsNotEq( value,this->_hx___textEngine->autoSize );
HXDLIN( 928)		if (_hx_tmp) {
HXLINE( 930)			this->_hx___dirty = true;
HXLINE( 931)			this->_hx___layoutDirty = true;
            		}
HXLINE( 935)		return (this->_hx___textEngine->autoSize = value);
            	}
...
Bool TextField_obj::get_background(){
            	HX_STACK_FRAME("openfl.text.TextField","get_background",0x50119b5b,"openfl.text.TextField.get_background","openfl/text/TextField.hx",942,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE( 942)		return this->_hx___textEngine->background;
            	}
...
Bool TextField_obj::set_background(Bool value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 949)		Bool _hx_tmp = (value != this->_hx___textEngine->background);
HXDLIN( 949)		if (_hx_tmp) {
HXLINE( 951)			this->_hx___dirty = true;
            		}
HXLINE( 955)		return (this->_hx___textEngine->background = value);
            	}
...
Int TextField_obj::get_backgroundColor(){
            	HX_STACK_FRAME("openfl.text.TextField","get_backgroundColor",0x63403c08,"openfl.text.TextField.get_backgroundColor","openfl/text/TextField.hx",962,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE( 962)		return this->_hx___textEngine->backgroundColor;
            	}
...
Int TextField_obj::set_backgroundColor(Int value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 969)		Bool _hx_tmp = (value != this->_hx___textEngine->backgroundColor);
HXDLIN( 969)		if (_hx_tmp) {
HXLINE( 971)			this->_hx___dirty = true;
            		}
HXLINE( 975)		return (this->_hx___textEngine->backgroundColor = value);
            	}
...
Bool TextField_obj::get_border(){
            	HX_STACK_FRAME("openfl.text.TextField","get_border",0xa3e0d9d9,"openfl.text.TextField.get_border","openfl/text/TextField.hx",982,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE( 982)		return this->_hx___textEngine->border;
            	}
...
Bool TextField_obj::set_border(Bool value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 989)		Bool _hx_tmp = (value != this->_hx___textEngine->border);
HXDLIN( 989)		if (_hx_tmp) {
HXLINE( 991)			this->_hx___dirty = true;
            		}
HXLINE( 995)		return (this->_hx___textEngine->border = value);
            	}
...
Int TextField_obj::get_borderColor(){
            	HX_STACK_FRAME("openfl.text.TextField","get_borderColor",0x6267b4ca,"openfl.text.TextField.get_borderColor","openfl/text/TextField.hx",1002,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE(1002)		return this->_hx___textEngine->borderColor;
            	}
...
Int TextField_obj::set_borderColor(Int value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(1009)		Bool _hx_tmp = (value != this->_hx___textEngine->borderColor);
HXDLIN(1009)		if (_hx_tmp) {
HXLINE(1011)			this->_hx___dirty = true;
            		}
HXLINE(1015)		return (this->_hx___textEngine->borderColor = value);
            	}
...
Int TextField_obj::get_bottomScrollV(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1022)		this->_hx___updateLayout();
HXLINE(1024)		return this->_hx___textEngine->bottomScrollV;
            	}
...
Int TextField_obj::get_caretIndex(){
            	HX_STACK_FRAME("openfl.text.TextField","get_caretIndex",0x074fbdfc,"openfl.text.TextField.get_caretIndex","openfl/text/TextField.hx",1031,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE(1031)		return this->_hx___caretIndex;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(TextField_obj,get_caretIndex,return )
 ...
 ::openfl::text::TextFormat TextField_obj::get_defaultTextFormat(){
            	HX_STACK_FRAME("openfl.text.TextField","get_defaultTextFormat",0x83063818,"openfl.text.TextField.get_defaultTextFormat","openfl/text/TextField.hx",1038,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE(1038)		return this->_hx___textFormat->clone();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(TextField_obj,get_defaultTextFormat,return )
 ...
 ::openfl::text::TextFormat TextField_obj::set_defaultTextFormat( ::openfl::text::TextFormat value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(1045)		this->_hx___textFormat->_hx___merge(value);
HXLINE(1047)		this->_hx___layoutDirty = true;
HXLINE(1048)		this->_hx___dirty = true;
...
Bool TextField_obj::get_displayAsPassword(){
            	HX_STACK_FRAME("openfl.text.TextField","get_displayAsPassword",0x62bc3b42,"openfl.text.TextField.get_displayAsPassword","openfl/text/TextField.hx",1057,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE(1057)		return this->_hx___textEngine->displayAsPassword;
            	}
...
Bool TextField_obj::set_displayAsPassword(Bool value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(1064)		Bool _hx_tmp = (value != this->_hx___textEngine->displayAsPassword);
HXDLIN(1064)		if (_hx_tmp) {
HXLINE(1066)			this->_hx___dirty = true;
HXLINE(1067)			this->_hx___layoutDirty = true;
            		}
HXLINE(1071)		return (this->_hx___textEngine->displayAsPassword = value);
            	}
...
Bool TextField_obj::get_embedFonts(){
            	HX_STACK_FRAME("openfl.text.TextField","get_embedFonts",0xb8d5ce98,"openfl.text.TextField.get_embedFonts","openfl/text/TextField.hx",1078,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE(1078)		return this->_hx___textEngine->embedFonts;
            	}
...
Bool TextField_obj::set_embedFonts(Bool value){
            	HX_STACK_FRAME("openfl.text.TextField","set_embedFonts",0xd8f5b70c,"openfl.text.TextField.set_embedFonts","openfl/text/TextField.hx",1092,0xccf02094)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(1092)		return (this->_hx___textEngine->embedFonts = value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(TextField_obj,set_embedFonts,return )
 ...
 ::Dynamic TextField_obj::get_gridFitType(){
            	HX_STACK_FRAME("openfl.text.TextField","get_gridFitType",0x3fa66af8,"openfl.text.TextField.get_gridFitType","openfl/text/TextField.hx",1099,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE(1099)		return this->_hx___textEngine->gridFitType;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(TextField_obj,get_gridFitType,return )
 ...
 ::Dynamic TextField_obj::set_gridFitType( ::Dynamic value){
            	HX_STACK_FRAME("openfl.text.TextField","set_gridFitType",0x3b71e804,"openfl.text.TextField.set_gridFitType","openfl/text/TextField.hx",1113,0xccf02094)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(1113)		return (this->_hx___textEngine->gridFitType = value);
            	}
...
Float TextField_obj::get_height(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1120)		this->_hx___updateLayout();
HXLINE(1121)		return this->_hx___textEngine->height;
            	}
...
HXDLIN(1128)		Float _hx_tmp1 = this->get_scaleY();
HXDLIN(1128)		if ((_hx_tmp1 == (int)1)) {
HXLINE(1128)			_hx_tmp = (value != this->_hx___textEngine->height);
            		}
            		else {
HXLINE(1128)			_hx_tmp = true;
            		}
HXDLIN(1128)		if (_hx_tmp) {
HXLINE(1130)			Bool _hx_tmp2 = !(this->_hx___transformDirty);
HXDLIN(1130)			if (_hx_tmp2) {
HXLINE(1130)				this->_hx___transformDirty = true;
HXDLIN(1130)				::openfl::display::DisplayObject_obj::_hx___worldTransformDirty++;
            			}
HXLINE(1131)			this->_hx___dirty = true;
HXLINE(1132)			this->_hx___layoutDirty = true;
            		}
HXLINE(1136)		this->set_scaleY((int)1);
HXLINE(1137)		return (this->_hx___textEngine->height = value);
            	}


::String TextField_obj::get_htmlText(){
            	HX_STACK_FRAME("openfl.text.TextField","get_htmlText",0xb86d81e5,"openfl.text.TextField.get_htmlText","openfl/text/TextField.hx",1144,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE(1144)		return this->_hx___textEngine->text;
            	}
...
HXDLIN(1151)		if (!(!(this->_hx___isHTML))) {
HXLINE(1151)			_hx_tmp = (this->_hx___textEngine->text != value);
            		}
            		else {
HXLINE(1151)			_hx_tmp = true;
            		}
HXDLIN(1151)		if (_hx_tmp) {
HXLINE(1153)			this->_hx___dirty = true;
HXLINE(1154)			this->_hx___layoutDirty = true;
            		}
HXLINE(1158)		this->_hx___isHTML = true;
HXLINE(1160)		{
HXLINE(1182)			value =  ::EReg_obj::__new(HX_("<br>",b2,8d,f3,27),HX_("g",67,00,00,00))->replace(value,HX_("\n",0a,00,00,00));
HXLINE(1183)			value =  ::EReg_obj::__new(HX_("<br/>",3b,61,28,cd),HX_("g",67,00,00,00))->replace(value,HX_("\n",0a,00,00,00));
HXLINE(1184)			HX_VARI( ::String,text) = value;
HXDLIN(1184)			HX_VARI( ::Array< ::Dynamic>,entities) = ::Array_obj< ::Dynamic>::__new(5)->init(0,::Array_obj< ::String >::fromData( _hx_array_data_23,2))->init(1,::Array_obj< ::String >::fromData( _hx_array_data_24,2))->init(2,::Array_obj< ::String >::fromData( _hx_array_data_25,2))->init(3,::Array_obj< ::String >::fromData( _hx_array_data_26,2))->init(4,::Array_obj< ::String >::fromData( _hx_array_data_27,2));
HXDLIN(1184)			{
HXLINE(1184)				HX_VARI( Int,_g1) = (int)0;
HXDLIN(1184)				HX_VARI( Int,_g) = entities->length;
HXDLIN(1184)				while((_g1 < _g)){
HXLINE(1184)					HX_VARI( Int,i) = _g1++;
HXDLIN(1184)					::String _hx_tmp1 = ((HX_("&",26,00,00,00) + entities->__get(i).StaticCast< ::Array< ::String > >()->__get((int)0)) + HX_(";",3b,00,00,00));
HXDLIN(1184)					 ::EReg _hx_tmp2 =  ::EReg_obj::__new(_hx_tmp1,HX_("g",67,00,00,00));
HXDLIN(1184)					::String _hx_tmp3 = entities->__get(i).StaticCast< ::Array< ::String > >()->__get((int)1);
HXDLIN(1184)					text = _hx_tmp2->replace(text,_hx_tmp3);
            				}
            			}
HXDLIN(1184)			value = text;
HXLINE(1188)			HX_VARI( ::Array< ::String >,segments) = value.split(HX_("<",3c,00,00,00));
HXLINE(1190)			Bool _hx_tmp4 = (segments->length == (int)1);
HXDLIN(1190)			if (_hx_tmp4) {
HXLINE(1192)				value =  ::EReg_obj::__new(HX_("<.*?>",97,b4,92,aa),HX_("g",67,00,00,00))->replace(value,HX_("",00,00,00,00));
HXLINE(1194)				Bool _hx_tmp5 = (this->_hx___textEngine->textFormatRanges->length > (int)1);
HXDLIN(1194)				if (_hx_tmp5) {
HXLINE(1196)					Int _hx_tmp6 = (this->_hx___textEngine->textFormatRanges->length - (int)1);
HXDLIN(1196)					this->_hx___textEngine->textFormatRanges->removeRange((int)1,_hx_tmp6);
            				}
HXLINE(1200)				HX_VARI(  ::openfl::_internal::text::TextFormatRange,range) = this->_hx___textEngine->textFormatRanges->__get((int)0).StaticCast<  ::openfl::_internal::text::TextFormatRange >();
HXLINE(1201)				range->format = this->_hx___textFormat;
HXLINE(1202)				range->start = (int)0;
HXLINE(1203)				range->end = value.length;
HXLINE(1205)				return (this->_hx___textEngine->text = value);
            			}
            			else {
HXLINE(1209)				this->_hx___textEngine->textFormatRanges->removeRange((int)0,this->_hx___textEngine->textFormatRanges->length);
HXLINE(1211)				value = HX_("",00,00,00,00);
HXLINE(1213)				 ::openfl::text::TextFormat _hx_tmp7 = this->_hx___textFormat->clone();
HXDLIN(1213)				HX_VARI( ::Array< ::Dynamic>,formatStack) = ::Array_obj< ::Dynamic>::__new(1)->init(0,_hx_tmp7);
HXLINE(1214)				HX_VAR( ::String,sub);
HXLINE(1215)				HX_VARI( Bool,noLineBreak) = false;
HXLINE(1217)				{
HXLINE(1217)					HX_VARI_NAME( Int,_g2,"_g") = (int)0;
HXDLIN(1217)					while((_g2 < segments->length)){
HXLINE(1217)						HX_VARI( ::String,segment) = segments->__get(_g2);
HXDLIN(1217)						++_g2;
HXLINE(1219)						if ((segment == HX_("",00,00,00,00))) {
HXLINE(1219)							continue;
            						}
HXLINE(1221)						::String _hx_tmp8 = segment.substr((int)0,(int)1);
HXDLIN(1221)						HX_VARI( Bool,isClosingTag) = (_hx_tmp8 == HX_("/",2f,00,00,00));
HXLINE(1222)						HX_VARI( Int,tagEndIndex) = segment.indexOf(HX_(">",3e,00,00,00),null());
HXLINE(1223)						HX_VARI( Int,start) = (tagEndIndex + (int)1);
HXLINE(1224)						HX_VARI( Int,spaceIndex) = segment.indexOf(HX_(" ",20,00,00,00),null());
HXLINE(1225)						Int _hx_tmp9;
HXDLIN(1225)						if (isClosingTag) {
HXLINE(1225)							_hx_tmp9 = (int)1;
            						}
            						else {
HXLINE(1225)							_hx_tmp9 = (int)0;
            						}
HXDLIN(1225)						 ::Dynamic _hx_tmp10;
HXDLIN(1225)						Bool _hx_tmp11;
HXDLIN(1225)						if ((spaceIndex > (int)-1)) {
HXLINE(1225)							_hx_tmp11 = (spaceIndex < tagEndIndex);
            						}
            						else {
HXLINE(1225)							_hx_tmp11 = false;
            						}
HXDLIN(1225)						if (_hx_tmp11) {
HXLINE(1225)							_hx_tmp10 = spaceIndex;
            						}
            						else {
HXLINE(1225)							_hx_tmp10 = tagEndIndex;
            						}
HXDLIN(1225)						HX_VARI( ::String,tagName) = segment.substring(_hx_tmp9,_hx_tmp10);
HXLINE(1226)						HX_VAR(  ::openfl::text::TextFormat,format);
HXLINE(1228)						if (isClosingTag) {
HXLINE(1230)							formatStack->pop().StaticCast<  ::openfl::text::TextFormat >();
HXLINE(1231)							Int _hx_tmp12 = (formatStack->length - (int)1);
HXDLIN(1231)							format = formatStack->__get(_hx_tmp12).StaticCast<  ::openfl::text::TextFormat >()->clone();
HXLINE(1233)							Bool _hx_tmp13;
HXDLIN(1233)							::String _hx_tmp14 = tagName.toLowerCase();
HXDLIN(1233)							if ((_hx_tmp14 == HX_("p",70,00,00,00))) {
HXLINE(1233)								_hx_tmp13 = (this->_hx___textEngine->textFormatRanges->length > (int)0);
            							}
            							else {
HXLINE(1233)								_hx_tmp13 = false;
            							}
HXDLIN(1233)							if (_hx_tmp13) {
HXLINE(1235)								hx::AddEq(value,HX_("\n",0a,00,00,00));
HXLINE(1236)								noLineBreak = true;
            							}
HXLINE(1240)							Bool _hx_tmp15 = (start < segment.length);
HXDLIN(1240)							if (_hx_tmp15) {
HXLINE(1242)								sub = segment.substr(start,null());
HXLINE(1243)								Int _hx_tmp16 = value.length;
HXDLIN(1243)								Int _hx_tmp17 = (value.length + sub.length);
HXDLIN(1243)								this->_hx___textEngine->textFormatRanges->push( ::openfl::_internal::text::TextFormatRange_obj::__new(format,_hx_tmp16,_hx_tmp17));
HXLINE(1244)								hx::AddEq(value,sub);
HXLINE(1245)								noLineBreak = false;
            							}
            						}
            						else {
HXLINE(1251)							Int _hx_tmp18 = (formatStack->length - (int)1);
HXDLIN(1251)							format = formatStack->__get(_hx_tmp18).StaticCast<  ::openfl::text::TextFormat >()->clone();
HXLINE(1253)							if ((tagEndIndex > (int)-1)) {
HXLINE(1255)								{
HXLINE(1255)									HX_VARI_NAME( ::String,_g11,"_g1") = tagName.toLowerCase();
HXDLIN(1255)									::String _hx_switch_0 = _g11;
            									if (  (_hx_switch_0==HX_("b",62,00,00,00)) ){
HXLINE(1301)										format->bold = true;
HXDLIN(1301)										goto _hx_goto_22;
            									}
            									if (  (_hx_switch_0==HX_("em",68,58,00,00)) ||  (_hx_switch_0==HX_("i",69,00,00,00)) ){
HXLINE(1309)										format->italic = true;
HXDLIN(1309)										goto _hx_goto_22;
            									}
            									if (  (_hx_switch_0==HX_("font",cf,5d,c0,43)) ){
HXLINE(1275)										HX_VARI(  ::EReg,faceEreg) =  ::EReg_obj::__new(HX_("face=\"([^\"]+)",c2,60,17,5c),HX_("i",69,00,00,00));
HXLINE(1277)										Bool _hx_tmp19 = faceEreg->match(segment);
HXDLIN(1277)										if (_hx_tmp19) {
HXLINE(1279)											format->font = faceEreg->matched((int)1);
            										}
HXLINE(1283)										HX_VARI(  ::EReg,colorEreg) =  ::EReg_obj::__new(HX_("color=\"#([^\"]+)",49,2b,aa,18),HX_("i",69,00,00,00));
HXLINE(1285)										Bool _hx_tmp20 = colorEreg->match(segment);
HXDLIN(1285)										if (_hx_tmp20) {
HXLINE(1287)											::String _hx_tmp21 = colorEreg->matched((int)1);
HXDLIN(1287)											format->color = ::Std_obj::parseInt((HX_("0x",48,2a,00,00) + _hx_tmp21));
            										}
HXLINE(1291)										HX_VARI(  ::EReg,sizeEreg) =  ::EReg_obj::__new(HX_("size=\"([^\"]+)",1e,d0,d4,88),HX_("i",69,00,00,00));
HXLINE(1293)										Bool _hx_tmp22 = sizeEreg->match(segment);
HXDLIN(1293)										if (_hx_tmp22) {
HXLINE(1295)											::String _hx_tmp23 = sizeEreg->matched((int)1);
HXDLIN(1295)											format->size = ::Std_obj::parseInt(_hx_tmp23);
            										}
HXLINE(1273)										goto _hx_goto_22;
            									}
            									if (  (_hx_switch_0==HX_("p",70,00,00,00)) ){
HXLINE(1259)										Bool _hx_tmp24;
HXDLIN(1259)										if ((this->_hx___textEngine->textFormatRanges->length > (int)0)) {
HXLINE(1259)											_hx_tmp24 = !(noLineBreak);
            										}
            										else {
HXLINE(1259)											_hx_tmp24 = false;
            										}
HXDLIN(1259)										if (_hx_tmp24) {
HXLINE(1261)											hx::AddEq(value,HX_("\n",0a,00,00,00));
            										}
HXLINE(1265)										HX_VARI(  ::EReg,alignEreg) =  ::EReg_obj::__new(HX_("align=\"([^\"]+)",9a,39,5a,96),HX_("i",69,00,00,00));
HXLINE(1267)										Bool _hx_tmp25 = alignEreg->match(segment);
HXDLIN(1267)										if (_hx_tmp25) {
HXLINE(1269)											::String _hx_tmp26 = alignEreg->matched((int)1).toLowerCase();
HXDLIN(1269)											format->align = ::openfl::text::_TextFormatAlign::TextFormatAlign_Impl__obj::fromString(_hx_tmp26);
            										}
HXLINE(1257)										goto _hx_goto_22;
            									}
            									if (  (_hx_switch_0==HX_("u",75,00,00,00)) ){
HXLINE(1305)										format->underline = true;
HXDLIN(1305)										goto _hx_goto_22;
            									}
            									_hx_goto_22:;
            								}
HXLINE(1313)								formatStack->push(format);
HXLINE(1315)								Bool _hx_tmp27 = (start < segment.length);
HXDLIN(1315)								if (_hx_tmp27) {
HXLINE(1317)									sub = segment.substring(start,null());
HXLINE(1318)									Int _hx_tmp28 = value.length;
HXDLIN(1318)									Int _hx_tmp29 = (value.length + sub.length);
HXDLIN(1318)									this->_hx___textEngine->textFormatRanges->push( ::openfl::_internal::text::TextFormatRange_obj::__new(format,_hx_tmp28,_hx_tmp29));
HXLINE(1319)									hx::AddEq(value,sub);
HXLINE(1320)									noLineBreak = false;
            								}
            							}
            							else {
HXLINE(1326)								Int _hx_tmp30 = value.length;
HXDLIN(1326)								Int _hx_tmp31 = (value.length + segment.length);
HXDLIN(1326)								this->_hx___textEngine->textFormatRanges->push( ::openfl::_internal::text::TextFormatRange_obj::__new(format,_hx_tmp30,_hx_tmp31));
HXLINE(1327)								hx::AddEq(value,segment);
HXLINE(1328)								noLineBreak = false;
            							}
            						}
            					}
            				}
...
HXLINE(1340)		return (this->_hx___textEngine->text = value);
            	}
...
Int TextField_obj::get_length(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1347)		Bool _hx_tmp = hx::IsNotNull( this->_hx___textEngine->text );
HXDLIN(1347)		if (_hx_tmp) {
HXLINE(1349)			return this->_hx___textEngine->text.length;
            		}
...
Int TextField_obj::get_maxChars(){
            	HX_STACK_FRAME("openfl.text.TextField","get_maxChars",0x980651c6,"openfl.text.TextField.get_maxChars","openfl/text/TextField.hx",1360,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE(1360)		return this->_hx___textEngine->maxChars;
            	}
...
Int TextField_obj::set_maxChars(Int value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(1367)		Bool _hx_tmp = (value != this->_hx___textEngine->maxChars);
HXDLIN(1367)		if (_hx_tmp) {
HXLINE(1369)			this->_hx___dirty = true;
HXLINE(1370)			this->_hx___layoutDirty = true;
            		}
HXLINE(1374)		return (this->_hx___textEngine->maxChars = value);
            	}
...
Int TextField_obj::get_maxScrollH(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1381)		this->_hx___updateLayout();
HXLINE(1383)		return this->_hx___textEngine->maxScrollH;
            	}
...
Int TextField_obj::get_maxScrollV(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1390)		this->_hx___updateLayout();
HXLINE(1392)		return this->_hx___textEngine->maxScrollV;
            	}
...
Bool TextField_obj::get_multiline(){
            	HX_STACK_FRAME("openfl.text.TextField","get_multiline",0x24925820,"openfl.text.TextField.get_multiline","openfl/text/TextField.hx",1399,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE(1399)		return this->_hx___textEngine->multiline;
            	}
...
Bool TextField_obj::set_multiline(Bool value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(1406)		Bool _hx_tmp = (value != this->_hx___textEngine->multiline);
HXDLIN(1406)		if (_hx_tmp) {
HXLINE(1408)			this->_hx___dirty = true;
HXLINE(1409)			this->_hx___layoutDirty = true;
            		}
HXLINE(1413)		return (this->_hx___textEngine->multiline = value);
            	}
...
Int TextField_obj::get_numLines(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1420)		this->_hx___updateLayout();
HXLINE(1422)		return this->_hx___textEngine->numLines;
            	}
...
::String TextField_obj::get_restrict(){
            	HX_STACK_FRAME("openfl.text.TextField","get_restrict",0x99d42d69,"openfl.text.TextField.get_restrict","openfl/text/TextField.hx",1429,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE(1429)		return this->_hx___textEngine->restrict;
            	}
...
::String TextField_obj::set_restrict(::String value){
            	HX_STACK_FRAME("openfl.text.TextField","set_restrict",0xaecd50dd,"openfl.text.TextField.set_restrict","openfl/text/TextField.hx",1436,0xccf02094)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(1436)		return (this->_hx___textEngine->restrict = value);
            	}
...
Int TextField_obj::get_scrollH(){
            	HX_STACK_FRAME("openfl.text.TextField","get_scrollH",0xbeccf60e,"openfl.text.TextField.get_scrollH","openfl/text/TextField.hx",1443,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE(1443)		return this->_hx___textEngine->scrollH;
            	}
...
Int TextField_obj::set_scrollH(Int value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(1450)		Bool _hx_tmp = (value > this->_hx___textEngine->maxScrollH);
HXDLIN(1450)		if (_hx_tmp) {
HXLINE(1450)			value = this->_hx___textEngine->maxScrollH;
            		}
HXLINE(1451)		Bool _hx_tmp1 = (value < (int)0);
HXDLIN(1451)		if (_hx_tmp1) {
HXLINE(1451)			value = (int)0;
            		}
HXLINE(1453)		Bool _hx_tmp2 = (value != this->_hx___textEngine->scrollH);
HXDLIN(1453)		if (_hx_tmp2) {
HXLINE(1455)			this->_hx___dirty = true;
            		}
HXLINE(1459)		return (this->_hx___textEngine->scrollH = value);
            	}
...
Int TextField_obj::get_scrollV(){
            	HX_STACK_FRAME("openfl.text.TextField","get_scrollV",0xbeccf61c,"openfl.text.TextField.get_scrollV","openfl/text/TextField.hx",1466,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE(1466)		return this->_hx___textEngine->scrollV;
            	}
...
Int TextField_obj::set_scrollV(Int value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(1473)		Bool _hx_tmp = (value > this->_hx___textEngine->maxScrollV);
HXDLIN(1473)		if (_hx_tmp) {
HXLINE(1473)			value = this->_hx___textEngine->maxScrollV;
            		}
HXLINE(1474)		Bool _hx_tmp1 = (value < (int)1);
HXDLIN(1474)		if (_hx_tmp1) {
HXLINE(1474)			value = (int)1;
            		}
HXLINE(1476)		Bool _hx_tmp2 = (value != this->_hx___textEngine->scrollV);
HXDLIN(1476)		if (_hx_tmp2) {
HXLINE(1478)			this->_hx___dirty = true;
            		}
HXLINE(1482)		return (this->_hx___textEngine->scrollV = value);
            	}
...
Bool TextField_obj::get_selectable(){
            	HX_STACK_FRAME("openfl.text.TextField","get_selectable",0xee1ebe03,"openfl.text.TextField.get_selectable","openfl/text/TextField.hx",1489,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE(1489)		return this->_hx___textEngine->selectable;
            	}
...
HXDLIN(1496)		Bool _hx_tmp1 = (value != this->_hx___textEngine->selectable);
HXDLIN(1496)		if (_hx_tmp1) {
HXLINE(1496)			 ::Dynamic _hx_tmp2 = this->get_type();
HXDLIN(1496)			_hx_tmp = hx::IsEq( _hx_tmp2,(int)1 );
            		}
            		else {
HXLINE(1496)			_hx_tmp = false;
            		}
HXDLIN(1496)		if (_hx_tmp) {
HXLINE(1498)			Bool _hx_tmp3;
HXDLIN(1498)			Bool _hx_tmp4 = hx::IsNotNull( this->stage );
HXDLIN(1498)			if (_hx_tmp4) {
HXLINE(1498)				 ::openfl::display::InteractiveObject _hx_tmp5 = this->stage->get_focus();
HXDLIN(1498)				_hx_tmp3 = hx::IsEq( _hx_tmp5,hx::ObjectPtr<OBJ_>(this) );
            			}
            			else {
HXLINE(1498)				_hx_tmp3 = false;
            			}
HXDLIN(1498)			if (_hx_tmp3) {
HXLINE(1500)				this->_hx___startTextInput();
            			}
            			else {
HXLINE(1502)				if (!(value)) {
HXLINE(1504)					this->_hx___stopTextInput();
            				}
            			}
            		}
HXLINE(1510)		return (this->_hx___textEngine->selectable = value);
            	}
...
Int TextField_obj::get_selectionBeginIndex(){
            	HX_STACK_FRAME("openfl.text.TextField","get_selectionBeginIndex",0xb79fa288,"openfl.text.TextField.get_selectionBeginIndex","openfl/text/TextField.hx",1517,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE(1517)		Float _hx_tmp = ::Math_obj::min(this->_hx___caretIndex,this->_hx___selectionIndex);
HXDLIN(1517)		return ::Std_obj::_hx_int(_hx_tmp);
            	}
...
Int TextField_obj::get_selectionEndIndex(){
            	HX_STACK_FRAME("openfl.text.TextField","get_selectionEndIndex",0xc3677dd6,"openfl.text.TextField.get_selectionEndIndex","openfl/text/TextField.hx",1524,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE(1524)		Float _hx_tmp = ::Math_obj::max(this->_hx___caretIndex,this->_hx___selectionIndex);
HXDLIN(1524)		return ::Std_obj::_hx_int(_hx_tmp);
            	}
...
Float TextField_obj::get_sharpness(){
            	HX_STACK_FRAME("openfl.text.TextField","get_sharpness",0xa1a5a7b4,"openfl.text.TextField.get_sharpness","openfl/text/TextField.hx",1531,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE(1531)		return this->_hx___textEngine->sharpness;
            	}
...
Float TextField_obj::set_sharpness(Float value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(1538)		Bool _hx_tmp = (value != this->_hx___textEngine->sharpness);
HXDLIN(1538)		if (_hx_tmp) {
HXLINE(1540)			this->_hx___dirty = true;
            		}
HXLINE(1544)		return (this->_hx___textEngine->sharpness = value);
            	}
...
::String TextField_obj::get_text(){
            	HX_STACK_FRAME("openfl.text.TextField","get_text",0x3b0d545a,"openfl.text.TextField.get_text","openfl/text/TextField.hx",1551,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE(1551)		return this->_hx___textEngine->text;
            	}
...
HXDLIN(1558)		if (!(this->_hx___isHTML)) {
HXLINE(1558)			_hx_tmp = (this->_hx___textEngine->text != value);
            		}
            		else {
HXLINE(1558)			_hx_tmp = true;
            		}
HXDLIN(1558)		if (_hx_tmp) {
HXLINE(1560)			this->_hx___dirty = true;
HXLINE(1561)			this->_hx___layoutDirty = true;
            		}
            		else {
HXLINE(1565)			return value;
            		}
HXLINE(1569)		Bool _hx_tmp1 = (this->_hx___textEngine->textFormatRanges->length > (int)1);
HXDLIN(1569)		if (_hx_tmp1) {
HXLINE(1571)			Int _hx_tmp2 = (this->_hx___textEngine->textFormatRanges->length - (int)1);
HXDLIN(1571)			this->_hx___textEngine->textFormatRanges->removeRange((int)1,_hx_tmp2);
            		}
HXLINE(1575)		HX_VARI(  ::openfl::_internal::text::TextFormatRange,range) = this->_hx___textEngine->textFormatRanges->__get((int)0).StaticCast<  ::openfl::_internal::text::TextFormatRange >();
HXLINE(1576)		range->format = this->_hx___textFormat;
HXLINE(1577)		range->start = (int)0;
HXLINE(1578)		range->end = value.length;
HXLINE(1580)		this->_hx___isHTML = false;
HXLINE(1582)		return (this->_hx___textEngine->text = value);
            	}
...
Int TextField_obj::get_textColor(){
            	HX_STACK_FRAME("openfl.text.TextField","get_textColor",0x69ca86a9,"openfl.text.TextField.get_textColor","openfl/text/TextField.hx",1589,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE(1589)		return this->_hx___textFormat->color;
            	}
...
Int TextField_obj::set_textColor(Int value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(1596)		Bool _hx_tmp = hx::IsNotEq( value,this->_hx___textFormat->color );
HXDLIN(1596)		if (_hx_tmp) {
HXLINE(1596)			this->_hx___dirty = true;
            		}
HXLINE(1598)		{
HXLINE(1598)			HX_VARI( Int,_g) = (int)0;
HXDLIN(1598)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->_hx___textEngine->textFormatRanges;
HXDLIN(1598)			while((_g < _g1->length)){
HXLINE(1598)				HX_VARI(  ::openfl::_internal::text::TextFormatRange,range) = _g1->__get(_g).StaticCast<  ::openfl::_internal::text::TextFormatRange >();
HXDLIN(1598)				++_g;
HXLINE(1600)				range->format->color = value;
            			}
            		}
HXLINE(1604)		return (this->_hx___textFormat->color = value);
            	}
...
Float TextField_obj::get_textWidth(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1610)		this->_hx___updateLayout();
HXLINE(1611)		return this->_hx___textEngine->textWidth;
            	}
...
Float TextField_obj::get_textHeight(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1618)		this->_hx___updateLayout();
HXLINE(1619)		return this->_hx___textEngine->textHeight;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(TextField_obj,get_textHeight,return )
 ...
 ::Dynamic TextField_obj::get_type(){
            	HX_STACK_FRAME("openfl.text.TextField","get_type",0x3b1c7a67,"openfl.text.TextField.get_type","openfl/text/TextField.hx",1626,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE(1626)		return this->_hx___textEngine->type;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(TextField_obj,get_type,return )
 ...
 ::Dynamic TextField_obj::set_type( ::Dynamic value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(1633)		Bool _hx_tmp = hx::IsNotEq( value,this->_hx___textEngine->type );
HXDLIN(1633)		if (_hx_tmp) {
HXLINE(1635)			if (hx::IsEq( value,(int)1 )) {
HXLINE(1637)				this->addEventListener(HX_("focusIn",dd,45,83,41),this->this_onFocusIn_dyn(),null(),null(),null());
HXLINE(1638)				this->addEventListener(HX_("focusOut",96,6f,5e,11),this->this_onFocusOut_dyn(),null(),null(),null());
HXLINE(1639)				this->addEventListener(HX_("addedToStage",63,22,55,0c),this->this_onAddedToStage_dyn(),null(),null(),null());
HXLINE(1641)				this->this_onFocusIn(null());
            			}
            			else {
HXLINE(1645)				this->removeEventListener(HX_("focusIn",dd,45,83,41),this->this_onFocusIn_dyn(),null());
HXLINE(1646)				this->removeEventListener(HX_("focusOut",96,6f,5e,11),this->this_onFocusOut_dyn(),null());
HXLINE(1647)				this->removeEventListener(HX_("addedToStage",63,22,55,0c),this->this_onAddedToStage_dyn(),null());
HXLINE(1649)				this->_hx___stopTextInput();
            			}
HXLINE(1653)			this->_hx___dirty = true;
            		}
HXLINE(1657)		return (this->_hx___textEngine->type = value);
            	}
...
Float TextField_obj::get_width(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1664)		this->_hx___updateLayout();
HXLINE(1665)		return this->_hx___textEngine->width;
            	}
...
HXDLIN(1672)		Float _hx_tmp1 = this->get_scaleX();
HXDLIN(1672)		if ((_hx_tmp1 == (int)1)) {
HXLINE(1672)			_hx_tmp = (this->_hx___textEngine->width != value);
            		}
            		else {
HXLINE(1672)			_hx_tmp = true;
            		}
HXDLIN(1672)		if (_hx_tmp) {
HXLINE(1674)			Bool _hx_tmp2 = !(this->_hx___transformDirty);
HXDLIN(1674)			if (_hx_tmp2) {
HXLINE(1674)				this->_hx___transformDirty = true;
HXDLIN(1674)				::openfl::display::DisplayObject_obj::_hx___worldTransformDirty++;
            			}
HXLINE(1675)			this->_hx___dirty = true;
HXLINE(1676)			this->_hx___layoutDirty = true;
            		}
HXLINE(1680)		this->set_scaleX((int)1);
HXLINE(1681)		return (this->_hx___textEngine->width = value);
            	}


Bool TextField_obj::get_wordWrap(){
            	HX_STACK_FRAME("openfl.text.TextField","get_wordWrap",0xa91076e1,"openfl.text.TextField.get_wordWrap","openfl/text/TextField.hx",1688,0xccf02094)
            	HX_STACK_THIS(this)
HXLINE(1688)		return this->_hx___textEngine->wordWrap;
            	}
...
Bool TextField_obj::set_wordWrap(Bool value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(1695)		Bool _hx_tmp = (value != this->_hx___textEngine->wordWrap);
HXDLIN(1695)		if (_hx_tmp) {
HXLINE(1697)			this->_hx___dirty = true;
HXLINE(1698)			this->_hx___layoutDirty = true;
            		}
HXLINE(1702)		return (this->_hx___textEngine->wordWrap = value);
            	}
...
HXLINE(1716)		Bool _hx_tmp = hx::IsNull( this->stage );
HXDLIN(1716)		if (_hx_tmp) {
HXLINE(1716)			return;
            		}
HXLINE(1718)		Bool _hx_tmp1;
HXDLIN(1718)		if (this->_hx___textEngine->selectable) {
HXLINE(1718)			_hx_tmp1 = (this->_hx___selectionIndex >= (int)0);
            		}
            		else {
...
HXLINE(1722)			Float _hx_tmp2 = this->get_mouseX();
HXDLIN(1722)			Float _hx_tmp3 = this->get_mouseY();
HXDLIN(1722)			HX_VARI( Int,position) = this->_hx___getPosition(_hx_tmp2,_hx_tmp3);
HXLINE(1724)			Bool _hx_tmp4 = (position != this->_hx___caretIndex);
HXDLIN(1724)			if (_hx_tmp4) {
HXLINE(1726)				this->_hx___caretIndex = position;
HXLINE(1727)				this->_hx___dirty = true;
            			}
            		}
            	}
...
void TextField_obj::stage_onMouseUp( ::openfl::events::MouseEvent event){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(event,"event")
HXLINE(1738)		Bool _hx_tmp = hx::IsNull( this->stage );
HXDLIN(1738)		if (_hx_tmp) {
HXLINE(1738)			return;
            		}
HXLINE(1740)		this->stage->removeEventListener(HX_("mouseMove",d6,9b,b5,f4),this->stage_onMouseMove_dyn(),null());
HXLINE(1741)		this->stage->removeEventListener(HX_("mouseUp",e0,f3,72,c0),this->stage_onMouseUp_dyn(),null());
HXLINE(1743)		 ::openfl::display::InteractiveObject _hx_tmp1 = this->stage->get_focus();
HXDLIN(1743)		if (hx::IsEq( _hx_tmp1,hx::ObjectPtr<OBJ_>(this) )) {
HXLINE(1745)			this->_hx___getWorldTransform();
HXLINE(1746)			this->_hx___updateLayout();
HXLINE(1748)			HX_VARI(  ::openfl::geom::Matrix,_this) = this->_hx___worldTransform;
HXDLIN(1748)			HX_VARI( Float,norm) = ((_this->a * _this->d) - (_this->b * _this->c));
HXLINE(1749)			HX_VARI_NAME(  ::openfl::geom::Matrix,_this1,"_this") = this->_hx___worldTransform;
HXDLIN(1749)			HX_VARI_NAME( Float,norm1,"norm") = ((_this1->a * _this1->d) - (_this1->b * _this1->c));
HXLINE(1751)			Float _hx_tmp2 = this->get_mouseX();
HXDLIN(1751)			Float _hx_tmp3 = this->get_mouseY();
HXDLIN(1751)			HX_VARI( Int,upPos) = this->_hx___getPosition(_hx_tmp2,_hx_tmp3);
HXLINE(1752)			HX_VAR( Int,leftPos);
HXLINE(1753)			HX_VAR( Int,rightPos);
HXLINE(1755)			Float _hx_tmp4 = ::Math_obj::min(this->_hx___selectionIndex,upPos);
HXDLIN(1755)			leftPos = ::Std_obj::_hx_int(_hx_tmp4);
HXLINE(1756)			Float _hx_tmp5 = ::Math_obj::max(this->_hx___selectionIndex,upPos);
HXDLIN(1756)			rightPos = ::Std_obj::_hx_int(_hx_tmp5);
HXLINE(1758)			this->_hx___selectionIndex = leftPos;
HXLINE(1759)			this->_hx___caretIndex = rightPos;
HXLINE(1761)			Bool _hx_tmp6 = this->_hx___inputEnabled;
HXDLIN(1761)			if (_hx_tmp6) {
HXLINE(1763)				this->this_onFocusIn(null());
HXLINE(1765)				this->_hx___stopCursorTimer();
HXLINE(1766)				this->_hx___startCursorTimer();
            			}
            		}
            	}
...
void TextField_obj::this_onAddedToStage( ::openfl::events::Event event){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(event,"event")
HXLINE(1777)		this->this_onFocusIn(null());
            	}
...
void TextField_obj::this_onFocusIn( ::openfl::events::FocusEvent event){
            	HX_STACK_FRAME("openfl.text.TextField","this_onFocusIn",0x90f9e141,"openfl.text.TextField.this_onFocusIn","openfl/text/TextField.hx",1784,0xccf02094)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(event,"event")
HXLINE(1784)		Bool _hx_tmp;
HXDLIN(1784)		Bool _hx_tmp1;
HXDLIN(1784)		Bool _hx_tmp2;
HXDLIN(1784)		Bool _hx_tmp3 = this->get_selectable();
HXDLIN(1784)		if (_hx_tmp3) {
HXLINE(1784)			 ::Dynamic _hx_tmp4 = this->get_type();
HXDLIN(1784)			_hx_tmp2 = hx::IsEq( _hx_tmp4,(int)1 );
            		}
            		else {
HXLINE(1784)			_hx_tmp2 = false;
            		}
HXDLIN(1784)		if (_hx_tmp2) {
HXLINE(1784)			_hx_tmp1 = hx::IsNotNull( this->stage );
            		}
            		else {
HXLINE(1784)			_hx_tmp1 = false;
            		}
HXDLIN(1784)		if (_hx_tmp1) {
HXLINE(1784)			 ::openfl::display::InteractiveObject _hx_tmp5 = this->stage->get_focus();
HXDLIN(1784)			_hx_tmp = hx::IsEq( _hx_tmp5,hx::ObjectPtr<OBJ_>(this) );
            		}
            		else {
HXLINE(1784)			_hx_tmp = false;
            		}
HXDLIN(1784)		if (_hx_tmp) {
HXLINE(1786)			this->_hx___startTextInput();
            		}
            	}
...
void TextField_obj::this_onFocusOut( ::openfl::events::FocusEvent event){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(event,"event")
HXLINE(1795)		this->_hx___stopTextInput();
            	}
...
void TextField_obj::this_onMouseDown( ::openfl::events::MouseEvent event){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(event,"event")
HXLINE(1802)		Bool _hx_tmp = !(this->get_selectable());
HXDLIN(1802)		if (_hx_tmp) {
HXLINE(1802)			return;
            		}
HXLINE(1804)		this->_hx___updateLayout();
HXLINE(1806)		Float _hx_tmp1 = this->get_mouseX();
HXDLIN(1806)		Float _hx_tmp2 = this->get_mouseY();
HXDLIN(1806)		this->_hx___caretIndex = this->_hx___getPosition(_hx_tmp1,_hx_tmp2);
HXLINE(1807)		this->_hx___selectionIndex = this->_hx___caretIndex;
HXLINE(1808)		this->_hx___dirty = true;
HXLINE(1810)		this->stage->addEventListener(HX_("mouseMove",d6,9b,b5,f4),this->stage_onMouseMove_dyn(),null(),null(),null());
HXLINE(1811)		this->stage->addEventListener(HX_("mouseUp",e0,f3,72,c0),this->stage_onMouseUp_dyn(),null(),null(),null());
            	}
...
void TextField_obj::window_onKeyDown(Int key,Int modifier){
            	HX_STACK_FRAME("openfl.text.TextField","window_onKeyDown",0x61330e17,"openfl.text.TextField.window_onKeyDown","openfl/text/TextField.hx",1818,0xccf02094)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
            	HX_STACK_ARG(modifier,"modifier")
HXLINE(1818)		switch((int)(key)){
            			case (int)8: {
HXLINE(1822)				Bool _hx_tmp;
HXDLIN(1822)				if ((this->_hx___selectionIndex == this->_hx___caretIndex)) {
HXLINE(1822)					_hx_tmp = (this->_hx___caretIndex > (int)0);
            				}
            				else {
HXLINE(1822)					_hx_tmp = false;
            				}
HXDLIN(1822)				if (_hx_tmp) {
HXLINE(1824)					this->_hx___selectionIndex = (this->_hx___caretIndex - (int)1);
            				}
HXLINE(1828)				Bool _hx_tmp1 = (this->_hx___selectionIndex != this->_hx___caretIndex);
HXDLIN(1828)				if (_hx_tmp1) {
HXLINE(1830)					this->replaceSelectedText(HX_("",00,00,00,00));
HXLINE(1831)					this->_hx___selectionIndex = this->_hx___caretIndex;
HXLINE(1833)					this->dispatchEvent( ::openfl::events::Event_obj::__new(HX_("change",70,91,72,b7),true,null()));
            				}
            			}
            			break;
            			case (int)99: {
HXLINE(1922)				Bool _hx_tmp2;
HXDLIN(1922)				if ((modifier != (int)64)) {
HXLINE(1922)					_hx_tmp2 = (modifier == (int)128);
            				}
            				else {
HXLINE(1922)					_hx_tmp2 = true;
            				}
HXDLIN(1922)				if (_hx_tmp2) {
HXLINE(1924)					::String _hx_tmp3 = this->_hx___textEngine->text.substring(this->_hx___caretIndex,this->_hx___selectionIndex);
HXDLIN(1924)					::lime::_hx_system::Clipboard_obj::set_text(_hx_tmp3);
            				}
            			}
            			break;
            			case (int)118: {
HXLINE(1945)				Bool _hx_tmp4;
HXDLIN(1945)				if ((modifier != (int)64)) {
HXLINE(1945)					_hx_tmp4 = (modifier == (int)128);
            				}
            				else {
HXLINE(1945)					_hx_tmp4 = true;
            				}
HXDLIN(1945)				if (_hx_tmp4) {
HXLINE(1947)					HX_VARI( ::String,text) = ::lime::_hx_system::Clipboard_obj::get_text();
HXLINE(1949)					Bool _hx_tmp5 = hx::IsNotNull( text );
HXDLIN(1949)					if (_hx_tmp5) {
HXLINE(1951)						this->replaceSelectedText(text);
            					}
            					else {
HXLINE(1955)						this->replaceSelectedText(HX_("",00,00,00,00));
            					}
HXLINE(1959)					this->dispatchEvent( ::openfl::events::Event_obj::__new(HX_("change",70,91,72,b7),true,null()));
            				}
            				else {
HXLINE(1962)					Int _hx_tmp6 = (this->_hx___textEngine->textFormatRanges->length - (int)1);
HXDLIN(1962)					this->_hx___textEngine->textFormatRanges->__get(_hx_tmp6).StaticCast<  ::openfl::_internal::text::TextFormatRange >()->end = this->_hx___textEngine->text.length;
            				}
            			}
            			break;
            			case (int)120: {
HXLINE(1930)				Bool _hx_tmp7;
HXDLIN(1930)				if ((modifier != (int)64)) {
HXLINE(1930)					_hx_tmp7 = (modifier == (int)128);
            				}
            				else {
HXLINE(1930)					_hx_tmp7 = true;
            				}
HXDLIN(1930)				if (_hx_tmp7) {
HXLINE(1932)					::String _hx_tmp8 = this->_hx___textEngine->text.substring(this->_hx___caretIndex,this->_hx___selectionIndex);
HXDLIN(1932)					::lime::_hx_system::Clipboard_obj::set_text(_hx_tmp8);
HXLINE(1934)					Bool _hx_tmp9 = (this->_hx___caretIndex != this->_hx___selectionIndex);
HXDLIN(1934)					if (_hx_tmp9) {
HXLINE(1936)						this->replaceSelectedText(HX_("",00,00,00,00));
HXLINE(1937)						this->dispatchEvent( ::openfl::events::Event_obj::__new(HX_("change",70,91,72,b7),true,null()));
            					}
            				}
            			}
            			break;
            			case (int)127: {
HXLINE(1839)				Bool _hx_tmp10;
HXDLIN(1839)				if ((this->_hx___selectionIndex == this->_hx___caretIndex)) {
HXLINE(1839)					_hx_tmp10 = (this->_hx___caretIndex < this->_hx___textEngine->text.length);
            				}
            				else {
HXLINE(1839)					_hx_tmp10 = false;
            				}
HXDLIN(1839)				if (_hx_tmp10) {
HXLINE(1841)					this->_hx___selectionIndex = (this->_hx___caretIndex + (int)1);
            				}
HXLINE(1845)				Bool _hx_tmp11 = (this->_hx___selectionIndex != this->_hx___caretIndex);
HXDLIN(1845)				if (_hx_tmp11) {
HXLINE(1847)					this->replaceSelectedText(HX_("",00,00,00,00));
HXLINE(1848)					this->_hx___selectionIndex = this->_hx___caretIndex;
HXLINE(1850)					this->dispatchEvent( ::openfl::events::Event_obj::__new(HX_("change",70,91,72,b7),true,null()));
            				}
            			}
            			break;
            			case (int)1073741903: {
HXLINE(1889)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_shiftKey(modifier)) {
HXLINE(1891)					Bool _hx_tmp12 = (this->_hx___caretIndex < this->_hx___textEngine->text.length);
HXDLIN(1891)					if (_hx_tmp12) {
HXLINE(1893)						this->_hx___caretIndex++;
            					}
            				}
            				else {
HXLINE(1899)					Bool _hx_tmp13 = (this->_hx___selectionIndex == this->_hx___caretIndex);
HXDLIN(1899)					if (_hx_tmp13) {
HXLINE(1901)						Bool _hx_tmp14 = (this->_hx___caretIndex < this->_hx___textEngine->text.length);
HXDLIN(1901)						if (_hx_tmp14) {
HXLINE(1903)							this->_hx___caretIndex++;
            						}
            					}
            					else {
HXLINE(1909)						Float _hx_tmp15 = ::Math_obj::max(this->_hx___caretIndex,this->_hx___selectionIndex);
HXDLIN(1909)						this->_hx___caretIndex = ::Std_obj::_hx_int(_hx_tmp15);
            					}
HXLINE(1913)					this->_hx___selectionIndex = this->_hx___caretIndex;
            				}
HXLINE(1917)				this->_hx___stopCursorTimer();
HXLINE(1918)				this->_hx___startCursorTimer();
            			}
            			break;
            			case (int)1073741904: {
HXLINE(1856)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_shiftKey(modifier)) {
HXLINE(1858)					Bool _hx_tmp16 = (this->_hx___caretIndex > (int)0);
HXDLIN(1858)					if (_hx_tmp16) {
HXLINE(1860)						this->_hx___caretIndex--;
            					}
            				}
            				else {
HXLINE(1866)					Bool _hx_tmp17 = (this->_hx___selectionIndex == this->_hx___caretIndex);
HXDLIN(1866)					if (_hx_tmp17) {
HXLINE(1868)						Bool _hx_tmp18 = (this->_hx___caretIndex > (int)0);
HXDLIN(1868)						if (_hx_tmp18) {
HXLINE(1870)							this->_hx___caretIndex--;
            						}
            					}
            					else {
HXLINE(1876)						Float _hx_tmp19 = ::Math_obj::min(this->_hx___caretIndex,this->_hx___selectionIndex);
HXDLIN(1876)						this->_hx___caretIndex = ::Std_obj::_hx_int(_hx_tmp19);
            					}
HXLINE(1880)					this->_hx___selectionIndex = this->_hx___caretIndex;
            				}
HXLINE(1884)				this->_hx___stopCursorTimer();
HXLINE(1885)				this->_hx___startCursorTimer();
            			}
            			break;
            			default:{
            			}
...
void TextField_obj::window_onTextInput(::String value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(1974)		this->replaceSelectedText(value);
HXLINE(1976)		this->dispatchEvent( ::openfl::events::Event_obj::__new(HX_("change",70,91,72,b7),true,null()));
            	}
