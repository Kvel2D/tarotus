...
HXDLIN(  26)		HX_VARI( ::Array< ::Dynamic>,_g1) = ::openfl::media::SoundMixer_obj::_hx___soundChannels;
HXDLIN(  26)		while((_g < _g1->length)){
HXLINE(  26)			HX_VARI(  ::openfl::media::SoundChannel,channel) = _g1->__get(_g).StaticCast<  ::openfl::media::SoundChannel >();
HXDLIN(  26)			++_g;
HXLINE(  28)			channel->stop();
            		}
            	}
...
void SoundMixer_obj::_hx___registerSoundChannel( ::openfl::media::SoundChannel soundChannel){
            	HX_STACK_FRAME("openfl.media.SoundMixer","__registerSoundChannel",0x60ebf103,"openfl.media.SoundMixer.__registerSoundChannel","openfl/media/SoundMixer.hx",37,0x17e3a43a)
            	HX_STACK_ARG(soundChannel,"soundChannel")
HXLINE(  37)		::openfl::media::SoundMixer_obj::_hx___soundChannels->push(soundChannel);
            	}
...
void SoundMixer_obj::_hx___unregisterSoundChannel( ::openfl::media::SoundChannel soundChannel){
            	HX_STACK_FRAME("openfl.media.SoundMixer","__unregisterSoundChannel",0xb1bc24dc,"openfl.media.SoundMixer.__unregisterSoundChannel","openfl/media/SoundMixer.hx",44,0x17e3a43a)
            	HX_STACK_ARG(soundChannel,"soundChannel")
HXLINE(  44)		::openfl::media::SoundMixer_obj::_hx___soundChannels->remove(soundChannel);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(SoundMixer_obj,_hx___unregisterSoundChannel,(void))
 ...
 ::openfl::media::SoundTransform SoundMixer_obj::get_soundTransform(){
            	HX_STACK_FRAME("openfl.media.SoundMixer","get_soundTransform",0xc6a43892,"openfl.media.SoundMixer.get_soundTransform","openfl/media/SoundMixer.hx",58,0x17e3a43a)
HXLINE(  58)		return ::openfl::media::SoundMixer_obj::_hx___soundTransform;
            	}
...
HXLINE(  65)		::openfl::media::SoundMixer_obj::_hx___soundTransform = value->clone();
HXLINE(  67)		{
HXLINE(  67)			HX_VARI( Int,_g) = (int)0;
HXDLIN(  67)			HX_VARI( ::Array< ::Dynamic>,_g1) = ::openfl::media::SoundMixer_obj::_hx___soundChannels;
HXDLIN(  67)			while((_g < _g1->length)){
HXLINE(  67)				HX_VARI(  ::openfl::media::SoundChannel,channel) = _g1->__get(_g).StaticCast<  ::openfl::media::SoundChannel >();
HXDLIN(  67)				++_g;
HXLINE(  69)				channel->_hx___updateTransform();
            			}
            		}
...
{
{
            	HX_STACK_FRAME("openfl.media.SoundMixer","boot",0x83c4785e,"openfl.media.SoundMixer.boot","openfl/media/SoundMixer.hx",13,0x17e3a43a)
HXLINE(  13)		_hx___soundChannels = ::Array_obj< ::Dynamic>::__new();
            	}
{
            	HX_STACK_FRAME("openfl.media.SoundMixer","boot",0x83c4785e,"openfl.media.SoundMixer.boot","openfl/media/SoundMixer.hx",14,0x17e3a43a)
HXLINE(  14)		_hx___soundTransform =  ::openfl::media::SoundTransform_obj::__new(null(),null());
            	}
}
