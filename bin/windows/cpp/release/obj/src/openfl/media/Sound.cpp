...
HXLINE(  43)		super::__construct(hx::ObjectPtr<OBJ_>(this));
HXLINE(  45)		this->bytesLoaded = (int)0;
HXLINE(  46)		this->bytesTotal = (int)0;
HXLINE(  47)		this->isBuffering = false;
HXLINE(  48)		this->url = null();
HXLINE(  50)		Bool _hx_tmp = hx::IsNotNull( stream );
HXDLIN(  50)		if (_hx_tmp) {
HXLINE(  52)			this->load(stream,context);
            		}
            	}
...
void Sound_obj::close(){
            	HX_STACK_FRAME("openfl.media.Sound","close",0xfbd9cbd1,"openfl.media.Sound.close","openfl/media/Sound.hx",63,0x46a01619)
            	HX_STACK_THIS(this)
HXLINE(  63)		Bool _hx_tmp = hx::IsNotNull( this->_hx___buffer );
HXDLIN(  63)		if (_hx_tmp) {
HXLINE(  65)			this->_hx___buffer->dispose();
            		}
            	}
...
HXLINE( 105)		::lime::audio::AudioBuffer_obj::fromURL(stream->url,this->AudioBuffer_onURLLoad_dyn());
            	}
...
Bool forcePlayAsMusic = __o_forcePlayAsMusic.Default(false);
            	HX_STACK_FRAME("openfl.media.Sound","loadCompressedDataFromByteArray",0x8f237f2f,"openfl.media.Sound.loadCompressedDataFromByteArray","openfl/media/Sound.hx",139,0x46a01619)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(bytes,"bytes")
            	HX_STACK_ARG(bytesLength,"bytesLength")
            	HX_STACK_ARG(forcePlayAsMusic,"forcePlayAsMusic")
HXLINE( 139)		this->_hx___buffer = ::lime::audio::AudioBuffer_obj::fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(bytes));
            	}
...
Float sampleRate = __o_sampleRate.Default(44100);
            	HX_STACK_FRAME("openfl.media.Sound","loadPCMFromByteArray",0xb6cc217a,"openfl.media.Sound.loadPCMFromByteArray","openfl/media/Sound.hx",156,0x46a01619)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(bytes,"bytes")
...
HXLINE( 156)		this->_hx___buffer = ::lime::audio::AudioBuffer_obj::fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(bytes));
            	}
...
HXLINE( 169)		Bool _hx_tmp = hx::IsNull( sndTransform );
HXDLIN( 169)		if (_hx_tmp) {
HXLINE( 171)			sndTransform =  ::openfl::media::SoundTransform_obj::__new(null(),null());
            		}
            		else {
HXLINE( 175)			sndTransform = sndTransform->clone();
            		}
HXLINE( 179)		HX_VARI( Float,pan) = (::openfl::media::SoundMixer_obj::_hx___soundTransform->pan + sndTransform->pan);
HXLINE( 181)		Bool _hx_tmp1 = (pan > (int)1);
HXDLIN( 181)		if (_hx_tmp1) {
HXLINE( 181)			pan = (int)1;
            		}
HXLINE( 182)		Bool _hx_tmp2 = (pan < (int)-1);
HXDLIN( 182)		if (_hx_tmp2) {
HXLINE( 182)			pan = (int)-1;
            		}
HXLINE( 184)		HX_VARI( Float,volume) = (::openfl::media::SoundMixer_obj::_hx___soundTransform->volume * sndTransform->volume);
HXLINE( 188)		HX_VARI(  ::lime::audio::AudioSource,source) =  ::lime::audio::AudioSource_obj::__new(this->_hx___buffer,null(),null(),null());
HXLINE( 189)		source->offset = ::Std_obj::_hx_int((startTime * (int)1000));
HXLINE( 190)		if ((loops > (int)1)) {
HXLINE( 190)			source->set_loops((loops - (int)1));
            		}
HXLINE( 192)		source->set_gain(volume);
HXLINE( 194)		HX_VARI(  ::lime::math::Vector4,position) = source->get_position();
HXLINE( 195)		position->x = pan;
HXLINE( 196)		Float _hx_tmp3 = ::Math_obj::pow(pan,(int)2);
HXDLIN( 196)		Float _hx_tmp4 = ::Math_obj::sqrt(((int)1 - _hx_tmp3));
HXDLIN( 196)		position->z = ((int)-1 * _hx_tmp4);
HXLINE( 197)		source->set_position(position);
HXLINE( 199)		return  ::openfl::media::SoundChannel_obj::__new(source,sndTransform);
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(Sound_obj,play,return )
 ...
 ::openfl::media::ID3Info Sound_obj::get_id3(){
            	HX_STACK_FRAME("openfl.media.Sound","get_id3",0xac6378e8,"openfl.media.Sound.get_id3","openfl/media/Sound.hx",242,0x46a01619)
            	HX_STACK_THIS(this)
HXLINE( 242)		return  ::openfl::media::ID3Info_obj::__new();
            	}
...
Int Sound_obj::get_length(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 249)		Bool _hx_tmp = hx::IsNotNull( this->_hx___buffer );
HXDLIN( 249)		if (_hx_tmp) {
HXLINE( 258)			Float _hx_tmp1 = (((Float)((Float)(this->_hx___buffer->data->length * (int)8) / (Float)(this->_hx___buffer->channels * this->_hx___buffer->bitsPerSample)) / (Float)this->_hx___buffer->sampleRate) * (int)1000);
HXDLIN( 258)			return ::Std_obj::_hx_int(_hx_tmp1);
            		}
HXLINE( 264)		return (int)0;
            	}
...
void Sound_obj::AudioBuffer_onURLLoad( ::lime::audio::AudioBuffer buffer){
            	HX_STACK_FRAME("openfl.media.Sound","AudioBuffer_onURLLoad",0x80e63186,"openfl.media.Sound.AudioBuffer_onURLLoad","openfl/media/Sound.hx",278,0x46a01619)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(buffer,"buffer")
HXLINE( 278)		Bool _hx_tmp = hx::IsNull( buffer );
HXDLIN( 278)		if (_hx_tmp) {
HXLINE( 280)			this->dispatchEvent( ::openfl::events::IOErrorEvent_obj::__new(HX_("ioError",02,fe,41,76),null(),null(),null(),null()));
            		}
            		else {
HXLINE( 284)			this->_hx___buffer = buffer;
HXLINE( 285)			this->dispatchEvent( ::openfl::events::Event_obj::__new(HX_("complete",b9,00,c8,7f),null(),null()));
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Sound_obj,AudioBuffer_onURLLoad,(void))
 ...
 ::openfl::media::Sound Sound_obj::fromAudioBuffer( ::lime::audio::AudioBuffer buffer){
            	...
            	HX_STACK_ARG(buffer,"buffer")
HXLINE(  85)		HX_VARI(  ::openfl::media::Sound,sound) =  ::openfl::media::Sound_obj::__new(null(),null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Sound_obj,fromAudioBuffer,return )
 ...
 ::openfl::media::Sound Sound_obj::fromFile(::String path){
            	HX_STACK_FRAME("openfl.media.Sound","fromFile",0x06bfbe8d,"openfl.media.Sound.fromFile","openfl/media/Sound.hx",94,0x46a01619)
            	HX_STACK_ARG(path,"path")
HXLINE(  94)		 ::lime::audio::AudioBuffer _hx_tmp = ::lime::audio::AudioBuffer_obj::fromFile(path);
HXDLIN(  94)		return ::openfl::media::Sound_obj::fromAudioBuffer(_hx_tmp);
            	}
