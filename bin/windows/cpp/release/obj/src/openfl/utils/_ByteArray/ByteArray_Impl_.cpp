...
Int length = __o_length.Default(0);
            	HX_STACK_FRAME("openfl.utils._ByteArray.ByteArray_Impl_","_new",0x0c79e17f,"openfl.utils._ByteArray.ByteArray_Impl_._new","openfl/utils/ByteArray.hx",26,0xaa5cee4a)
            	HX_STACK_ARG(length,"length")
HXLINE(  26)		HX_VARI_NAME(  ::openfl::utils::ByteArrayData,this1,"this") =  ::openfl::utils::ByteArrayData_obj::__new(length);
...
Int ByteArray_Impl__obj::get( ::openfl::utils::ByteArrayData this1,Int index){
            	HX_STACK_FRAME("openfl.utils._ByteArray.ByteArray_Impl_","get",0x47412238,"openfl.utils._ByteArray.ByteArray_Impl_.get","openfl/utils/ByteArray.hx",45,0xaa5cee4a)
            	HX_STACK_ARG(this1,"this1")
            	HX_STACK_ARG(index,"index")
HXLINE(  45)		return this1->b->__get(index);
            	}
...
HXLINE(  57)		this1->_hx___resize((index + (int)1));
HXLINE(  58)		this1->b[index] = value;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(ByteArray_Impl__obj,set,return )
 ...
 ::openfl::utils::ByteArrayData ByteArray_Impl__obj::fromArrayBuffer( ::haxe::io::Bytes buffer){
            	HX_STACK_FRAME("openfl.utils._ByteArray.ByteArray_Impl_","fromArrayBuffer",0x09275ad1,"openfl.utils._ByteArray.ByteArray_Impl_.fromArrayBuffer","openfl/utils/ByteArray.hx",74,0xaa5cee4a)
            	HX_STACK_ARG(buffer,"buffer")
HXLINE(  74)		return ::openfl::utils::ByteArrayData_obj::fromBytes(buffer);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ByteArray_Impl__obj,fromArrayBuffer,return )
 ...
 ::openfl::utils::ByteArrayData ByteArray_Impl__obj::fromBytes( ::haxe::io::Bytes bytes){
            	HX_STACK_FRAME("openfl.utils._ByteArray.ByteArray_Impl_","fromBytes",0xcad779c3,"openfl.utils._ByteArray.ByteArray_Impl_.fromBytes","openfl/utils/ByteArray.hx",88,0xaa5cee4a)
            	HX_STACK_ARG(bytes,"bytes")
HXLINE(  88)		Bool _hx_tmp = ::Std_obj::is(bytes,hx::ClassOf< ::openfl::utils::ByteArrayData >());
HXDLIN(  88)		if (_hx_tmp) {
HXLINE(  90)			return ( ( ::openfl::utils::ByteArrayData)(bytes) );
            		}
            		else {
HXLINE(  97)			return ::openfl::utils::ByteArrayData_obj::fromBytes(bytes);
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ByteArray_Impl__obj,fromBytes,return )
 ...
 ::openfl::utils::ByteArrayData ByteArray_Impl__obj::fromBytesData(::Array< unsigned char > bytesData){
            	HX_STACK_FRAME("openfl.utils._ByteArray.ByteArray_Impl_","fromBytesData",0x72e7998d,"openfl.utils._ByteArray.ByteArray_Impl_.fromBytesData","openfl/utils/ByteArray.hx",114,0xaa5cee4a)
            	HX_STACK_ARG(bytesData,"bytesData")
HXLINE( 114)		return ::openfl::utils::ByteArrayData_obj::fromBytes(::haxe::io::Bytes_obj::ofData(bytesData));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ByteArray_Impl__obj,fromBytesData,return )
 ...
 ::haxe::io::Bytes ByteArray_Impl__obj::toArrayBuffer( ::openfl::utils::ByteArrayData byteArray){
            	HX_STACK_FRAME("openfl.utils._ByteArray.ByteArray_Impl_","toArrayBuffer",0x56ee15e0,"openfl.utils._ByteArray.ByteArray_Impl_.toArrayBuffer","openfl/utils/ByteArray.hx",129,0xaa5cee4a)
            	HX_STACK_ARG(byteArray,"byteArray")
HXLINE( 129)		return byteArray;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ByteArray_Impl__obj,toArrayBuffer,return )
 ...
 ::haxe::io::Bytes ByteArray_Impl__obj::toBytes( ::openfl::utils::ByteArrayData byteArray){
            	HX_STACK_FRAME("openfl.utils._ByteArray.ByteArray_Impl_","toBytes",0xfc5d6f92,"openfl.utils._ByteArray.ByteArray_Impl_.toBytes","openfl/utils/ByteArray.hx",142,0xaa5cee4a)
            	HX_STACK_ARG(byteArray,"byteArray")
HXLINE( 142)		return byteArray;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ByteArray_Impl__obj,toBytesData,return )
 ...
 ::lime::utils::Bytes ByteArray_Impl__obj::toLimeBytes( ::openfl::utils::ByteArrayData byteArray){
            	HX_STACK_FRAME("openfl.utils._ByteArray.ByteArray_Impl_","toLimeBytes",0x1aa31bbd,"openfl.utils._ByteArray.ByteArray_Impl_.toLimeBytes","openfl/utils/ByteArray.hx",170,0xaa5cee4a)
            	HX_STACK_ARG(byteArray,"byteArray")
HXLINE( 170)		return  ::lime::utils::Bytes_obj::__new(::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(byteArray),byteArray->b);
            	}
...
Int ByteArray_Impl__obj::get_length( ::openfl::utils::ByteArrayData this1){
            	HX_STACK_FRAME("openfl.utils._ByteArray.ByteArray_Impl_","get_length",0xd68ebb4d,"openfl.utils._ByteArray.ByteArray_Impl_.get_length","openfl/utils/ByteArray.hx",188,0xaa5cee4a)
            	HX_STACK_ARG(this1,"this1")
HXLINE( 188)		return this1->length;
            	}
...
Int ByteArray_Impl__obj::set_length( ::openfl::utils::ByteArrayData this1,Int value){
            	...
            	HX_STACK_ARG(this1,"this1")
            	HX_STACK_ARG(value,"value")
HXLINE( 200)		if ((value > (int)0)) {
HXLINE( 202)			this1->_hx___resize(value);
            		}
HXLINE( 206)		this1->length = value;
