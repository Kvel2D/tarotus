...
HXLINE( 289)		Bool _hx_tmp = hx::IsNull( array );
HXDLIN( 289)		if (_hx_tmp) {
HXLINE( 291)			array = ::Array_obj< Bool >::__new();
            		}
HXLINE( 295)		this->_hx___array = array;
HXLINE( 297)		Bool _hx_tmp1 = hx::IsNotNull( length );
HXDLIN( 297)		if (_hx_tmp1) {
HXLINE( 299)			this->set_length(length);
            		}
HXLINE( 303)		this->fixed = hx::IsEq( fixed,true );
            	}
...
::Dynamic BoolVector_obj::concat(::Dynamic a){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","concat",0x25e9276b,"openfl._Vector.BoolVector.concat","openfl/Vector.hx",310,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
HXLINE( 310)		Bool _hx_tmp = hx::IsNull( a );
HXDLIN( 310)		if (_hx_tmp) {
HXLINE( 312)			::Array< Bool > _hx_tmp1 = this->_hx___array->copy();
HXDLIN( 312)			return  ::openfl::_Vector::BoolVector_obj::__new(null(),null(),_hx_tmp1);
            		}
            		else {
HXLINE( 316)			::Array< Bool > _hx_tmp2 = this->_hx___array->concat(hx::TCast<  ::openfl::_Vector::BoolVector >::cast(a)->_hx___array);
HXDLIN( 316)			return  ::openfl::_Vector::BoolVector_obj::__new(null(),null(),_hx_tmp2);
            		}
...
::Dynamic BoolVector_obj::copy(){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","copy",0xf3d4c64c,"openfl._Vector.BoolVector.copy","openfl/Vector.hx",325,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 325)		Bool _hx_tmp = this->fixed;
HXDLIN( 325)		::Array< Bool > _hx_tmp1 = this->_hx___array->copy();
HXDLIN( 325)		return  ::openfl::_Vector::BoolVector_obj::__new(null(),_hx_tmp,_hx_tmp1);
            	}
...
Bool BoolVector_obj::get(Int index){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","get",0x3a8115df,"openfl._Vector.BoolVector.get","openfl/Vector.hx",332,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
HXLINE( 332)		if ((index >= this->_hx___array->length)) {
HXLINE( 334)			return false;
            		}
            		else {
HXLINE( 338)			return this->_hx___array->__get(index);
            		}
...
HXLINE( 347)		{
HXLINE( 347)			HX_VARI( Int,_g1) = from;
HXDLIN( 347)			HX_VARI( Int,_g) = this->_hx___array->length;
HXDLIN( 347)			while((_g1 < _g)){
HXLINE( 347)				HX_VARI( Int,i) = _g1++;
HXLINE( 349)				if ((this->_hx___array->__get(i) == x)) {
HXLINE( 351)					return i;
            				}
            			}
            		}
...
void BoolVector_obj::insertAt(Int index,Bool element){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","insertAt",0xaf7e1ea3,"openfl._Vector.BoolVector.insertAt","openfl/Vector.hx",364,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(element,"element")
HXLINE( 364)		Bool _hx_tmp;
HXDLIN( 364)		if (!(!(this->fixed))) {
HXLINE( 364)			_hx_tmp = (index < this->_hx___array->length);
            		}
            		else {
HXLINE( 364)			_hx_tmp = true;
            		}
HXDLIN( 364)		if (_hx_tmp) {
HXLINE( 366)			this->_hx___array->insert(index,element);
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(BoolVector_obj,insertAt,(void))
 ...
 ::Dynamic BoolVector_obj::iterator(){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","iterator",0x80f8ec05,"openfl._Vector.BoolVector.iterator","openfl/Vector.hx",375,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 375)		return this->_hx___array->iterator();
            	}
...
::String BoolVector_obj::join(::String sep){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","join",0xf8753e81,"openfl._Vector.BoolVector.join","openfl/Vector.hx",382,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(sep,"sep")
HXLINE( 382)		return this->_hx___array->join(sep);
            	}
...
Int BoolVector_obj::lastIndexOf(Bool x, ::Dynamic __o_from){
 ::Dynamic from = __o_from.Default(0);
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(from,"from")
HXLINE( 389)		HX_VARI( Int,i) = (this->_hx___array->length - (int)1);
HXLINE( 391)		while(hx::IsGreaterEq( i,from )){
HXLINE( 393)			if ((this->_hx___array->__get(i) == x)) {
HXLINE( 393)				return i;
            			}
HXLINE( 394)			--i;
            		}
HXLINE( 398)		return (int)-1;
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(BoolVector_obj,lastIndexOf,return )
 ...
 ::Dynamic BoolVector_obj::pop(){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","pop",0x3a87f2da,"openfl._Vector.BoolVector.pop","openfl/Vector.hx",405,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 405)		Bool _hx_tmp = !(this->fixed);
HXDLIN( 405)		if (_hx_tmp) {
HXLINE( 407)			return this->_hx___array->pop();
            		}
            		else {
...
Int BoolVector_obj::push(Bool x){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","push",0xfc711c71,"openfl._Vector.BoolVector.push","openfl/Vector.hx",420,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
HXLINE( 420)		Bool _hx_tmp = !(this->fixed);
HXDLIN( 420)		if (_hx_tmp) {
HXLINE( 422)			return this->_hx___array->push(x);
            		}
            		else {
HXLINE( 426)			return this->_hx___array->length;
            		}
...
void BoolVector_obj::reverse(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 435)		this->_hx___array->reverse();
            	}
...
Bool BoolVector_obj::set(Int index,Bool value){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","set",0x3a8a30eb,"openfl._Vector.BoolVector.set","openfl/Vector.hx",442,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(value,"value")
HXLINE( 442)		Bool _hx_tmp;
HXDLIN( 442)		if (!(!(this->fixed))) {
HXLINE( 442)			_hx_tmp = (index < this->_hx___array->length);
            		}
            		else {
HXLINE( 442)			_hx_tmp = true;
            		}
HXDLIN( 442)		if (_hx_tmp) {
HXLINE( 444)			return (this->_hx___array[index] = value);
            		}
            		else {
...
HX_DEFINE_DYNAMIC_FUNC2(BoolVector_obj,set,return )
 ...
 ::Dynamic BoolVector_obj::shift(){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","shift",0x981c260b,"openfl._Vector.BoolVector.shift","openfl/Vector.hx",457,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 457)		Bool _hx_tmp = !(this->fixed);
HXDLIN( 457)		if (_hx_tmp) {
HXLINE( 459)			return this->_hx___array->shift();
            		}
            		else {
...
::Dynamic BoolVector_obj::slice( ::Dynamic __o_startIndex, ::Dynamic __o_endIndex){
 ...
 ::Dynamic endIndex = __o_endIndex.Default(16777215);
            	HX_STACK_FRAME("openfl._Vector.BoolVector","slice",0x9ac0fddb,"openfl._Vector.BoolVector.slice","openfl/Vector.hx",472,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(startIndex,"startIndex")
            	HX_STACK_ARG(endIndex,"endIndex")
HXLINE( 472)		::Array< Bool > _hx_tmp = this->_hx___array->slice(startIndex,endIndex);
HXDLIN( 472)		return  ::openfl::_Vector::BoolVector_obj::__new(null(),null(),_hx_tmp);
            	}
...
void BoolVector_obj::sort( ::Dynamic f){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","sort",0xfe6831f5,"openfl._Vector.BoolVector.sort","openfl/Vector.hx",479,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
HXLINE( 479)		this->_hx___array->sort(f);
            	}
...
::Dynamic BoolVector_obj::splice(Int pos,Int len){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","splice",0x1db7a3d3,"openfl._Vector.BoolVector.splice","openfl/Vector.hx",486,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(len,"len")
HXLINE( 486)		::Array< Bool > _hx_tmp = this->_hx___array->splice(pos,len);
HXDLIN( 486)		return  ::openfl::_Vector::BoolVector_obj::__new(null(),null(),_hx_tmp);
            	}
...
::String BoolVector_obj::toString(){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","toString",0x25cd72c3,"openfl._Vector.BoolVector.toString","openfl/Vector.hx",493,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 493)		return this->_hx___array->toString();
            	}
...
void BoolVector_obj::unshift(Bool x){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","unshift",0x70955152,"openfl._Vector.BoolVector.unshift","openfl/Vector.hx",500,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
HXLINE( 500)		Bool _hx_tmp = !(this->fixed);
HXDLIN( 500)		if (_hx_tmp) {
HXLINE( 502)			this->_hx___array->unshift(x);
            		}
            	}
...
Int BoolVector_obj::get_length(){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","get_length",0x8b6b9a86,"openfl._Vector.BoolVector.get_length","openfl/Vector.hx",518,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 518)		return this->_hx___array->length;
            	}
...
Int BoolVector_obj::set_length(Int value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 525)		Bool _hx_tmp = !(this->fixed);
HXDLIN( 525)		if (_hx_tmp) {
HXLINE( 529)			_hx_array_set_size_exact(this->_hx___array,value);
            		}
HXLINE( 558)		return this->_hx___array->length;
            	}
