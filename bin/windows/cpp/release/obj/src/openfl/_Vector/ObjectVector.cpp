...
HXLINE(1433)		Bool _hx_tmp = hx::IsNull( array );
HXDLIN(1433)		if (_hx_tmp) {
HXLINE(1435)			array = ::cpp::VirtualArray_obj::__new();
            		}
HXLINE(1439)		this->_hx___array = array;
HXLINE(1441)		Bool _hx_tmp1 = hx::IsNotNull( length );
HXDLIN(1441)		if (_hx_tmp1) {
HXLINE(1443)			this->set_length(length);
            		}
HXLINE(1447)		this->fixed = hx::IsEq( fixed,true );
            	}
...
::Dynamic ObjectVector_obj::concat(::Dynamic a){
            	HX_STACK_FRAME("openfl._Vector.ObjectVector","concat",0x91684536,"openfl._Vector.ObjectVector.concat","openfl/Vector.hx",1454,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
HXLINE(1454)		Bool _hx_tmp = hx::IsNull( a );
HXDLIN(1454)		if (_hx_tmp) {
HXLINE(1456)			::cpp::VirtualArray _hx_tmp1 = this->_hx___array->copy();
HXDLIN(1456)			return  ::openfl::_Vector::ObjectVector_obj::__new(null(),null(),_hx_tmp1);
            		}
            		else {
HXLINE(1460)			::cpp::VirtualArray _hx_tmp2 = this->_hx___array->concat(hx::TCast<  ::openfl::_Vector::ObjectVector >::cast(a)->_hx___array);
HXDLIN(1460)			return  ::openfl::_Vector::ObjectVector_obj::__new(null(),null(),_hx_tmp2);
            		}
HXLINE(1454)		return null();
            	}
...
::Dynamic ObjectVector_obj::copy(){
            	HX_STACK_FRAME("openfl._Vector.ObjectVector","copy",0xb1a04b57,"openfl._Vector.ObjectVector.copy","openfl/Vector.hx",1469,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE(1469)		::cpp::VirtualArray _hx_tmp = this->_hx___array->copy();
HXDLIN(1469)		return  ::openfl::_Vector::ObjectVector_obj::__new(null(),null(),_hx_tmp);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ObjectVector_obj,copy,return )
 ...
 ::Dynamic ObjectVector_obj::get(Int index){
            	HX_STACK_FRAME("openfl._Vector.ObjectVector","get",0x1b363b34,"openfl._Vector.ObjectVector.get","openfl/Vector.hx",1476,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
HXLINE(1476)		return this->_hx___array->__get(index);
            	}
...
HXLINE(1483)		{
HXLINE(1483)			HX_VARI( Int,_g1) = from;
HXDLIN(1483)			HX_VARI( Int,_g) = this->_hx___array->get_length();
HXDLIN(1483)			while((_g1 < _g)){
HXLINE(1483)				HX_VARI( Int,i) = _g1++;
HXLINE(1485)				if (hx::IsEq( this->_hx___array->__get(i),x )) {
HXLINE(1487)					return i;
            				}
            			}
            		}
HXLINE(1493)		return (int)-1;
            	}
...
void ObjectVector_obj::insertAt(Int index, ::Dynamic element){
            	HX_STACK_FRAME("openfl._Vector.ObjectVector","insertAt",0x4f58852e,"openfl._Vector.ObjectVector.insertAt","openfl/Vector.hx",1500,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(element,"element")
HXLINE(1500)		Bool _hx_tmp;
HXDLIN(1500)		if (!(!(this->fixed))) {
HXLINE(1500)			_hx_tmp = (index < this->_hx___array->get_length());
            		}
            		else {
HXLINE(1500)			_hx_tmp = true;
            		}
HXDLIN(1500)		if (_hx_tmp) {
HXLINE(1502)			this->_hx___array->insert(index,element);
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(ObjectVector_obj,insertAt,(void))
 ...
 ::Dynamic ObjectVector_obj::iterator(){
            	HX_STACK_FRAME("openfl._Vector.ObjectVector","iterator",0x20d35290,"openfl._Vector.ObjectVector.iterator","openfl/Vector.hx",1511,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE(1511)		return this->_hx___array->iterator();
            	}
...
::String ObjectVector_obj::join(::String sep){
            	HX_STACK_FRAME("openfl._Vector.ObjectVector","join",0xb640c38c,"openfl._Vector.ObjectVector.join","openfl/Vector.hx",1518,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(sep,"sep")
HXLINE(1518)		return this->_hx___array->join(sep);
            	}
...
Int ObjectVector_obj::lastIndexOf( ::Dynamic x, ::Dynamic __o_from){
 ::Dynamic from = __o_from.Default(0);
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(from,"from")
HXLINE(1525)		HX_VARI( Int,i) = (this->_hx___array->get_length() - (int)1);
HXLINE(1527)		while(hx::IsGreaterEq( i,from )){
HXLINE(1529)			if (hx::IsEq( this->_hx___array->__get(i),x )) {
HXLINE(1529)				return i;
            			}
HXLINE(1530)			--i;
            		}
HXLINE(1534)		return (int)-1;
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(ObjectVector_obj,lastIndexOf,return )
 ...
 ::Dynamic ObjectVector_obj::pop(){
            	HX_STACK_FRAME("openfl._Vector.ObjectVector","pop",0x1b3d182f,"openfl._Vector.ObjectVector.pop","openfl/Vector.hx",1541,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE(1541)		Bool _hx_tmp = !(this->fixed);
HXDLIN(1541)		if (_hx_tmp) {
HXLINE(1543)			return this->_hx___array->pop();
            		}
            		else {
...
Int ObjectVector_obj::push( ::Dynamic x){
            	HX_STACK_FRAME("openfl._Vector.ObjectVector","push",0xba3ca17c,"openfl._Vector.ObjectVector.push","openfl/Vector.hx",1556,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
HXLINE(1556)		Bool _hx_tmp = !(this->fixed);
HXDLIN(1556)		if (_hx_tmp) {
HXLINE(1558)			return this->_hx___array->push(x);
            		}
            		else {
HXLINE(1562)			return this->_hx___array->get_length();
            		}
...
void ObjectVector_obj::reverse(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1571)		this->_hx___array->reverse();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ObjectVector_obj,reverse,(void))
 ...
 ::Dynamic ObjectVector_obj::set(Int index, ::Dynamic value){
            	HX_STACK_FRAME("openfl._Vector.ObjectVector","set",0x1b3f5640,"openfl._Vector.ObjectVector.set","openfl/Vector.hx",1578,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(value,"value")
HXLINE(1578)		Bool _hx_tmp;
HXDLIN(1578)		if (!(!(this->fixed))) {
HXLINE(1578)			_hx_tmp = (index < this->_hx___array->get_length());
            		}
            		else {
HXLINE(1578)			_hx_tmp = true;
            		}
HXDLIN(1578)		if (_hx_tmp) {
HXLINE(1580)			return (this->_hx___array->set(index,value));
            		}
            		else {
HXLINE(1584)			return value;
            		}
HXLINE(1578)		return null();
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(ObjectVector_obj,set,return )
 ...
 ::Dynamic ObjectVector_obj::shift(){
            	HX_STACK_FRAME("openfl._Vector.ObjectVector","shift",0xec650aa0,"openfl._Vector.ObjectVector.shift","openfl/Vector.hx",1593,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE(1593)		Bool _hx_tmp = !(this->fixed);
HXDLIN(1593)		if (_hx_tmp) {
HXLINE(1595)			return this->_hx___array->shift();
            		}
            		else {
HXLINE(1599)			return null();
            		}
HXLINE(1593)		return null();
            	}
...
::Dynamic ObjectVector_obj::slice( ::Dynamic __o_startIndex, ::Dynamic __o_endIndex){
 ...
 ::Dynamic endIndex = __o_endIndex.Default(16777215);
            	HX_STACK_FRAME("openfl._Vector.ObjectVector","slice",0xef09e270,"openfl._Vector.ObjectVector.slice","openfl/Vector.hx",1608,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(startIndex,"startIndex")
            	HX_STACK_ARG(endIndex,"endIndex")
HXLINE(1608)		::cpp::VirtualArray _hx_tmp = this->_hx___array->slice(startIndex,endIndex);
HXDLIN(1608)		return  ::openfl::_Vector::ObjectVector_obj::__new(null(),null(),_hx_tmp);
            	}
...
void ObjectVector_obj::sort( ::Dynamic f){
            	HX_STACK_FRAME("openfl._Vector.ObjectVector","sort",0xbc33b700,"openfl._Vector.ObjectVector.sort","openfl/Vector.hx",1615,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
HXLINE(1615)		this->_hx___array->sort(f);
            	}
...
::Dynamic ObjectVector_obj::splice(Int pos,Int len){
            	HX_STACK_FRAME("openfl._Vector.ObjectVector","splice",0x8936c19e,"openfl._Vector.ObjectVector.splice","openfl/Vector.hx",1622,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(len,"len")
HXLINE(1622)		::cpp::VirtualArray _hx_tmp = this->_hx___array->splice(pos,len);
HXDLIN(1622)		return  ::openfl::_Vector::ObjectVector_obj::__new(null(),null(),_hx_tmp);
            	}
...
::String ObjectVector_obj::toString(){
            	HX_STACK_FRAME("openfl._Vector.ObjectVector","toString",0xc5a7d94e,"openfl._Vector.ObjectVector.toString","openfl/Vector.hx",1629,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE(1629)		return this->_hx___array->toString();
            	}
...
void ObjectVector_obj::unshift( ::Dynamic x){
            	HX_STACK_FRAME("openfl._Vector.ObjectVector","unshift",0x14504527,"openfl._Vector.ObjectVector.unshift","openfl/Vector.hx",1636,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
HXLINE(1636)		Bool _hx_tmp = !(this->fixed);
HXDLIN(1636)		if (_hx_tmp) {
HXLINE(1638)			this->_hx___array->unshift(x);
            		}
            	}
...
Int ObjectVector_obj::get_length(){
            	HX_STACK_FRAME("openfl._Vector.ObjectVector","get_length",0xa394f9d1,"openfl._Vector.ObjectVector.get_length","openfl/Vector.hx",1654,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE(1654)		return this->_hx___array->get_length();
            	}
...
Int ObjectVector_obj::set_length(Int value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(1661)		Bool _hx_tmp = !(this->fixed);
HXDLIN(1661)		if (_hx_tmp) {
HXLINE(1665)			_hx_array_set_size_exact(this->_hx___array,value);
            		}
HXLINE(1694)		return this->_hx___array->get_length();
            	}
