...
HXLINE( 579)		Bool _hx_tmp = hx::IsNull( array );
HXDLIN( 579)		if (_hx_tmp) {
HXLINE( 581)			array = ::Array_obj< Float >::__new();
            		}
HXLINE( 585)		this->_hx___array = array;
HXLINE( 587)		Bool _hx_tmp1 = hx::IsNotNull( length );
HXDLIN( 587)		if (_hx_tmp1) {
HXLINE( 589)			this->set_length(length);
            		}
HXLINE( 593)		this->fixed = hx::IsEq( fixed,true );
            	}
...
::Dynamic FloatVector_obj::concat(::Dynamic a){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","concat",0xbb39c8cd,"openfl._Vector.FloatVector.concat","openfl/Vector.hx",600,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
HXLINE( 600)		Bool _hx_tmp = hx::IsNull( a );
HXDLIN( 600)		if (_hx_tmp) {
HXLINE( 602)			::Array< Float > _hx_tmp1 = this->_hx___array->copy();
HXDLIN( 602)			return  ::openfl::_Vector::FloatVector_obj::__new(null(),null(),_hx_tmp1);
            		}
            		else {
HXLINE( 606)			::Array< Float > _hx_tmp2 = this->_hx___array->concat(hx::TCast<  ::openfl::_Vector::FloatVector >::cast(a)->_hx___array);
HXDLIN( 606)			return  ::openfl::_Vector::FloatVector_obj::__new(null(),null(),_hx_tmp2);
            		}
...
::Dynamic FloatVector_obj::copy(){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","copy",0xb028eb2e,"openfl._Vector.FloatVector.copy","openfl/Vector.hx",615,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 615)		Bool _hx_tmp = this->fixed;
HXDLIN( 615)		::Array< Float > _hx_tmp1 = this->_hx___array->copy();
HXDLIN( 615)		return  ::openfl::_Vector::FloatVector_obj::__new(null(),_hx_tmp,_hx_tmp1);
            	}
...
Float FloatVector_obj::get(Int index){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","get",0x7cc8a33d,"openfl._Vector.FloatVector.get","openfl/Vector.hx",622,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
HXLINE( 622)		return this->_hx___array->__get(index);
            	}
...
HXLINE( 629)		{
HXLINE( 629)			HX_VARI( Int,_g1) = from;
HXDLIN( 629)			HX_VARI( Int,_g) = this->_hx___array->length;
HXDLIN( 629)			while((_g1 < _g)){
HXLINE( 629)				HX_VARI( Int,i) = _g1++;
HXLINE( 631)				if ((this->_hx___array->__get(i) == x)) {
HXLINE( 633)					return i;
            				}
            			}
            		}
HXLINE( 639)		return (int)-1;
            	}
...
void FloatVector_obj::insertAt(Int index,Float element){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","insertAt",0xb3435c85,"openfl._Vector.FloatVector.insertAt","openfl/Vector.hx",646,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(element,"element")
HXLINE( 646)		Bool _hx_tmp;
HXDLIN( 646)		if (!(!(this->fixed))) {
HXLINE( 646)			_hx_tmp = (index < this->_hx___array->length);
            		}
            		else {
HXLINE( 646)			_hx_tmp = true;
            		}
HXDLIN( 646)		if (_hx_tmp) {
HXLINE( 648)			this->_hx___array->insert(index,element);
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(FloatVector_obj,insertAt,(void))
 ...
 ::Dynamic FloatVector_obj::iterator(){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","iterator",0x84be29e7,"openfl._Vector.FloatVector.iterator","openfl/Vector.hx",657,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 657)		return this->_hx___array->iterator();
            	}
...
::String FloatVector_obj::join(::String sep){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","join",0xb4c96363,"openfl._Vector.FloatVector.join","openfl/Vector.hx",664,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(sep,"sep")
HXLINE( 664)		return this->_hx___array->join(sep);
            	}
...
Int FloatVector_obj::lastIndexOf(Float x, ::Dynamic __o_from){
 ::Dynamic from = __o_from.Default(0);
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(from,"from")
HXLINE( 671)		HX_VARI( Int,i) = (this->_hx___array->length - (int)1);
HXLINE( 673)		while(hx::IsGreaterEq( i,from )){
HXLINE( 675)			if ((this->_hx___array->__get(i) == x)) {
HXLINE( 675)				return i;
            			}
HXLINE( 676)			--i;
            		}
HXLINE( 680)		return (int)-1;
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(FloatVector_obj,lastIndexOf,return )
 ...
 ::Dynamic FloatVector_obj::pop(){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","pop",0x7ccf8038,"openfl._Vector.FloatVector.pop","openfl/Vector.hx",687,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 687)		Bool _hx_tmp = !(this->fixed);
HXDLIN( 687)		if (_hx_tmp) {
HXLINE( 689)			return this->_hx___array->pop();
            		}
            		else {
HXLINE( 693)			return null();
            		}
HXLINE( 687)		return ((Float)0.);
            	}
...
Int FloatVector_obj::push(Float x){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","push",0xb8c54153,"openfl._Vector.FloatVector.push","openfl/Vector.hx",702,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
HXLINE( 702)		Bool _hx_tmp = !(this->fixed);
HXDLIN( 702)		if (_hx_tmp) {
HXLINE( 704)			return this->_hx___array->push(x);
            		}
            		else {
HXLINE( 708)			return this->_hx___array->length;
            		}
...
void FloatVector_obj::reverse(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 717)		this->_hx___array->reverse();
            	}
...
Float FloatVector_obj::set(Int index,Float value){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","set",0x7cd1be49,"openfl._Vector.FloatVector.set","openfl/Vector.hx",724,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(value,"value")
HXLINE( 724)		Bool _hx_tmp;
HXDLIN( 724)		if (!(!(this->fixed))) {
HXLINE( 724)			_hx_tmp = (index < this->_hx___array->length);
            		}
            		else {
HXLINE( 724)			_hx_tmp = true;
            		}
HXDLIN( 724)		if (_hx_tmp) {
HXLINE( 726)			return (this->_hx___array[index] = value);
            		}
            		else {
...
HX_DEFINE_DYNAMIC_FUNC2(FloatVector_obj,set,return )
 ...
 ::Dynamic FloatVector_obj::shift(){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","shift",0xa56846e9,"openfl._Vector.FloatVector.shift","openfl/Vector.hx",739,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 739)		Bool _hx_tmp = !(this->fixed);
HXDLIN( 739)		if (_hx_tmp) {
HXLINE( 741)			return this->_hx___array->shift();
            		}
            		else {
HXLINE( 745)			return null();
            		}
HXLINE( 739)		return ((Float)0.);
            	}
...
::Dynamic FloatVector_obj::slice( ::Dynamic __o_startIndex, ::Dynamic __o_endIndex){
 ...
 ::Dynamic endIndex = __o_endIndex.Default(16777215);
            	HX_STACK_FRAME("openfl._Vector.FloatVector","slice",0xa80d1eb9,"openfl._Vector.FloatVector.slice","openfl/Vector.hx",754,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(startIndex,"startIndex")
            	HX_STACK_ARG(endIndex,"endIndex")
HXLINE( 754)		::Array< Float > _hx_tmp = this->_hx___array->slice(startIndex,endIndex);
HXDLIN( 754)		return  ::openfl::_Vector::FloatVector_obj::__new(null(),null(),_hx_tmp);
            	}
...
void FloatVector_obj::sort( ::Dynamic f){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","sort",0xbabc56d7,"openfl._Vector.FloatVector.sort","openfl/Vector.hx",761,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
HXLINE( 761)		this->_hx___array->sort(f);
            	}
...
::Dynamic FloatVector_obj::splice(Int pos,Int len){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","splice",0xb3084535,"openfl._Vector.FloatVector.splice","openfl/Vector.hx",768,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(len,"len")
HXLINE( 768)		::Array< Float > _hx_tmp = this->_hx___array->splice(pos,len);
HXDLIN( 768)		return  ::openfl::_Vector::FloatVector_obj::__new(null(),null(),_hx_tmp);
            	}
...
::String FloatVector_obj::toString(){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","toString",0x2992b0a5,"openfl._Vector.FloatVector.toString","openfl/Vector.hx",775,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 775)		return this->_hx___array->toString();
            	}
...
void FloatVector_obj::unshift(Float x){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","unshift",0x81d1e5b0,"openfl._Vector.FloatVector.unshift","openfl/Vector.hx",782,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
HXLINE( 782)		Bool _hx_tmp = !(this->fixed);
HXDLIN( 782)		if (_hx_tmp) {
HXLINE( 784)			this->_hx___array->unshift(x);
            		}
            	}
...
Int FloatVector_obj::get_length(){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","get_length",0xf96594e8,"openfl._Vector.FloatVector.get_length","openfl/Vector.hx",800,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 800)		return this->_hx___array->length;
            	}
...
Int FloatVector_obj::set_length(Int value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 807)		Bool _hx_tmp = !(this->fixed);
HXDLIN( 807)		if (_hx_tmp) {
HXLINE( 811)			_hx_array_set_size_exact(this->_hx___array,value);
            		}
HXLINE( 840)		return this->_hx___array->length;
            	}
