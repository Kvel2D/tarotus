...
HXLINE( 103)		::lime::tools::helpers::ProcessHelper_obj::openURL(request->url);
            	}
...
HXLINE( 115)			::haxe::Log_obj::trace(((HX_("Warning: ",e2,3b,0f,9a) + api) + HX_(" is not implemented",1f,12,d2,b9)),hx::SourceInfo(HX_("Lib.hx",b9,80,1c,19),115,HX_("openfl.Lib",47,43,57,2f),HX_("notImplemented",6f,3a,1a,27)));
            		}
            	}
