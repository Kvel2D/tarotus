...
HXLINE( 199)				list = ( (::Array< ::Dynamic>)(this->_hx___eventMap->get(type)) );
            			}
HXLINE( 200)			Bool _hx_tmp4 = hx::IsNull( list );
HXDLIN( 200)			if (_hx_tmp4) {
HXLINE( 200)				return false;
            			}
HXLINE( 201)			list = list->copy();
            		}
            		else {
HXLINE( 205)			list = ( (::Array< ::Dynamic>)(this->_hx___eventMap->get(type)) );
HXLINE( 206)			Bool _hx_tmp5 = hx::IsNull( list );
HXDLIN( 206)			if (_hx_tmp5) {
HXLINE( 206)				return false;
            			}
HXLINE( 207)			this->_hx___dispatching->set(type,true);
            		}
HXLINE( 211)		Bool _hx_tmp6 = hx::IsNull( event->target );
HXDLIN( 211)		if (_hx_tmp6) {
HXLINE( 213)			Bool _hx_tmp7 = hx::IsNotNull( this->_hx___targetDispatcher );
HXDLIN( 213)			if (_hx_tmp7) {
HXLINE( 215)				event->target = this->_hx___targetDispatcher;
            			}
            			else {
HXLINE( 219)				event->target = hx::ObjectPtr<OBJ_>(this);
            			}
            		}
HXLINE( 225)		event->currentTarget = hx::ObjectPtr<OBJ_>(this);
HXLINE( 227)		HX_VARI( Bool,capture) = (event->eventPhase == (int)1);
HXLINE( 228)		HX_VARI( Int,index) = (int)0;
HXLINE( 229)		HX_VAR(  ::openfl::events::_EventDispatcher::Listener,listener);
HXLINE( 231)		while((index < list->length)){
HXLINE( 233)			listener = list->__get(index).StaticCast<  ::openfl::events::_EventDispatcher::Listener >();
HXLINE( 235)			Bool _hx_tmp8 = (listener->useCapture == capture);
HXDLIN( 235)			if (_hx_tmp8) {
HXLINE( 238)				listener->callback(event);
HXLINE( 240)				if (event->_hx___isCanceledNow) {
HXLINE( 242)					goto _hx_goto_2;
            				}
            			}
HXLINE( 248)			Bool _hx_tmp9 = hx::IsEq( listener,list->__get(index).StaticCast<  ::openfl::events::_EventDispatcher::Listener >() );
HXDLIN( 248)			if (_hx_tmp9) {
HXLINE( 250)				++index;
            			}
            		}
            		_hx_goto_2:;
HXLINE( 256)		Bool _hx_tmp10;
HXDLIN( 256)		Bool _hx_tmp11 = hx::IsNotNull( this->_hx___newEventMap );
HXDLIN( 256)		if (_hx_tmp11) {
HXLINE( 256)			_hx_tmp10 = this->_hx___newEventMap->exists(type);
            		}
            		else {
HXLINE( 256)			_hx_tmp10 = false;
            		}
HXDLIN( 256)		if (_hx_tmp10) {
HXLINE( 258)			HX_VARI_NAME( ::Array< ::Dynamic>,list1,"list") = ( (::Array< ::Dynamic>)(this->_hx___newEventMap->get(type)) );
HXLINE( 260)			Bool _hx_tmp12 = (list1->length > (int)0);
HXDLIN( 260)			if (_hx_tmp12) {
HXLINE( 262)				this->_hx___eventMap->set(type,list1);
            			}
            			else {
HXLINE( 266)				this->_hx___eventMap->remove(type);
            			}
HXLINE( 270)			Bool _hx_tmp13 = !(( (Bool)( ::Dynamic(this->_hx___eventMap->iterator()->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN( 270)			if (_hx_tmp13) {
HXLINE( 272)				this->_hx___eventMap = null();
HXLINE( 273)				this->_hx___newEventMap = null();
            			}
            			else {
HXLINE( 277)				this->_hx___newEventMap->remove(type);
            			}
            		}
HXLINE( 283)		this->_hx___dispatching->set(event->type,false);
...
Int EventDispatcher_obj::_hx___sortByPriority( ::openfl::events::_EventDispatcher::Listener l1, ::openfl::events::_EventDispatcher::Listener l2){
            	HX_STACK_FRAME("openfl.events.EventDispatcher","__sortByPriority",0x7512cd5d,"openfl.events.EventDispatcher.__sortByPriority","openfl/events/EventDispatcher.hx",292,0xe2270714)
            	HX_STACK_ARG(l1,"l1")
            	HX_STACK_ARG(l2,"l2")
HXLINE( 292)		if ((l1->priority == l2->priority)) {
HXLINE( 292)			return (int)0;
            		}
            		else {
HXLINE( 292)			if ((l1->priority > l2->priority)) {
