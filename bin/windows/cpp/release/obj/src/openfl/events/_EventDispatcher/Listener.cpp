...
HXLINE( 310)		this->callback = callback;
HXLINE( 311)		this->useCapture = useCapture;
HXLINE( 312)		this->priority = priority;
            	}
...
Bool Listener_obj::match( ::Dynamic callback,Bool useCapture){
            	HX_STACK_FRAME("openfl.events._EventDispatcher.Listener","match",0xdf4e17e0,"openfl.events._EventDispatcher.Listener.match","openfl/events/EventDispatcher.hx",319,0xe2270714)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(callback,"callback")
            	HX_STACK_ARG(useCapture,"useCapture")
HXLINE( 319)		Bool _hx_tmp = ::Reflect_obj::compareMethods(this->callback,callback);
HXDLIN( 319)		if (_hx_tmp) {
HXLINE( 319)			return (this->useCapture == useCapture);
            		}
            		else {
HXLINE( 319)			return false;
            		}
HXDLIN( 319)		return false;
            	}
