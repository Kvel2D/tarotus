...
HXLINE(  63)		this->bubbles = bubbles;
HXLINE(  64)		this->cancelable = cancelable;
HXLINE(  65)		this->eventPhase = (int)2;
            	}
...
Dynamic Event_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::events::Event Event_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  72)		HX_VARI(  ::openfl::events::Event,event) =  ::openfl::events::Event_obj::__new(this->type,this->bubbles,this->cancelable);
...
::String Event_obj::formatToString(::String className,::String p1,::String p2,::String p3,::String p4,::String p5){
            	...
            	HX_STACK_ARG(p4,"p4")
            	HX_STACK_ARG(p5,"p5")
HXLINE(  83)		HX_VARI( ::Array< ::String >,parameters) = ::Array_obj< ::String >::__new(0);
HXLINE(  84)		Bool _hx_tmp = hx::IsNotNull( p1 );
HXDLIN(  84)		if (_hx_tmp) {
HXLINE(  84)			parameters->push(p1);
            		}
HXLINE(  85)		Bool _hx_tmp1 = hx::IsNotNull( p2 );
HXDLIN(  85)		if (_hx_tmp1) {
HXLINE(  85)			parameters->push(p2);
            		}
HXLINE(  86)		Bool _hx_tmp2 = hx::IsNotNull( p3 );
HXDLIN(  86)		if (_hx_tmp2) {
HXLINE(  86)			parameters->push(p3);
            		}
HXLINE(  87)		Bool _hx_tmp3 = hx::IsNotNull( p4 );
HXDLIN(  87)		if (_hx_tmp3) {
HXLINE(  87)			parameters->push(p4);
            		}
HXLINE(  88)		Bool _hx_tmp4 = hx::IsNotNull( p5 );
HXDLIN(  88)		if (_hx_tmp4) {
HXLINE(  88)			parameters->push(p5);
            		}
HXLINE(  90)		return ::Reflect_obj::callMethod(hx::ObjectPtr<OBJ_>(this),this->_hx___formatToString_dyn(),::cpp::VirtualArray_obj::__new(2)->init(0,className)->init(1,parameters));
            	}
...
Bool Event_obj::isDefaultPrevented(){
            	HX_STACK_FRAME("openfl.events.Event","isDefaultPrevented",0x5475e94b,"openfl.events.Event.isDefaultPrevented","openfl/events/Event.hx",97,0x7220a03b)
            	HX_STACK_THIS(this)
HXLINE(  97)		return this->_hx___preventDefault;
            	}
...
void Event_obj::preventDefault(){
            	HX_STACK_FRAME("openfl.events.Event","preventDefault",0xdba9c454,"openfl.events.Event.preventDefault","openfl/events/Event.hx",104,0x7220a03b)
            	HX_STACK_THIS(this)
HXLINE( 104)		Bool _hx_tmp = this->cancelable;
...
void Event_obj::stopImmediatePropagation(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 115)		this->_hx___isCanceled = true;
HXLINE( 116)		this->_hx___isCanceledNow = true;
            	}
...
void Event_obj::stopPropagation(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 123)		this->_hx___isCanceled = true;
            	}
...
::String Event_obj::toString(){
            	HX_STACK_FRAME("openfl.events.Event","toString",0x6e61ddf7,"openfl.events.Event.toString","openfl/events/Event.hx",130,0x7220a03b)
            	HX_STACK_THIS(this)
HXLINE( 130)		return this->_hx___formatToString(HX_("Event",fa,37,f2,08),::Array_obj< ::String >::fromData( _hx_array_data_0,3));
            	}
...
HXLINE( 139)		HX_VARI( ::String,output) = (HX_("[",5b,00,00,00) + className);
HXLINE( 140)		HX_VARI(  ::Dynamic,arg) = null();
HXLINE( 142)		{
HXLINE( 142)			HX_VARI( Int,_g) = (int)0;
HXDLIN( 142)			while((_g < parameters->length)){
HXLINE( 142)				HX_VARI( ::String,param) = parameters->__get(_g);
HXDLIN( 142)				++_g;
HXLINE( 144)				arg = ::Reflect_obj::field(hx::ObjectPtr<OBJ_>(this),param);
HXLINE( 146)				Bool _hx_tmp = ::Std_obj::is(arg,hx::ClassOf< ::String >());
HXDLIN( 146)				if (_hx_tmp) {
HXLINE( 148)					::String _hx_tmp1 = ((HX_(" ",20,00,00,00) + param) + HX_("=\"",45,35,00,00));
HXDLIN( 148)					::String _hx_tmp2 = ::Std_obj::string(arg);
HXDLIN( 148)					hx::AddEq(output,((_hx_tmp1 + _hx_tmp2) + HX_("\"",22,00,00,00)));
            				}
            				else {
HXLINE( 152)					::String _hx_tmp3 = ((HX_(" ",20,00,00,00) + param) + HX_("=",3d,00,00,00));
HXDLIN( 152)					::String _hx_tmp4 = ::Std_obj::string(arg);
HXDLIN( 152)					hx::AddEq(output,(_hx_tmp3 + _hx_tmp4));
            				}
            			}
            		}
HXLINE( 158)		hx::AddEq(output,HX_("]",5d,00,00,00));
HXLINE( 159)		return output;
            	}
...
HXLINE(  16)		CLEAR = HX_("clear",8d,71,5b,48);
            	}
{
