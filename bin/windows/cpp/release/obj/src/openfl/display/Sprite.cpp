...
HXLINE(  30)		this->buttonMode = false;
HXLINE(  31)		this->useHandCursor = true;
HXLINE(  32)		this->loaderInfo = ::openfl::display::LoaderInfo_obj::create(null());
            	}
...
HXLINE(  77)					stack[stack->length] = hitObject;
            				}
HXLINE(  80)				return hitTest;
            			}
            		}
            		else {
HXLINE(  85)			Bool _hx_tmp2;
HXDLIN(  85)			Bool _hx_tmp3;
HXDLIN(  85)			Bool _hx_tmp4 = !(!(hitObject->get_visible()));
HXDLIN(  85)			if (_hx_tmp4) {
HXLINE(  85)				_hx_tmp3 = this->_hx___isMask;
            			}
            			else {
...
HXDLIN(  85)				if (interactiveOnly) {
HXLINE(  85)					_hx_tmp5 = !(this->mouseEnabled);
            				}
            				else {
HXLINE(  85)					_hx_tmp5 = false;
            				}
HXDLIN(  85)				if (_hx_tmp5) {
HXLINE(  85)					_hx_tmp2 = !(this->mouseChildren);
            				}
            				else {
...
HXDLIN(  86)			 ::openfl::display::DisplayObject _hx_tmp7 = this->get_mask();
HXDLIN(  86)			Bool _hx_tmp8 = hx::IsNotNull( _hx_tmp7 );
HXDLIN(  86)			if (_hx_tmp8) {
HXLINE(  86)				_hx_tmp6 = !(this->get_mask()->_hx___hitTestMask(x,y));
            			}
            			else {
...
HXLINE(  88)			Bool _hx_tmp9 = this->super::_hx___hitTest(x,y,shapeFlag,stack,interactiveOnly,hitObject);
HXDLIN(  88)			if (_hx_tmp9) {
HXLINE(  90)				return interactiveOnly;
            			}
            			else {
HXLINE(  92)				Bool _hx_tmp10;
HXDLIN(  92)				Bool _hx_tmp11;
HXDLIN(  92)				Bool _hx_tmp12;
HXDLIN(  92)				if (!(!(interactiveOnly))) {
HXLINE(  92)					_hx_tmp12 = this->mouseEnabled;
            				}
            				else {
HXLINE(  92)					_hx_tmp12 = true;
            				}
HXDLIN(  92)				if (_hx_tmp12) {
HXLINE(  92)					_hx_tmp11 = hx::IsNotNull( this->_hx___graphics );
            				}
            				else {
HXLINE(  92)					_hx_tmp11 = false;
            				}
HXDLIN(  92)				if (_hx_tmp11) {
HXLINE(  92)					 ::openfl::geom::Matrix _hx_tmp13 = this->_hx___getWorldTransform();
HXDLIN(  92)					_hx_tmp10 = this->_hx___graphics->_hx___hitTest(x,y,shapeFlag,_hx_tmp13);
            				}
            				else {
HXLINE(  92)					_hx_tmp10 = false;
            				}
HXDLIN(  92)				if (_hx_tmp10) {
HXLINE(  94)					Bool _hx_tmp14 = hx::IsNotNull( stack );
HXDLIN(  94)					if (_hx_tmp14) {
HXLINE(  96)						stack->push(hitObject);
            					}
...
Bool Sprite_obj::_hx___hitTestMask(Float x,Float y){
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 113)		Bool _hx_tmp = this->super::_hx___hitTestMask(x,y);
HXDLIN( 113)		if (_hx_tmp) {
HXLINE( 115)			return true;
            		}
            		else {
HXLINE( 117)			Bool _hx_tmp1;
HXDLIN( 117)			Bool _hx_tmp2 = hx::IsNotNull( this->_hx___graphics );
HXDLIN( 117)			if (_hx_tmp2) {
HXLINE( 117)				 ::openfl::geom::Matrix _hx_tmp3 = this->_hx___getWorldTransform();
HXDLIN( 117)				_hx_tmp1 = this->_hx___graphics->_hx___hitTest(x,y,true,_hx_tmp3);
            			}
            			else {
...
HXLINE( 123)		return false;
 ...
 ::openfl::display::Graphics Sprite_obj::get_graphics(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 137)		Bool _hx_tmp = hx::IsNull( this->_hx___graphics );
HXDLIN( 137)		if (_hx_tmp) {
HXLINE( 139)			this->_hx___graphics =  ::openfl::display::Graphics_obj::__new(hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE( 143)		return this->_hx___graphics;
            	}
...
Bool Sprite_obj::get_tabEnabled(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 150)		if (!(this->_hx___tabEnabled)) {
HXLINE( 150)			return this->buttonMode;
            		}
            		else {
