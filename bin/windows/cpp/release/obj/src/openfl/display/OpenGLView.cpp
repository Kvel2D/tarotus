...
HXLINE( 186)			 ::openfl::geom::Rectangle _hx_tmp2 = this->get_scrollRect();
HXDLIN( 186)			Bool _hx_tmp3 = hx::IsNull( _hx_tmp2 );
...
HXLINE( 192)				Float _hx_tmp4 = this->get_x();
HXDLIN( 192)				Float _hx_tmp5 = (_hx_tmp4 + this->get_scrollRect()->x);
HXDLIN( 192)				Float _hx_tmp6 = this->get_y();
HXDLIN( 192)				Float _hx_tmp7 = (_hx_tmp6 + this->get_scrollRect()->y);
HXDLIN( 192)				Float _hx_tmp8 = this->get_scrollRect()->width;
HXDLIN( 192)				rect =  ::openfl::geom::Rectangle_obj::__new(_hx_tmp5,_hx_tmp7,_hx_tmp8,this->get_scrollRect()->height);
            			}
HXLINE( 196)			renderSession->shaderManager->setShader(null());
HXLINE( 197)			renderSession->blendModeManager->setBlendMode(null());
HXLINE( 199)			Bool _hx_tmp9 = hx::IsNotNull( this->_hx___render );
