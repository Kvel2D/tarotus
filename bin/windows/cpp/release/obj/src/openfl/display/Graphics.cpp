...
HXLINE( 444)		::openfl::Lib_obj::notImplemented(HX_("Graphics.drawRoundRectComplex",45,c0,68,95));
            	}
...
HXLINE( 825)			scaleX = parentTransform->a;
            		}
            		else {
...
HXLINE( 835)			scaleY = parentTransform->d;
            		}
            		else {
...
HXLINE( 854)			this->_hx___width = ::Math_obj::floor(width);
HXLINE( 855)			this->_hx___height = ::Math_obj::floor(height);
HXLINE( 857)			this->_hx___renderTransform->a = ((Float)width / (Float)this->_hx___bounds->width);
HXLINE( 858)			this->_hx___renderTransform->d = ((Float)height / (Float)this->_hx___bounds->height);
            		}
HXLINE( 862)		Bool _hx_tmp12;
HXDLIN( 862)		if ((this->_hx___width > (int)0)) {
HXLINE( 862)			_hx_tmp12 = (this->_hx___height <= (int)0);
            		}
            		else {
HXLINE( 862)			_hx_tmp12 = true;
            		}
HXDLIN( 862)		if (_hx_tmp12) {
HXLINE( 862)			return;
            		}
HXLINE( 864)		this->_hx___worldTransform->a = ((Float)(int)1 / (Float)this->_hx___renderTransform->a);
HXLINE( 865)		this->_hx___worldTransform->b = (int)0;
HXLINE( 866)		this->_hx___worldTransform->c = (int)0;
HXLINE( 867)		this->_hx___worldTransform->d = ((Float)(int)1 / (Float)this->_hx___renderTransform->d);
HXLINE( 868)		this->_hx___worldTransform->tx = this->_hx___bounds->x;
HXLINE( 869)		this->_hx___worldTransform->ty = this->_hx___bounds->y;
HXLINE( 870)		this->_hx___worldTransform->concat(this->_hx___owner->_hx___worldTransform);
            	}
...
HXDLIN( 884)		if (value) {
HXLINE( 884)			_hx_tmp = hx::IsNotNull( this->_hx___owner );
            		}
            		else {
HXLINE( 884)			_hx_tmp = false;
            		}
HXDLIN( 884)		if (_hx_tmp) {
HXLINE( 886)			HX_VARI(  ::openfl::display::DisplayObject,_this) = this->_hx___owner;
HXDLIN( 886)			Bool _hx_tmp1 = !(_this->_hx___renderDirty);
HXDLIN( 886)			if (_hx_tmp1) {
HXLINE( 886)				_this->_hx___renderDirty = true;
HXDLIN( 886)				::openfl::display::DisplayObject_obj::_hx___worldRenderDirty++;
            			}
            		}
HXLINE( 890)		return (this->_hx___dirty = value);
            	}
