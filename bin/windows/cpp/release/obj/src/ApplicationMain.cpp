...
HXLINE(  21)		HX_VARI(  ::NMEPreloader,display) =  ::NMEPreloader_obj::__new();
...
HXLINE(  51)		HX_VARI( Int,result) = app->exec();
HXLINE(  54)		::lime::_hx_system::System_obj::exit(result);
            	}
...
HXLINE(  62)		HX_VARI( ::Array< Int >,loaded) = ::Array_obj< Int >::fromData( _hx_array_data_0,1);
HXLINE(  63)		HX_VARI( Int,total) = (int)0;
HXLINE(  76)		::ApplicationMain_obj::preloader = null();
HXLINE(  81)		if ((total == (int)0)) {
HXLINE(  83)			::ApplicationMain_obj::start();
            		}
            	}
...
HXLINE(  92)		::ApplicationMain_obj::config =  ::Dynamic(hx::Anon_obj::Create(9)
            			->setFixed(0,HX_("company",3d,15,69,83),HX_("",00,00,00,00))
            			->setFixed(1,HX_("build",2e,db,ea,ba),HX_("888",38,af,2a,00))
            			->setFixed(2,HX_("windows",83,de,74,e8),::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(hx::Anon_obj::Create(19)
            				->setFixed(0,HX_("resizable",6b,37,50,a9),true)
            				->setFixed(1,HX_("display",42,2a,4a,bb),(int)0)
            				->setFixed(2,HX_("width",06,b6,62,ca),(int)1500)
            				->setFixed(3,HX_("fullscreen",3b,3a,b4,f9),false)
            				->setFixed(4,HX_("maximized",18,0e,e1,fe),null())
            				->setFixed(5,HX_("x",78,00,00,00),null())
            				->setFixed(6,HX_("y",79,00,00,00),null())
            				->setFixed(7,HX_("height",e7,07,4c,02),(int)1000)
            				->setFixed(8,HX_("title",98,15,3b,10),HX_("Tarotus",88,33,0e,5b))
            				->setFixed(9,HX_("borderless",45,46,71,17),false)
            				->setFixed(10,HX_("background",ee,93,1d,26),(int)0)
            				->setFixed(11,HX_("minimized",86,fb,9d,28),null())
            				->setFixed(12,HX_("stencilBuffer",1c,94,39,31),true)
            				->setFixed(13,HX_("vsync",d1,2d,a8,3d),true)
            				->setFixed(14,HX_("antialiasing",f4,16,b3,48),(int)0)
            				->setFixed(15,HX_("hidden",6a,ff,95,4c),null())
            				->setFixed(16,HX_("parameters",aa,be,7e,51),HX_("{}",a2,6b,00,00))
            				->setFixed(17,HX_("depthBuffer",63,46,9e,52),false)
            				->setFixed(18,HX_("hardware",a8,e2,d3,75),true))))
            			->setFixed(3,HX_("orientation",d0,ee,fe,fd),HX_("landscape",3b,78,ad,fc))
            			->setFixed(4,HX_("fps",e9,c7,4d,00),(int)60)
            			->setFixed(5,HX_("packageName",f1,04,ad,04),HX_("com.kvel2d",d1,8b,5b,a3))
            			->setFixed(6,HX_("file",7c,ce,bb,43),HX_("game",f2,f3,5e,44))
            			->setFixed(7,HX_("name",4b,72,ff,48),HX_("Tarotus",88,33,0e,5b))
            			->setFixed(8,HX_("version",18,e7,f1,7c),HX_("1.0.0",b5,d1,2e,55)));
HXLINE( 142)		::ApplicationMain_obj::create();
            	}
...
HXLINE( 150)		HX_VARI( Bool,hasMain) = false;
HXLINE( 151)		HX_VARI( hx::Class,entryPoint) = ::Type_obj::resolveClass(HX_("haxegon.Load",94,58,8d,9b));
HXLINE( 153)		{
HXLINE( 153)			HX_VARI( Int,_g) = (int)0;
HXDLIN( 153)			HX_VARI( ::Array< ::String >,_g1) = ::Type_obj::getClassFields(entryPoint);
HXDLIN( 153)			while((_g < _g1->length)){
HXLINE( 153)				HX_VARI( ::String,methodName) = _g1->__get(_g);
HXDLIN( 153)				++_g;
HXLINE( 155)				if ((methodName == HX_("main",39,38,56,48))) {
HXLINE( 157)					hasMain = true;
HXLINE( 158)					goto _hx_goto_1;
            				}
            			}
            			_hx_goto_1:;
            		}
HXLINE( 164)		::lime::Assets_obj::initialize();
HXLINE( 166)		if (hasMain) {
HXLINE( 168)			 ::Dynamic _hx_tmp = ::Reflect_obj::field(entryPoint,HX_("main",39,38,56,48));
HXDLIN( 168)			::Reflect_obj::callMethod(entryPoint,_hx_tmp,::cpp::VirtualArray_obj::__new(0));
            		}
            		else {
HXLINE( 172)			::Type_obj::createInstance(hx::ClassOf< ::DocumentClass >(),::cpp::VirtualArray_obj::__new(0));
            		}
HXLINE( 183)		Bool _hx_tmp1 = ::openfl::Lib_obj::current->stage->window->_hx___fullscreen;
HXDLIN( 183)		if (_hx_tmp1) {
HXLINE( 185)			::openfl::Lib_obj::current->stage->dispatchEvent( ::openfl::events::FullScreenEvent_obj::__new(HX_("fullScreen",5b,ae,48,2e),false,false,true,true));
            		}
HXLINE( 189)		::openfl::Lib_obj::current->stage->dispatchEvent( ::openfl::events::Event_obj::__new(HX_("resize",f4,59,7b,08),false,false));
            	}
