...
class HXCPP_CLASS_ATTRIBUTES DestReg_obj : public hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"openfl._internal.stage3D._AGALConverter.DestReg"); }
		...
		static  ::openfl::_internal::stage3D::_AGALConverter::DestReg Parse(Int v,::hx::EnumBase programType);
